unit GI_GAIFile;
// Unit bracket (inferred): .text 0x004AB90C..0x004AD4A0; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    procedure Execute; override; // @addr $4ABA90
  end;
  ...
  public
    ...
    constructor Create(Owner: TObjectGI); // @addr $4ABCF0 @ida "TGAIFileGI *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>, TObjectGI *Owner@<ecx>);"
    destructor Destroy; override; // @addr $4ABDE0 @ida "void __usercall $name(TGAIFileGI *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure Clear; override; // @addr $4ABF48
    procedure OpenImage; // @addr $4ABF64
    procedure CloseImage; // @addr $4AC010
    function GetFrameData(FrameIndex: Integer): Pointer; // @addr $4AC120
    procedure TrimFrameCache; // @addr $4AC2C0
    function GetFrameCount: Integer; // @addr $4AC400
    function GetContentSize: TPoint; // @addr $4AC488 @ida "void __usercall $name(TGAIFileGI *Self@<eax>, TPoint *Result@<edx>);"
    function GetContentOrigin: TPoint; // @addr $4AC524 @ida "void __usercall $name(TGAIFileGI *Self@<eax>, TPoint *Result@<edx>);"
    procedure SetImageKindX(Value: TImageKindXGI); // @addr $4AC5C0
    procedure SetImageKindY(Value: TImageKindYGI); // @addr $4AC5F8
    procedure SetSize(Size: TPoint); override; // @addr $4AC630 @ida "void __usercall $name(TGAIFileGI *Self@<eax>, TPoint *Size@<edx>);"
    procedure SetFrameSequence(Sequence: WideString); // @addr $4AC654
    function GetSequenceFrame(Index: Integer): Integer; // @addr $4AC94C
    function GetFrameDelay(Index: Integer): Integer; // @addr $4AC984
    procedure OnDeactivate; override; // @addr $4AC9BC
    procedure LoadFromConfigPath(const Path: WideString); override; // @addr $4AC9FC
    procedure LoadFromBlock(Block: TBlockParEC); override; // @addr $4ACA30
    procedure LoadImageProperties(Block: TBlockParEC); // @addr $4ACA58
    procedure UpdateAutoGeometry; override; // @addr $4ACD48
    procedure AdvanceFrame(Timer: PCallbackTimerGI; UserData: Integer); // @addr $4ACDBC
    procedure Draw(ClipRect: TRect); override; // @addr $4ACEC0 @ida "void __usercall $name(TGAIFileGI *Self@<eax>, TRect *ClipRect@<edx>);"
  end;
...
{ @routine $4ABA90 TGAIFileThreadGI_Execute }
...
{ @routine $4ABCF0 TGAIFileGI_Create }
...
{ @routine $4ABDE0 TGAIFileGI_Destroy }
...
{ @routine $4ABF48 TGAIFileGI_Clear }
...
{ @routine $4ABF64 TGAIFileGI_OpenImage }
...
{ @routine $4AC010 TGAIFileGI_CloseImage }
...
{ @routine $4AC120 TGAIFileGI_GetFrameData }
...
{ @routine $4AC2C0 TGAIFileGI_TrimFrameCache }
...
{ @routine $4AC400 TGAIFileGI_GetFrameCount }
...
{ @routine $4AC488 TGAIFileGI_GetContentSize }
...
{ @routine $4AC524 TGAIFileGI_GetContentOrigin }
...
{ @routine $4AC5C0 TGAIFileGI_SetImageKindX }
...
{ @routine $4AC5F8 TGAIFileGI_SetImageKindY }
...
{ @routine $4AC630 TGAIFileGI_SetSize }
...
{ @routine $4AC654 TGAIFileGI_SetFrameSequence }
...
{ @routine $4AC94C TGAIFileGI_GetSequenceFrame }
...
{ @routine $4AC984 TGAIFileGI_GetFrameDelay }
...
{ @routine $4AC9BC TGAIFileGI_OnDeactivate }
...
{ @routine $4AC9FC TGAIFileGI_LoadFromConfigPath }
...
{ @routine $4ACA30 TGAIFileGI_LoadFromBlock }
...
{ @routine $4ACA58 TGAIFileGI_LoadImageProperties }
...
{ @routine $4ACD48 TGAIFileGI_UpdateAutoGeometry }
...
{ @routine $4ACDBC TGAIFileGI_AdvanceFrame }
...
{ @routine $4ACEC0 TGAIFileGI_Draw }
