unit GR_DX;
// Unit bracket (inferred): .text 0x007E9834..0x007EBFB7; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
// Unit bracket (inferred): .itext 0x00876A60..0x00876A67; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    constructor Create; // @addr 0x7EA060 @ida "TTextureGR *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x7EA0B0 @ida "void __usercall $name(TTextureGR *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure Clear; // @addr 0x7EA0EC
    procedure ReleaseSurfaces; // @addr 0x7EA178 @note "Retains the array and SurfaceCount."
    function GetSurface(Index: Integer): IDirect3DTexture9; // @addr 0x7EA1D0 @ida "void __usercall $name(TTextureGR *Self@<eax>, int Index@<edx>, IDirect3DTexture9 **Result@<ecx>);" @note "Returns nil when out of range; successful access refreshes LastUseTick."
    procedure SetSurface(Value: IDirect3DTexture9; Index: Integer); // @addr 0x7EA21C @note "A negative index appends; indexes beyond the end create nil holes."
  end;

var
  TextureManagerDisabled: Boolean = False; // @addr $87EBF0 @note "DisableTextureManager setting."
  MaxTextureSize: TPoint; // @addr $88AFC0
  DrawVertices: TScreenVerticesGR; // @addr $88AFC8
  PendingPoints: array of TScreenVertexGR; // @addr $88B188
  TextureCaches: TList = nil; // @addr 0x87EBF4
  AvailableTextureBytes: Cardinal = 0; // @addr $87EBF8
  CircleCos: TCircleTableGR; // @addr $88B18C
  CircleSin: TCircleTableGR; // @addr $88B730
  LineAlphaTable: TLineAlphaTableGR; // @addr $88BCD4
  ReservedTextureBytes: Cardinal = 0; // @addr 0x87EBFC
  TextureIdleSeconds: Integer = 120; // @addr 0x87EC00
  LastTextureEvictionTick: Cardinal = 0; // @addr 0x87EC04
  PendingPointCount: Integer = 0; // @addr $87EC08
  PendingPointCapacity: Integer = 0; // @addr $87EC0C
  ResidentTextureBytes: Cardinal = 0; // @addr 0x87EC10

procedure EvictTextureCaches(Force: Boolean); // @addr 0x7E99B4
procedure SubtractResidentTextureBytes(ByteCount: Cardinal); // @addr 0x7EBF50

function CreateTextureCache: TTextureGR; // @addr 0x7E98DC
function GR_CreateTexture(Width, Height: Integer; Format, Pool: Cardinal): IDirect3DTexture9; // @addr 0x7E9B34 @ida "void __userpurge $name(int Width@<eax>, int Height@<edx>, unsigned int Format@<ecx>, unsigned int Pool@<^4>, IDirect3DTexture9 **Result@<^0>);" @note "Clamps each dimension to at least 16. Returns nil without a device; retries allocation after evicting textures."
procedure FreeTextureCache(Cache: TTextureGR); // @addr 0x7E9928 @note "Accepts nil."

procedure ClearTexturePixels(Texture: IDirect3DTexture9); // @addr $7E9FB8

procedure ReleaseAllTextureSurfaces; // @addr $7E9970
function GetTextureByteSize(Texture: IDirect3DTexture9): Cardinal; // @addr $7EBE8C @note "Counts level zero only. Native format test repeats A8R8G8B8; X8R8G8B8 is not recognized."
procedure AddResidentTextureBytes(ByteCount: Cardinal); // @addr $7EBF3C
function Color565ToArgb(Color: Cardinal): Cardinal; // @addr $7EBE18
function ColorWithAlpha(Color, Alpha: Cardinal): Cardinal; // @addr $7EBE60
function CreateTextureFromPixels(Width, Height: Integer; Format: Cardinal; Pixels: Pointer; PitchBytes: Integer; Pool: Cardinal): IDirect3DTexture9; // @addr $7E9DA4 @ida "void __userpurge $name(int Width@<eax>, int Height@<edx>, unsigned int Format@<ecx>, void *Pixels@<^12>, int PitchBytes@<^8>, unsigned int Pool@<^4>, IDirect3DTexture9 **Result@<^0>);"

procedure QueueDrawPoint(X, Y: Integer; Color: Cardinal; Alpha: Integer); // @addr $7EA380
procedure FlushDrawPoints(ClipRect: PRect); // @addr $7EA48C
procedure DrawAlphaLine(X1, Y1, X2, Y2: Integer; Color: Cardinal; Alpha: Integer; ClipRect: PRect); // @addr $7EA508
procedure DrawGradientLine(X1, Y1: Integer; Color1: Cardinal; X2, Y2: Integer; Color2: Cardinal; ClipRect: PRect); // @addr $7EA550
procedure DrawColoredTriangle(X1, Y1: Integer; Color1: Cardinal; X2, Y2: Integer; Color2: Cardinal; X3, Y3: Integer; Color3: Cardinal; Filled: Boolean; ClipRect: PRect); // @addr $7EB2A4
procedure DrawColoredRect(X, Y, Width, Height: Integer; Color: Cardinal; Alpha: Integer; Filled: Boolean; ClipRect: PRect); // @addr $7EB3A0
procedure DrawAntialiasedCircle(X, Y, Radius: Integer; Color: Cardinal; Alpha: Integer; ClipRect: PRect); // @addr $7EB53C
procedure DrawCircle(X, Y, Radius: Integer; Color: Cardinal; Alpha, Mode: Integer; ClipRect: PRect); // @addr $7EB798
procedure DrawTexture(Texture: IDirect3DTexture9; X, Y, Alpha: Integer; Color: Cardinal; ClipRect: PRect; UsePreparedVertices, MirrorHorizontal: Boolean); // @addr $7EBB48
procedure DrawTextureSized(Texture: IDirect3DTexture9; X, Y, Width, Height, Alpha: Integer; Color: Cardinal; ClipRect: PRect; UsePreparedVertices, MirrorHorizontal: Boolean); // @addr $7EBBB8

procedure DrawAntialiasedLineDX(StartX, StartY, FinishX, FinishY: Integer; Color: Cardinal; Alpha: Integer; UnusedClipRect: PRect); // @addr $7EA62C @note "Native routine ignores the supplied clip rectangle."
procedure DrawAnimatedLineDX(StartX, StartY, FinishX, FinishY: Integer; Color: Cardinal; Phase: Integer; UnusedClipRect: PRect); // @addr $7EAC14 @note "Uses LineAlphaTable and advances phase by 20 per column. Ignores the supplied clip rectangle."

implementation

// @unit-initialization $876A60
// @unit-finalization $7EBF78

uses MMSystem, EC_Mem, GR_Main, EC_Str, Math, Windows;

{ @routine $7E98DC CreateTextureCache }
...
{ @routine $7E9928 FreeTextureCache }
...
{ @routine $7E9970 ReleaseAllTextureSurfaces }
...
{ @routine $7E99B4 EvictTextureCaches }
...
{ @routine $7E9B34 GR_CreateTexture }
...
{ @routine $7E9DA4 CreateTextureFromPixels }
...
{ @routine $7E9FB8 ClearTexturePixels }
...
{ @routine $7EA060 TTextureGR_Create }
...
{ @routine $7EA0B0 TTextureGR_Destroy }
...
{ @routine $7EA0EC TTextureGR_Clear }
...
{ @routine $7EA178 TTextureGR_ReleaseSurfaces }
...
{ @routine $7EA1D0 TTextureGR_GetSurface }
...
{ @routine $7EA21C TTextureGR_SetSurface }
...
{ @routine $7EA48C FlushDrawPoints }
...
{ @routine $7EA550 DrawGradientLine }
...
{ @routine $7EA62C DrawAntialiasedLineDX }
...
var
  ...
  // @nested $7EA600 LineFractionDX
  function LineFractionDX(Value: Double): Double; // @addr $7EA600 @ida "double __userpurge $name@<st0>(double Value@<^0>, void *ParentFrame@<^8>);" @stackpop 8 @calls "0x007EA84D 0x007EA88E 0x007EA8A8 0x007EA9A6 0x007EA9EF 0x007EAA06 0x007EAAF3 0x007EAB0D"
  begin
...
{ @routine $7EAC14 DrawAnimatedLineDX }
...
var
  ...
  // @nested $7EABC4 AnimatedLineFractionDX
  function AnimatedLineFractionDX(Value: Double): Double; // @addr $7EABC4 @ida "double __userpurge $name@<st0>(double Value@<^0>, void *ParentFrame@<^8>);" @stackpop 8 @calls "0x007EAE35 0x007EAE76 0x007EAE90 0x007EAFE1 0x007EB02A 0x007EB041 0x007EB188 0x007EB1A2"
  begin
    Result := Value - Floor(Value);
  end;

  // @nested $7EABF0 AdvanceLinePhase
  procedure AdvanceLinePhase; // @addr $7EABF0 @ida "void __usercall $name(void *ParentFrame@<^0>);" @stackpop 0 @calls "0x007EAF78 0x007EB161"
  begin
    Inc(Phase, 20);
...
{ @routine $7EB2A4 DrawColoredTriangle }
...
begin
  ...
  // Native $7EB33B/$7EB36A set state 8 to 2/3: wireframe/solid fill.
...
{ @routine $7EB3A0 DrawColoredRect }
...
{ @routine $7EB53C DrawAntialiasedCircle }
...
{ @routine $7EBBB8 DrawTextureSized }
...
{ @routine $7EBE8C GetTextureByteSize }
...
{ @routine $7EBF3C AddResidentTextureBytes }
...
{ @routine $7EBF50 SubtractResidentTextureBytes }
