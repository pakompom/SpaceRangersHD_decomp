unit aScript;
// Unit bracket (inferred): .text 0x0066A02C..0x0067A3F4; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
const
  // Serialized PlaceKind IDs, decoded by TScriptPlace.GetPoint ($66DA5C)
  // and ShipInPlace ($66E070). Keep the stored field as a 32-bit integer.
  spkPolar = 0;
  spkPlanetPosition = 1;
  spkDockedPlanet = 2;
  spkStarDirection = 3;
  ...
  // TShip.ApplyScriptStateOrders ($72A7A0), state completion ($72ACDC),
  // and HasScriptControl ($72D720) establish these serialized StateKind IDs.
  sskIdle = 0;
  sskMoveToPlace = 1;
  sskFollowGroup = 2;
  sskJumpToStar = 3;
...
type
  ...
  // Native record RTTI at $66A004.
  TScriptShipOtb = packed record // @size 0x4C
    Count: Integer; // @offset 0x00
    OwnerMask: TOwnerMask; // @offset 0x04
    ShipTypeMask: TScriptShipTypeMask; // @offset 0x06  Logical ship-type bits, including station bit 8.
    PlayerOnly: Boolean; // @offset 0x08
    MinSpeed: Integer; // @offset 0x0C
    MaxSpeed: Integer; // @offset 0x10
    WeaponRequirement: Integer; // @offset 0x14  1 requires weapons; 2 requires none.
    MinCargoHookLevel: Integer; // @offset 0x18
    MinFreeCargoSpace: Integer; // @offset 0x1C
    MinTraderStatus: Integer; // @offset 0x20
    MaxTraderStatus: Integer; // @offset 0x24
    MinWarriorStatus: Integer; // @offset 0x28
    MaxWarriorStatus: Integer; // @offset 0x2C
    MinPirateStatus: Integer; // @offset 0x30
    MaxPirateStatus: Integer; // @offset 0x34
    MinStrength: Single; // @offset 0x38
    MaxStrength: Single; // @offset 0x3C
    StationNames: WideString; // @offset 0x40
    DominatorMasks: TScriptDominatorMasks; // @offset 0x44
  end;
  ...
  public
    ...
    constructor Create; // @addr 0x66D7D8 @ida "TScriptStar *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66D84C @ida "void __usercall $name(TScriptStar *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    constructor Create; // @addr 0x66D8B0 @ida "TScriptConstellation *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66D8F4 @ida "void __usercall $name(TScriptConstellation *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    function GetGroup: TScriptGroup; // @addr 0x66D9BC
    function RunActionCode(ActionType: Byte; Ship: TShip; Object1, Object2: TObject; Param: Integer): Integer; // @addr 0x679198 @note "Returns the event parameter after script changes. Object slots can carry event-specific integers."

    constructor Create; // @addr 0x66D928 @ida "TScriptShip *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66D96C @ida "void __usercall $name(TScriptShip *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    function GetPoint: TPointF; // @addr 0x66DA5C @ida "void __usercall $name(TScriptPlace *Self@<eax>, TPointF *Result@<edx>);"
    function GetRandomPoint(Seed: Cardinal): TPointF; // @addr 0x66DF08 @ida "void __usercall $name(TScriptPlace *Self@<eax>, unsigned int Seed@<edx>, TPointF *Result@<ecx>);"
    function ShipInPlace(Ship: TShip): Boolean; // @addr 0x66E070 @note "Kind 2 requires docking at the bound planet; other kinds require normal space."

    constructor Create; // @addr 0x66D9E4 @ida "TScriptPlace *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66DA28 @ida "void __usercall $name(TScriptPlace *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;

  TScriptItem = class(TObjectEx) // @size 0x68
  public
    Name: WideString; // @offset 0x04
    ...
    ActionTypeMask: TScriptActionTypeSet; // @offset 0x58
    StepTypeMask: TScriptStepTypeSet; // @offset 0x60
    ActionCodeInitialized: Boolean; // @offset 0x62
    Script: TScript; // @offset 0x64
    procedure CompileActionCode; // @addr 0x678A50 @note "Requires nonempty OnActionText and an empty ActionCode slot."
    function RunActionCode(ActionType: Byte; Ship: TShip; Object1, Object2: TObject; Param: Integer): Integer; // @addr 0x678DD0 @note "Returns the event parameter after script changes. Object slots can carry event-specific integers."
    function FormatDataText(Text, ColorTag: WideString): WideString; // @addr 0x679FA0 @ida "void __userpurge $name(TScriptItem *Self@<eax>, unsigned __int16 *Text@<edx>, unsigned __int16 *ColorTag@<ecx>, unsigned __int16 **Result@<^0>);"

    constructor Create; // @addr 0x66E0E4 @ida "TScriptItem *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66E13C @ida "void __usercall $name(TScriptItem *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    ShipTypeMask: TScriptShipTypeMask; // @offset 0x16
    ...
    constructor Create; // @addr 0x66E1A8 @ida "TScriptGroup *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66E1EC @ida "void __usercall $name(TScriptGroup *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    constructor Create; // @addr 0x66E23C @ida "TScriptState *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66E298 @ida "void __usercall $name(TScriptState *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    constructor Create; // @addr 0x66E35C @ida "TScriptDialog *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66E3B0 @ida "void __usercall $name(TScriptDialog *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    constructor Create; // @addr 0x66E400 @ida "TScriptDialogMsg *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66E454 @ida "void __usercall $name(TScriptDialogMsg *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    constructor Create; // @addr 0x66E4A4 @ida "TScriptDialogAnswer *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66E50C @ida "void __usercall $name(TScriptDialogAnswer *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    procedure Clear; // @addr 0x66E8D4 @note "Frees owned entries but retains list and code containers."
    procedure PublishShipContext(Binding: TScriptShip); // @addr 0x66EC40 @note "Changes the global CurrentScript context."
    procedure PublishCurrentShip(Ship: TShip); // @addr 0x66ECD0
    function GetStar(Name: WideString): TScriptStar; // @addr 0x66ED24 @note "Raises when absent."
    function GetPlanetBinding(Name: WideString): PScriptPlanetBinding; // @addr 0x66EE48 @note "Raises when absent."
    function GetItem(Name: WideString): TScriptItem; // @addr 0x66EFB0 @note "Raises when absent."
    procedure RunShipState(Binding: TScriptShip); // @addr 0x66F0CC
    procedure RunTurnCode; // @addr 0x66F34C
    procedure RunAuxiliaryCode; // @addr 0x66F4EC
    procedure CallDialog(Index: Integer); // @addr 0x66F690
    procedure CallDialogByVariable(Name: WideString); // @addr 0x66F958
    procedure CallDialogMessage(Index: Integer); // @addr 0x66FA64
    procedure BuildDialogAnswer(Index: Integer); // @addr 0x66FD14
    procedure ExecuteDialogAnswer(Index: Integer); // @addr 0x66FFD4 @note "Index -1 is ignored."
    procedure BindShip(GroupIndex: Integer; Ship: TShip); // @addr 0x670284 @note "The player may have multiple script bindings; ordinary ships have one."
    procedure UnbindShip(Ship: TShip); // @addr 0x670338
    procedure ClearShipBindings; // @addr 0x670428
    procedure ChangeState(Binding: TScriptShip; StateIndex: Integer); // @addr 0x67051C
    procedure SetGroupRelation(SourceGroup, TargetGroup: Integer; Level: TRelationLevel); // @addr 0x6705B4 @note "Changes source ships' relations to ranger members of the target group."
    procedure SetPlanetRelation(GroupIndex: Integer; Planet: TPlanet; Level: TRelationLevel); // @addr 0x670680
    function TryBindStars(StarIndex: Integer): Boolean; // @addr 0x6706F8 @note "Recursively assigns remaining stars and their planets; earlier star bindings must already exist."
    function LoadFromBuffer(Buffer: TBufEC; AnchorStar: TStar; FirstPlanet: TPlanet; CreateObjects: Boolean): Boolean; // @addr 0x671518 @note "Accepts script-definition versions 5 through 8."
    function LoadFromFile(FileName: WideString; AnchorStar: TStar; FirstPlanet: TPlanet; CreateObjects: Boolean): Boolean; // @addr 0x674BA8
    procedure SaveState(Buffer: TBufEC); // @addr 0x674D1C @note "Compiled instructions are excluded."
    procedure LoadState(Buffer: TBufEC; Galaxy: TGalaxy); // @addr 0x67551C @note "Requires the original script-definition file. Resolves star, planet and item IDs through Galaxy; ship IDs are deferred."
    procedure BindImportedFunctions; // @addr 0x676280
    procedure ResolveLoadedReferences(Galaxy: TGalaxy); // @addr 0x6764E4 @note "Resolves saved ship IDs and restores ship, place, and state bindings after LoadState."

    constructor Create; // @addr 0x66E578 @ida "TScript *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x66E6D4 @ida "void __usercall $name(TScript *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;

  TScriptThread = class(TThreadEC) // @size 0x2C
  public
    constructor Create; // @addr 0x66B770 @ida "TScriptThread *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    procedure Execute; override; // @addr 0x66B7B4 @slot 0x00
  end;
  ...
  public
    ...
    procedure Initialize(Name, SourceText, ActionTypes, StepTypes: WideString); // @addr 0x6781DC

    constructor Create; // @addr 0x678140 @ida "TScriptCacheUnit *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x67818C @ida "void __usercall $name(TScriptCacheUnit *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;

  TScriptCache = class(TObject) // @size 0x8
  public
    Entries: TObjectList; // @offset 0x04  Owns TScriptCacheUnit entries sorted by Name.
    function GetOrCompile(Name: WideString; Config: TBlockParEC): TScriptCacheUnit; // @addr 0x677EE4 @note "Returns nil for absent or empty OnActCode."

    constructor Create; // @addr 0x677A44 @ida "TScriptCache *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x677AEC @ida "void __usercall $name(TScriptCache *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    SourceText: WideString; // @offset 0x08
    Code: TCodeEC; // @offset 0x0C  Owned.
    procedure Initialize(Block: TBlockParEC; SourceText: WideString); // @addr 0x678504

    constructor Create; // @addr 0x678468 @ida "TScriptGICacheUnit *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x6784B4 @ida "void __usercall $name(TScriptGICacheUnit *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    function GetOrCompile(Block: TBlockParEC): TScriptGICacheUnit; // @addr 0x677BFC @note "Returns nil for empty source."

    constructor Create; // @addr 0x677A98 @ida "TScriptGICache *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x677B30 @ida "void __usercall $name(TScriptGICache *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    constructor Create(LibraryName: WideString; ModuleHandle: Cardinal; DefinitionBlock: TBlockParEC); // @addr 0x676880 @ida "TLibraryHandler *__userpurge $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>, unsigned __int16 *LibraryName@<ecx>, unsigned int ModuleHandle@<^4>, TBlockParEC *DefinitionBlock@<^0>);"
    procedure InitFunction(Cell: TVarEC); // @addr 0x676988
    procedure InitAllFunctions(Scope: TVarArrayEC); // @addr 0x676E70

    destructor Destroy; override; // @addr 0x67691C @ida "void __usercall $name(TLibraryHandler *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  ...
  public
    ...
    function GetLib(Name: WideString): TLibraryHandler; // @addr 0x67718C
    procedure InitFunction(Cell: TVarEC); // @addr 0x67736C

    constructor Create; // @addr 0x676FA0 @ida "TLibraryCache *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x676FF4 @ida "void __usercall $name(TLibraryCache *Self@<eax>, __int8 DestroyFlags@<dl>);"
  end;
  PScriptVDRequest = ^TScriptVDRequest;

  // Native record RTTI at $66A920.
...
var
  CurrentScript: TScript; // @addr 0x889C48
  QueuedArcadeBattles: TList; // @addr 0x889C4C  Owns PScriptABRequest records.
  QueuedPlanetaryBattles: TList; // @addr 0x889C50  Owns PScriptPBRequest records.
  QueuedTextQuests: TList; // @addr 0x889C54 // Owns PQueuedTextQuest records.
  QueuedVideos: TList; // @addr 0x889C58  Owns PScriptVDRequest records.
  ResumingScript: TScript = nil; // @addr 0x87B7A4
  StagedArcadeShipScript: TScript = nil; // @addr $87B7A8
  ScriptArcadeReturnScreenId: Byte = 0; // @addr $87B7AC Direct stores in TryShowQueuedArcadeBattle establish ownership.
  ScriptTakeoffRequested: Boolean = False; // @addr 0x87B7B0
  StagedArcadeShips: TObjectList; // @addr $889C5C  Owns ships waiting for an arcade request.
  ScriptEndTurnRequested: Boolean = False; // @addr 0x87B7B4
  ScriptFunctionScope: TVarArrayEC; // @addr 0x889C60
  ScriptProcess: TCodeProcessEC; // @addr 0x889C64
  ScriptDialogOverrides: TObjectList; // @addr 0x889C68  Record entries are freed explicitly before clearing.
  ScriptLibraryCache: TLibraryCache = nil; // @addr 0x87B7B8
  ArtefactScriptCache: TScriptCache = nil; // @addr $87B7BC @note "Named artifact action code via TArtefact.GetActionCode."
  ArtefactKindScriptCache: TScriptCache = nil; // @addr $87B7C0 @note "Item-type artifact action code; item types 8 and 9 use the named artifact cache instead."
  UselessItemScriptCache: TScriptCache = nil; // @addr $87B7C4
  CustomShipInfoScriptCache: TScriptCache = nil; // @addr $87B7C8
  GameplayUiScriptCache: TScriptGICache = nil; // @addr 0x87B7CC
  CurrentScriptState: TScriptState = nil; // @addr 0x87B7D0
  ScriptDialogInjections: TObjectList; // @addr 0x889C6C
  ScriptDialogBlocks: TObjectList; // @addr 0x889C70
  ScriptRequestThread: TScriptThread; // @addr 0x889C74

procedure LogScriptCallHistory; // @addr 0x66AA00
procedure ClearPendingScriptRequests; // @addr 0x66ACF4
function HasPendingScriptRequests: Boolean; // @addr 0x66ADF0
function TryShowQueuedArcadeBattle: Boolean; // @addr 0x66AE44
function TryShowQueuedTextQuest: Boolean; // @addr 0x66AEF0
function TryRunQueuedPlanetaryBattle: Boolean; // @addr 0x66AF80
function TryShowQueuedVideo: Boolean; // @addr 0x66B1F8
function TryDispatchScriptTakeoff: Boolean; // @addr 0x66B3AC
function TryDispatchScriptEndTurn: Boolean; // @addr 0x66B43C
function TryDispatchResumingScriptRequest: Boolean; // @addr 0x66B504 @note "Moves the first request belonging to ResumingScript to its queue's front."
function DispatchPendingScriptRequests: Boolean; // @addr 0x66B6D4
procedure StartScriptRequestThread; // @addr 0x66B74C
procedure CompleteQueuedArcadeBattle(Status: Integer); // @addr 0x66B888 @note "Requires a nonempty queue. Clears ResumingScript when no requests remain; preserves GABStatus changed by the script."
procedure CompleteQueuedTextQuest(Status: TScriptQuestStatus); // @addr 0x66B978 @note "Requires a nonempty queue. Clears ResumingScript when no requests remain; preserves GQuestStatus changed by the script."
procedure CompleteQueuedPlanetaryBattle(Status: Integer); // @addr 0x66BA58 @note "Requires a nonempty queue. Clears ResumingScript when no requests remain; preserves GRobotStatus changed by the script."
procedure CompleteQueuedVideo(Status: Integer); // @addr 0x66BB38 @note "Requires a nonempty queue when a player exists. Clears ResumingScript when no requests remain; preserves GVideoStatus changed by the script."
procedure LogScriptStepCount(ExpressionCount: Integer); // @addr 0x66BC28

procedure InitializeScriptEngine; // @addr 0x66BCF8
procedure FinalizeScriptEngine; // @addr 0x66BD3C
procedure RunGlobalScriptsForContext(Star: TStar; RunFrom: Integer); // @addr 0x66BD74
function TryStartScriptByName(AnchorStar: TStar; AnchorPlanet: TPlanet; Name: WideString): Boolean; // @addr 0x66BFF4
function TryStartScriptInstanceFromTemplate(AnchorStar: TStar; AnchorPlanet: TPlanet; TemplateIndex: Integer): Boolean; // @addr 0x66C068
function TryRestartScript(Script: TScript; AnchorStar: TStar; AnchorPlanet: TPlanet): Boolean; // @addr 0x66C158 @note "Replaces and frees Script on success; retains it on failure. Requires an existing Galaxy.Scripts entry."
procedure CompileScriptTemplateCondition(TemplateIndex: Integer); // @addr 0x66C2E4
function IsStarProtectedByScript(Star: TStar): Boolean; // @addr 0x66C560
function ScriptDefinitionBit(Value: Cardinal; BitIndex: Integer): Boolean; // @addr 0x66C618
function DecodeScriptRaceMask(Value: Cardinal): TOwnerMask; // @addr 0x66C63C
function DecodeScriptOwnerMask(Value: Cardinal): TOwnerMask; // @addr 0x66C718 @note "Bit 9 also selects the player's current owner ID."
function DecodeScriptEconomyMask(Value: Cardinal): TScriptEconomyMask; // @addr 0x66C888
function DecodeScriptGovernmentMask(Value: Cardinal): TScriptGovernmentMask; // @addr 0x66C920
function DecodeScriptShipTypeMask(Value: Cardinal): TScriptShipTypeMask; // @addr 0x66C9FC
function DecodeScriptDominatorMask(Value: Cardinal; KlingType: Byte): TDominatorSeriesMask; // @addr 0x66CB64
function DecodeScriptItemOwner(Value: Integer): Byte; // @addr 0x66CEBC @note "Values outside 0..7 become owner 6."
function DecodeScriptRelationLevel(Value: Integer): TRelationLevel; // @addr 0x66CF30 @note "Values outside 0..4 become hostile."
function ScriptShipMatchesType(Ship: TShip; ShipTypeMask: TScriptShipTypeMask; StationNames: WideString; DominatorMasks: array of TDominatorSeriesMask): Boolean; // @addr 0x66CF80 @note "DominatorMasks requires eight entries indexed by TKlingType. StationNames is a comma-separated filter when ship-type bit 8 is set."
function CollectScriptCandidateShips(Star: TStar): TList; // @addr 0x66D150 @note "Caller owns the list; ship references are borrowed."
function FindScriptGroupCandidate(Candidates: TList; Group: TScriptGroup): TShip; // @addr 0x66D478 @note "Returns the first match or nil; leaves Candidates unchanged."
function GetScriptShipBindingForContext(Ship: TShip; Script: TScript): TScriptShip; // @addr 0x66D758 @note "The player may have multiple bindings; ordinary ships have one."
procedure ClearScriptDialogRules; // @addr 0x676754
procedure ExecuteScriptText(SourceText: WideString; Scope: TVarArrayEC); // @addr 0x6773F0 @note "Nil Scope temporarily clears CurrentScript. Compiled code is freed after execution."
function CompileScriptText(SourceText: WideString): TCodeEC; // @addr 0x67767C @note "Caller owns the returned code."
procedure RunScriptCode(ContextName: WideString; Code, ParentCode: TCodeEC); // @addr 0x6777F4
function GetCachedActionCode(var Cache: TScriptCache; Name: WideString; Config: TBlockParEC): TScriptCacheUnit; // @addr 0x678570
procedure ExecuteGameplayUiCode(Block: TBlockParEC; VirtualKey: Cardinal); // @addr 0x6785F0 @note "Runs with CurrentScript nil. VirtualKey=0 leaves KEY and KEYMOD unchanged."
procedure ScriptSnap(out Snapshot: TScriptContextSnapshot); // @addr 0x678948 @note "When CurrentScript is nil, only Snapshot.Script is written."
procedure ScriptUnSnap(Snapshot: TScriptContextSnapshot); // @addr 0x6789B4 @ida "void __usercall $name(TScriptContextSnapshot *Snapshot@<eax>);"
function RunItemUseCode(Item: TItem; Ship: TShip): Integer; // @addr 0x6794F8 @note "Returns ScriptItemActParam, initially zero."
function RunItemConfigActionCode(Item: TItem; ActionType: Byte; Ship: TShip; Object1, Object2: TObject; Param: Integer): Integer; // @addr 0x67970C @note "Uses artifact or useless-item configuration code. Object slots can carry event-specific integers."
function RunCustomShipInfoActionCode(Info: PCustomShipInfo; ActionType: Byte; Ship: TShip; Object1, Object2: TObject; Param: Integer): Integer; // @addr 0x679B04 @note "Returns the event parameter after script changes. Object slots can carry event-specific integers."
function GetScriptContextDescription: WideString; // @addr 0x67A194 @ida "void __usercall $name(unsigned __int16 **Result@<eax>);"
...
{ @routine $66AA00 LogScriptCallHistory }
...
{ @routine $66ACF4 ClearPendingScriptRequests }
...
{ @routine $66ADF0 HasPendingScriptRequests }
...
{ @routine $66AE44 TryShowQueuedArcadeBattle }
...
{ @routine $66AEF0 TryShowQueuedTextQuest }
...
{ @routine $66AF80 TryRunQueuedPlanetaryBattle }
...
{ @routine $66B1F8 TryShowQueuedVideo }
...
{ @routine $66B3AC TryDispatchScriptTakeoff }
...
{ @routine $66B43C TryDispatchScriptEndTurn }
...
{ @routine $66B504 TryDispatchResumingScriptRequest }
...
{ @routine $66B6D4 DispatchPendingScriptRequests }
...
{ @routine $66B74C StartScriptRequestThread }
...
{ @routine $66B770 TScriptThread_Create }
...
{ @routine $66B7B4 TScriptThread_Execute }
...
{ @routine $66B888 CompleteQueuedArcadeBattle }
...
{ @routine $66B978 CompleteQueuedTextQuest }
...
{ @routine $66BA58 CompleteQueuedPlanetaryBattle }
...
{ @routine $66BB38 CompleteQueuedVideo }
...
{ @routine $66BC28 LogScriptStepCount }
...
{ @routine $66BCF8 InitializeScriptEngine }
...
{ @routine $66BD3C FinalizeScriptEngine }
...
{ @routine $66BD74 RunGlobalScriptsForContext }
...
{ @routine $66BFF4 TryStartScriptByName }
...
{ @routine $66C068 TryStartScriptInstanceFromTemplate }
...
{ @routine $66C158 TryRestartScript }
...
{ @routine $66C2E4 CompileScriptTemplateCondition }
...
{ @routine $66C560 IsStarProtectedByScript }
...
{ @routine $66C618 ScriptDefinitionBit }
...
{ @routine $66C63C DecodeScriptRaceMask }
...
{ @routine $66C718 DecodeScriptOwnerMask }
...
{ @routine $66C888 DecodeScriptEconomyMask }
...
{ @routine $66C920 DecodeScriptGovernmentMask }
...
{ @routine $66C9FC DecodeScriptShipTypeMask }
...
{ @routine $66CB64 DecodeScriptDominatorMask }
...
{ @routine $66CEBC DecodeScriptItemOwner }
...
{ @routine $66CF30 DecodeScriptRelationLevel }
...
{ @routine $66CF80 ScriptShipMatchesType }
...
{ @routine $66D150 CollectScriptCandidateShips }
...
{ @routine $66D478 FindScriptGroupCandidate }
...
{ @routine $66D758 GetScriptShipBindingForContext }
...
{ @routine $66D7D8 TScriptStar_Create }
...
{ @routine $66D84C TScriptStar_Destroy }
...
{ @routine $66D8B0 TScriptConstellation_Create }
...
{ @routine $66D8F4 TScriptConstellation_Destroy }
...
{ @routine $66D928 TScriptShip_Create }
...
{ @routine $66D96C TScriptShip_Destroy }
...
{ @routine $66D9BC TScriptShip_GetGroup }
...
{ @routine $66D9E4 TScriptPlace_Create }
...
{ @routine $66DA28 TScriptPlace_Destroy }
...
{ @routine $66DA5C TScriptPlace_GetPoint }
...
{ @routine $66DF08 TScriptPlace_GetRandomPoint }
...
{ @routine $66E070 TScriptPlace_ShipInPlace }
...
{ @routine $66E0E4 TScriptItem_Create }
...
{ @routine $66E13C TScriptItem_Destroy }
...
{ @routine $66E1A8 TScriptGroup_Create }
...
{ @routine $66E1EC TScriptGroup_Destroy }
...
{ @routine $66E23C TScriptState_Create }
...
{ @routine $66E298 TScriptState_Destroy }
...
{ @routine $66E35C TScriptDialog_Create }
...
{ @routine $66E3B0 TScriptDialog_Destroy }
...
{ @routine $66E400 TScriptDialogMsg_Create }
...
{ @routine $66E454 TScriptDialogMsg_Destroy }
...
{ @routine $66E4A4 TScriptDialogAnswer_Create }
...
{ @routine $66E50C TScriptDialogAnswer_Destroy }
...
{ @routine $66E6D4 TScript_Destroy }
...
{ @routine $66EC40 TScript_PublishShipContext }
...
{ @routine $66ECD0 TScript_PublishCurrentShip }
...
{ @routine $66ED24 TScript_GetStar }
...
{ @routine $66EE48 TScript_GetPlanetBinding }
...
{ @routine $66EFB0 TScript_GetItem }
...
{ @routine $66F0CC TScript_RunShipState }
...
{ @routine $66F34C TScript_RunTurnCode }
...
{ @routine $66F4EC TScript_RunAuxiliaryCode }
...
{ @routine $66F690 TScript_CallDialog }
...
{ @routine $66F958 TScript_CallDialogByVariable }
...
{ @routine $66FA64 TScript_CallDialogMessage }
...
{ @routine $66FD14 TScript_BuildDialogAnswer }
...
{ @routine $66FFD4 TScript_ExecuteDialogAnswer }
...
{ @routine $670284 TScript_BindShip }
...
{ @routine $670338 TScript_UnbindShip }
...
{ @routine $670428 TScript_ClearShipBindings }
...
{ @routine $67051C TScript_ChangeState }
...
{ @routine $6705B4 TScript_SetGroupRelation }
...
{ @routine $670680 TScript_SetPlanetRelation }
...
{ @routine $6706F8 TScript_TryBindStars }
...
{ @routine $671518 TScript_LoadFromBuffer }
...
var
  ...
  // @nested $6711A8 CompileStateActionCode
  procedure CompileStateActionCode(State: TScriptState); // @addr 0x6711A8 @ida "void __usercall $name(TScriptState *State@<eax>, void *ParentFrame@<^0>);" @note "Nested helper; captures Self at ParentFrame-4. Caller removes ParentFrame."
  var
...
{ @routine $674BA8 TScript_LoadFromFile }
...
{ @routine $674D1C TScript_SaveState }
...
{ @routine $67551C TScript_LoadState }
...
{ @routine $676280 TScript_BindImportedFunctions }
...
{ @routine $6764E4 TScript_ResolveLoadedReferences }
...
{ @routine $676754 ClearScriptDialogRules }
...
{ @routine $676880 TLibraryHandler_Create }
...
{ @routine $67691C TLibraryHandler_Destroy }
...
{ @routine $676988 TLibraryHandler_InitFunction }
...
{ @routine $676E70 TLibraryHandler_InitAllFunctions }
...
{ @routine $676FA0 TLibraryCache_Create }
...
{ @routine $676FF4 TLibraryCache_Destroy }
...
{ @routine $67718C TLibraryCache_GetLib }
...
var
  ...
  // @nested $677030 LoadHandler
  function LoadHandler: TLibraryHandler; // @addr 0x677030 @ida "TLibraryHandler *__cdecl $name(void *ParentFrame);" @note "Nested helper; captures the library name at ParentFrame-4. Returns nil when its ScriptLibs block is absent."
  var
    Module: Cardinal;
...
{ @routine $67736C TLibraryCache_InitFunction }
...
{ @routine $6773F0 ExecuteScriptText }
...
{ @routine $67767C CompileScriptText }
...
{ @routine $677A44 TScriptCache_Create }
...
{ @routine $677A98 TScriptGICache_Create }
...
{ @routine $677AEC TScriptCache_Destroy }
...
{ @routine $677B30 TScriptGICache_Destroy }
...
{ @routine $677BFC TScriptGICache_GetOrCompile }
...
var
  ...
  // @nested $677B74 CreateUiCacheEntry
  function CreateUiCacheEntry: TScriptGICacheUnit; // @addr $677B74 @ida "TScriptGICacheUnit *__cdecl $name(void *ParentFrame);" @note "Nested helper; captures Block at ParentFrame-4."
  var
    Text: WideString;
  begin
    Result := nil;
...
{ @routine $677EE4 TScriptCache_GetOrCompile }
...
var
  ...
  // @nested $677DAC CreateEntry
  function CreateEntry: TScriptCacheUnit; // @addr 0x677DAC @ida "TScriptCacheUnit *__cdecl $name(void *ParentFrame);" @note "Nested helper; captures source block, config, and name at ParentFrame-4, -8, and -12. Caller owns a non-nil result."
  var
...
{ @routine $678140 TScriptCacheUnit_Create }
...
{ @routine $67818C TScriptCacheUnit_Destroy }
...
{ @routine $6781DC TScriptCacheUnit_Initialize }
...
{ @routine $678468 TScriptGICacheUnit_Create }
...
{ @routine $6784B4 TScriptGICacheUnit_Destroy }
...
{ @routine $678504 TScriptGICacheUnit_Initialize }
...
{ @routine $678570 GetCachedActionCode }
...
{ @routine $6785F0 ExecuteGameplayUiCode }
...
{ @routine $678A50 TScriptItem_CompileActionCode }
...
{ @routine $678DD0 TScriptItem_RunActionCode }
...
{ @routine $679198 TScriptShip_RunActionCode }
...
{ @routine $67970C RunItemConfigActionCode }
...
{ @routine $679B04 RunCustomShipInfoActionCode }
...
{ @routine $679FA0 TScriptItem_FormatDataText }
...
{ @routine $67A194 GetScriptContextDescription }
