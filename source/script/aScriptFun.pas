unit aScriptFun;
// Unit bracket (inferred): .text 0x006236EC..0x00663C0C; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
procedure SF_GRun(av: array of TVarEC; code: TCodeEC); // @addr 0x6236EC
procedure SF_GCntRun(av: array of TVarEC; code: TCodeEC); // @addr 0x623720
procedure SF_GLastTurnRun(av: array of TVarEC; code: TCodeEC); // @addr 0x623834
procedure SF_GAllCntRun(av: array of TVarEC; code: TCodeEC); // @addr 0x623980
procedure SF_IsScriptActive(av: array of TVarEC; code: TCodeEC); // @addr 0x623A34
procedure SF_GetValueFromScript(av: array of TVarEC; code: TCodeEC); // @addr 0x623B1C
procedure SF_RunFunctionFromScript(av: array of TVarEC; code: TCodeEC); // @addr 0x623F84
procedure SF_GetVariableName(av: array of TVarEC; code: TCodeEC); // @addr 0x624450
procedure SF_GetVariableType(av: array of TVarEC; code: TCodeEC); // @addr 0x6244D4
procedure SF_StatusPlayer(av: array of TVarEC; code: TCodeEC); // @addr 0x625868
procedure SF_AddPlanetNews(av: array of TVarEC; code: TCodeEC); // @addr 0x62455C
procedure SF_AddJournalRecord(av: array of TVarEC; code: TCodeEC); // @addr 0x624654
procedure SF_AutoBattle(av: array of TVarEC; code: TCodeEC); // @addr 0x624820
procedure SF_GetOwner(av: array of TVarEC; code: TCodeEC); // @addr 0x62489C
procedure SF_GiveReward(av: array of TVarEC; code: TCodeEC); // @addr 0x62492C
procedure SF_GiveRewardByNom(av: array of TVarEC; code: TCodeEC); // @addr 0x624A5C
procedure SF_CountReward(av: array of TVarEC; code: TCodeEC); // @addr 0x624AF0
procedure SF_CountRewardByNom(av: array of TVarEC; code: TCodeEC); // @addr 0x624D74
procedure SF_DeleteRewardByNom(av: array of TVarEC; code: TCodeEC); // @addr 0x624E6C
procedure SF_Rnd(av: array of TVarEC; code: TCodeEC); // @addr 0x62568C
procedure SF_GameDateTxtByTurn(av: array of TVarEC; code: TCodeEC); // @addr 0x6257A8
procedure SF_Id(av: array of TVarEC; code: TCodeEC); // @addr 0x6258D4
procedure SF_SetName(av: array of TVarEC; code: TCodeEC); // @addr 0x625C08
procedure SF_UseTranclucator(av: array of TVarEC; code: TCodeEC); // @addr 0x625D7C
procedure SF_HullDamage(av: array of TVarEC; code: TCodeEC); // @addr 0x626054
procedure SF_Hitpoints(av: array of TVarEC; code: TCodeEC); // @addr 0x626138
procedure SF_Hit(av: array of TVarEC; code: TCodeEC); // @addr 0x626200
procedure SF_ChangeGlobalRelationsShips(av: array of TVarEC; code: TCodeEC); // @addr 0x626304
procedure SF_ChangeGlobalRelationsPlanets(av: array of TVarEC; code: TCodeEC); // @addr 0x62649C
procedure SF_GlobalRelationsShips(av: array of TVarEC; code: TCodeEC); // @addr 0x626610
procedure SF_GlobalRelationsPlanets(av: array of TVarEC; code: TCodeEC); // @addr 0x626758
procedure SF_SetRelationGroup(av: array of TVarEC; code: TCodeEC); // @addr 0x62688C
procedure SF_SetRelationPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x62692C
procedure SF_GetRelationPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x6269CC
procedure SF_CurTurn(av: array of TVarEC; code: TCodeEC); // @addr 0x626A6C
procedure SF_ShipType(av: array of TVarEC; code: TCodeEC); // @addr 0x626AC8
procedure SF_ConName(av: array of TVarEC; code: TCodeEC); // @addr 0x626D04
procedure SF_StarName(av: array of TVarEC; code: TCodeEC); // @addr 0x626E04
procedure SF_StarMapLabel(av: array of TVarEC; code: TCodeEC); // @addr 0x626E88
procedure SF_PlanetName(av: array of TVarEC; code: TCodeEC); // @addr 0x626F68
procedure SF_IdToPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x626FEC
procedure SF_IdToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x62707C
procedure SF_IdToItem(av: array of TVarEC; code: TCodeEC); // @addr 0x627124
procedure SF_PlanetSetGoods(av: array of TVarEC; code: TCodeEC); // @addr 0x6271B4
procedure SF_ShipName(av: array of TVarEC; code: TCodeEC); // @addr 0x627254
procedure SF_ShipRank(av: array of TVarEC; code: TCodeEC); // @addr 0x627310
procedure SF_ShipRankPoints(av: array of TVarEC; code: TCodeEC); // @addr 0x6273A4
procedure SF_ShipNextRankPoints(av: array of TVarEC; code: TCodeEC); // @addr 0x627458
procedure SF_ShipRaiseRank(av: array of TVarEC; code: TCodeEC); // @addr 0x627500
procedure SF_ShipStar(av: array of TVarEC; code: TCodeEC); // @addr 0x6275B4
procedure SF_StarToCon(av: array of TVarEC; code: TCodeEC); // @addr 0x627638
procedure SF_ConNear(av: array of TVarEC; code: TCodeEC); // @addr 0x6276BC
procedure SF_ConStars(av: array of TVarEC; code: TCodeEC); // @addr 0x6277C4
procedure SF_ConStar(av: array of TVarEC; code: TCodeEC); // @addr 0x62784C
procedure SF_GalaxyStars(av: array of TVarEC; code: TCodeEC); // @addr 0x62790C
procedure SF_GalaxyStar(av: array of TVarEC; code: TCodeEC); // @addr 0x627950
procedure SF_StarAngleBetween(av: array of TVarEC; code: TCodeEC); // @addr 0x627A08
procedure SF_FindPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x627B30
procedure SF_IsPlayer(av: array of TVarEC; code: TCodeEC); // @addr 0x629A10
procedure SF_GroupCount(av: array of TVarEC; code: TCodeEC); // @addr 0x629A9C
procedure SF_GroupIn(av: array of TVarEC; code: TCodeEC); // @addr 0x629B70
procedure SF_CountIn(av: array of TVarEC; code: TCodeEC); // @addr 0x629F58
procedure SF_ChangeState(av: array of TVarEC; code: TCodeEC); // @addr 0x62A52C
procedure SF_NearestGroup(av: array of TVarEC; code: TCodeEC); // @addr 0x62A3B4
procedure SF_StarAngle(av: array of TVarEC; code: TCodeEC); // @addr 0x62A738
procedure SF_NewsAdd(av: array of TVarEC; code: TCodeEC); // @addr 0x62A7DC
procedure SF_MsgAdd(av: array of TVarEC; code: TCodeEC); // @addr 0x62A898
procedure SF_Ether(av: array of TVarEC; code: TCodeEC); // @addr 0x62AA0C
procedure SF_CustomEther(av: array of TVarEC; code: TCodeEC); // @addr 0x62ADAC
procedure SF_EtherDelete(av: array of TVarEC; code: TCodeEC); // @addr 0x62B16C
procedure SF_EtherIdAdd(av: array of TVarEC; code: TCodeEC); // @addr 0x62B21C
procedure SF_EtherIdDelete(av: array of TVarEC; code: TCodeEC); // @addr 0x62B2D4
procedure SF_EtherState(av: array of TVarEC; code: TCodeEC); // @addr 0x62B3AC
procedure SF_ConChangeRelationToRanger(av: array of TVarEC; code: TCodeEC); // @addr 0x62B484
procedure SF_GetData(av: array of TVarEC; code: TCodeEC); // @addr 0x62B5AC
procedure SF_SetData(av: array of TVarEC; code: TCodeEC); // @addr 0x62B670
procedure SF_ShipData(av: array of TVarEC; code: TCodeEC); // @addr 0x62B774
procedure SF_Format(av: array of TVarEC; code: TCodeEC); // @addr 0x62B7F4
procedure SF_DeleteTags(av: array of TVarEC; code: TCodeEC); // @addr 0x62BAF8
procedure SF_Dialog(av: array of TVarEC; code: TCodeEC); // @addr 0x62BBBC
procedure SF_DText(av: array of TVarEC; code: TCodeEC); // @addr 0x62BF90
procedure SF_DAddText(av: array of TVarEC; code: TCodeEC); // @addr 0x62C1AC
procedure SF_DAdd(av: array of TVarEC; code: TCodeEC); // @addr 0x62C3D8
procedure SF_DChange(av: array of TVarEC; code: TCodeEC); // @addr 0x62E684
procedure SF_DAnswer(av: array of TVarEC; code: TCodeEC); // @addr 0x62C454
procedure SF_Player(av: array of TVarEC; code: TCodeEC); // @addr 0x62E700
procedure SF_ItemExist(av: array of TVarEC; code: TCodeEC); // @addr 0x62E73C
procedure SF_ItemIn(av: array of TVarEC; code: TCodeEC); // @addr 0x62E7D8
procedure SF_ItemCost(av: array of TVarEC; code: TCodeEC); // @addr 0x637A00
procedure SF_ItemCount(av: array of TVarEC; code: TCodeEC); // @addr 0x62EAA4
procedure SF_ShipPicksItem(av: array of TVarEC; code: TCodeEC); // @addr 0x624FA0
procedure SF_DropItem(av: array of TVarEC; code: TCodeEC); // @addr 0x62513C
procedure SF_DropScriptItem(av: array of TVarEC; code: TCodeEC); // @addr 0x625490
procedure SF_DeleteEquipment(av: array of TVarEC; code: TCodeEC); // @addr 0x625598
procedure SF_DecayGoods(av: array of TVarEC; code: TCodeEC); // @addr 0x62EBBC
procedure SF_UpsurgeGoods(av: array of TVarEC; code: TCodeEC); // @addr 0x62EC78
procedure SF_GoodsAdd(av: array of TVarEC; code: TCodeEC); // @addr 0x62ED10
procedure SF_GoodsCount(av: array of TVarEC; code: TCodeEC); // @addr 0x62EE64
procedure SF_GoodsCost(av: array of TVarEC; code: TCodeEC); // @addr 0x62EF00
procedure SF_GoodsRuinsForBuy(av: array of TVarEC; code: TCodeEC); // @addr 0x62EF9C
procedure SF_ShipGoods(av: array of TVarEC; code: TCodeEC); // @addr 0x62F03C
procedure SF_ShipGoodsIllegalOnPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x62F18C
procedure SF_GoodsDrop(av: array of TVarEC; code: TCodeEC); // @addr 0x62F2B0
procedure SF_UselessItemCreate(av: array of TVarEC; code: TCodeEC); // @addr 0x62F558
procedure SF_GoodsSellPrice(av: array of TVarEC; code: TCodeEC); // @addr 0x62F798
procedure SF_GoodsBuyPrice(av: array of TVarEC; code: TCodeEC); // @addr 0x62F8BC
procedure SF_CountTurn(av: array of TVarEC; code: TCodeEC); // @addr 0x62F9E0
procedure SF_ShipSetBad(av: array of TVarEC; code: TCodeEC); // @addr 0x62FE40
procedure SF_GroupSetBad(av: array of TVarEC; code: TCodeEC); // @addr 0x62FED4
procedure SF_ShipSetPartner(av: array of TVarEC; code: TCodeEC); // @addr 0x62FFB0
procedure SF_ShipJoin(av: array of TVarEC; code: TCodeEC); // @addr 0x6300B8
procedure SF_ShipOut(av: array of TVarEC; code: TCodeEC); // @addr 0x630528
procedure SF_AllShipOut(av: array of TVarEC; code: TCodeEC); // @addr 0x6305B8
procedure SF_ShipInScript(av: array of TVarEC; code: TCodeEC); // @addr 0x6305F0
procedure SF_ShipInGameEvent(av: array of TVarEC; code: TCodeEC); // @addr 0x6306B4
procedure SF_ShipInCurScript(av: array of TVarEC; code: TCodeEC); // @addr 0x6307AC
procedure SF_ShipInNormalSpace(av: array of TVarEC; code: TCodeEC); // @addr 0x630870
procedure SF_ShipInHole(av: array of TVarEC; code: TCodeEC); // @addr 0x630920
procedure SF_ShipIsTakeoff(av: array of TVarEC; code: TCodeEC); // @addr 0x6309F4
procedure SF_ShipCntWeapon(av: array of TVarEC; code: TCodeEC); // @addr 0x630A98
procedure SF_ShipWeapon(av: array of TVarEC; code: TCodeEC); // @addr 0x630B20
procedure SF_ShipEqInSlot(av: array of TVarEC; code: TCodeEC); // @addr 0x630BDC
procedure SF_ArtefactTypeInUse(av: array of TVarEC; code: TCodeEC); // @addr 0x630CC4
procedure SF_ArtefactTypeBoosted(av: array of TVarEC; code: TCodeEC); // @addr 0x630EB8
procedure SF_ShipSpeed(av: array of TVarEC; code: TCodeEC); // @addr 0x631044
procedure SF_EnginePower(av: array of TVarEC; code: TCodeEC); // @addr 0x6310C8
procedure SF_ShipJump(av: array of TVarEC; code: TCodeEC); // @addr 0x631218
procedure SF_ShipArmor(av: array of TVarEC; code: TCodeEC); // @addr 0x63129C
procedure SF_ShipProtectability(av: array of TVarEC; code: TCodeEC); // @addr 0x631320
procedure SF_ShipDroidRepair(av: array of TVarEC; code: TCodeEC); // @addr 0x6313C4
procedure SF_ShipRadarRange(av: array of TVarEC; code: TCodeEC); // @addr 0x631480
procedure SF_ShipScanerPower(av: array of TVarEC; code: TCodeEC); // @addr 0x631508
procedure SF_ShipHookPower(av: array of TVarEC; code: TCodeEC); // @addr 0x631594
procedure SF_ShipHookRange(av: array of TVarEC; code: TCodeEC); // @addr 0x63164C
procedure SF_ShipAverageDamage(av: array of TVarEC; code: TCodeEC); // @addr 0x6316FC
procedure SF_ShipHealthFactor(av: array of TVarEC; code: TCodeEC); // @addr 0x6318F0
procedure SF_ShipHealthFactorStatus(av: array of TVarEC; code: TCodeEC); // @addr 0x631BC0
procedure SF_PlayerImmunity(av: array of TVarEC; code: TCodeEC); // @addr 0x631CF0
procedure SF_ShipStatusEffect(av: array of TVarEC; code: TCodeEC); // @addr 0x631D50
procedure SF_ShipGroup(av: array of TVarEC; code: TCodeEC); // @addr 0x630F9C
procedure SF_ShipCanJump(av: array of TVarEC; code: TCodeEC); // @addr 0x627EF4
procedure SF_ShipInStar(av: array of TVarEC; code: TCodeEC); // @addr 0x628080
procedure SF_ShipInPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x628130
procedure SF_ShipStatistic(av: array of TVarEC; code: TCodeEC); // @addr 0x6281D4
procedure SF_PlayerDominatorStatistic(av: array of TVarEC; code: TCodeEC); // @addr 0x6286A0
procedure SF_ShipMoney(av: array of TVarEC; code: TCodeEC); // @addr 0x628770
procedure SF_ShipFuel(av: array of TVarEC; code: TCodeEC); // @addr 0x62882C
procedure SF_ShipFuelLow(av: array of TVarEC; code: TCodeEC); // @addr 0x62891C
procedure SF_ShipStrengthInBestRanger(av: array of TVarEC; code: TCodeEC); // @addr 0x6289EC
procedure SF_ShipStrengthInAverageRanger(av: array of TVarEC; code: TCodeEC); // @addr 0x628A8C
procedure SF_ChanceToWin(av: array of TVarEC; code: TCodeEC); // @addr 0x628B28
procedure SF_ShipFind(av: array of TVarEC; code: TCodeEC); // @addr 0x629174
procedure SF_RangerStatus(av: array of TVarEC; code: TCodeEC); // @addr 0x628BFC
procedure SF_RangerPlaceInRating(av: array of TVarEC; code: TCodeEC); // @addr 0x628F04
procedure SF_RangerExcludedFromRating(av: array of TVarEC; code: TCodeEC); // @addr 0x628FF8
procedure SF_GalaxyMoney(av: array of TVarEC; code: TCodeEC); // @addr 0x625AAC
procedure SF_ShipDestroy(av: array of TVarEC; code: TCodeEC); // @addr 0x629254 @note "Queues destruction without removing the ship immediately; returns the previous flag. An omitted second argument queues destruction, a negative one only queries."
procedure SF_ShipDestroyType(av: array of TVarEC; code: TCodeEC); // @addr 0x629340
procedure SF_ItemDestroy(av: array of TVarEC; code: TCodeEC); // @addr 0x629470
procedure SF_RangersCapital(av: array of TVarEC; code: TCodeEC); // @addr 0x629550
procedure SF_GroupToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x629590
procedure SF_OrderLanding(av: array of TVarEC; code: TCodeEC); // @addr 0x6298DC
procedure SF_OrderJump(av: array of TVarEC; code: TCodeEC); // @addr 0x629688
procedure SF_GroupIs(av: array of TVarEC; code: TCodeEC); // @addr 0x631EA0
procedure SF_StateIs(av: array of TVarEC; code: TCodeEC); // @addr 0x631FA8
procedure SF_Dist(av: array of TVarEC; code: TCodeEC); // @addr 0x6320F4
procedure SF_Angle(av: array of TVarEC; code: TCodeEC); // @addr 0x63259C
procedure SF_Dist2Star(av: array of TVarEC; code: TCodeEC); // @addr 0x632A44
procedure SF_BuyPirate(av: array of TVarEC; code: TCodeEC); // @addr 0x632AE0
procedure SF_BuyTransport(av: array of TVarEC; code: TCodeEC); // @addr 0x632BB4
procedure SF_Name(av: array of TVarEC; code: TCodeEC); // @addr 0x632CA4
procedure SF_ShortName(av: array of TVarEC; code: TCodeEC); // @addr 0x632EA8
procedure SF_FirstGiveMoney(av: array of TVarEC; code: TCodeEC); // @addr 0x63306C
procedure SF_HaveProgramm(av: array of TVarEC; code: TCodeEC); // @addr 0x6330D0
procedure SF_GetProgramm(av: array of TVarEC; code: TCodeEC); // @addr 0x633160
procedure SF_SetProgramm(av: array of TVarEC; code: TCodeEC); // @addr 0x6331F0
procedure SF_DomikProgramm(av: array of TVarEC; code: TCodeEC); // @addr 0x6332AC
procedure SF_DomikProgrammDate(av: array of TVarEC; code: TCodeEC); // @addr 0x6333D0
procedure SF_HoleMamaCreate(av: array of TVarEC; code: TCodeEC); // @addr 0x63347C
procedure SF_HoleCreate(av: array of TVarEC; code: TCodeEC); // @addr 0x633874
procedure SF_TerronWeaponLock(av: array of TVarEC; code: TCodeEC); // @addr 0x633C10
procedure SF_TerronGrowLock(av: array of TVarEC; code: TCodeEC); // @addr 0x633C54
procedure SF_TerronLandingLock(av: array of TVarEC; code: TCodeEC); // @addr 0x633C98
procedure SF_TerronToStar(av: array of TVarEC; code: TCodeEC); // @addr 0x633CDC
procedure SF_KellerLeave(av: array of TVarEC; code: TCodeEC); // @addr 0x633D20
procedure SF_KellerNewResearch(av: array of TVarEC; code: TCodeEC); // @addr 0x633D64
procedure SF_KellerKill(av: array of TVarEC; code: TCodeEC); // @addr 0x633DA8
procedure SF_BlazerLanding(av: array of TVarEC; code: TCodeEC); // @addr 0x633DDC
procedure SF_BlazerSelfDestruction(av: array of TVarEC; code: TCodeEC); // @addr 0x633ED0
procedure SF_GalaxyShipId(av: array of TVarEC; code: TCodeEC); // @addr 0x633F14
procedure SF_NearCivilPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x633F54
procedure SF_SkipGreeting(av: array of TVarEC; code: TCodeEC); // @addr 0x634060
procedure SF_Sound(av: array of TVarEC; code: TCodeEC); // @addr 0x634098
procedure SF_Tips(av: array of TVarEC; code: TCodeEC); // @addr 0x634148
procedure SF_TipsState(av: array of TVarEC; code: TCodeEC); // @addr 0x6341BC
procedure SF_CT(av: array of TVarEC; code: TCodeEC); // @addr 0x6343C0
procedure SF_BlockExist(av: array of TVarEC; code: TCodeEC); // @addr 0x634700
procedure SF_GetMainData(av: array of TVarEC; code: TCodeEC); // @addr 0x634B3C
procedure SF_GetGameOptions(av: array of TVarEC; code: TCodeEC); // @addr 0x634D9C
procedure SF_ResourceExist(av: array of TVarEC; code: TCodeEC); // @addr 0x634F40
procedure SF_SFT(av: array of TVarEC; code: TCodeEC); // @addr 0x63D008
procedure SF_CurrentMods(av: array of TVarEC; code: TCodeEC); // @addr 0x635008
procedure SF_RobotSupport(av: array of TVarEC; code: TCodeEC); // @addr 0x635158
procedure SF_StarShips(av: array of TVarEC; code: TCodeEC); // @addr 0x6351B0
procedure SF_StarPlanets(av: array of TVarEC; code: TCodeEC); // @addr 0x635290
procedure SF_StarMissiles(av: array of TVarEC; code: TCodeEC); // @addr 0x635374
procedure SF_StarAsteroids(av: array of TVarEC; code: TCodeEC); // @addr 0x635458
procedure SF_GroupShip(av: array of TVarEC; code: TCodeEC); // @addr 0x63553C
procedure SF_ShipItems(av: array of TVarEC; code: TCodeEC); // @addr 0x635638
procedure SF_ShipArts(av: array of TVarEC; code: TCodeEC); // @addr 0x635724
procedure SF_PlayerTranclucators(av: array of TVarEC; code: TCodeEC); // @addr 0x635810
procedure SF_ArtTranclucatorToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x635928
procedure SF_TranclucatorData(av: array of TVarEC; code: TCodeEC); // @addr 0x635A18
procedure SF_LinkItemToScript(av: array of TVarEC; code: TCodeEC); // @addr 0x6364C0
procedure SF_ReleaseItemFromScript(av: array of TVarEC; code: TCodeEC); // @addr 0x6366BC
procedure SF_ScriptItemData(av: array of TVarEC; code: TCodeEC); // @addr 0x636790
procedure SF_ScriptItemTextData(av: array of TVarEC; code: TCodeEC); // @addr 0x636928
procedure SF_ScriptItemToItem(av: array of TVarEC; code: TCodeEC); // @addr 0x636B24
procedure SF_GetShipPirateRank(av: array of TVarEC; code: TCodeEC); // @addr 0x636BF8
procedure SF_ShipPirateRankPoints(av: array of TVarEC; code: TCodeEC); // @addr 0x636C8C
procedure SF_ShipNextPirateRankPoints(av: array of TVarEC; code: TCodeEC); // @addr 0x636D44
procedure SF_ShipInPirateClan(av: array of TVarEC; code: TCodeEC); // @addr 0x636DF4
procedure SF_ShipOnSidePirateClan(av: array of TVarEC; code: TCodeEC); // @addr 0x636EAC
procedure SF_RaisePirateRank(av: array of TVarEC; code: TCodeEC); // @addr 0x636F44
procedure SF_ItemType(av: array of TVarEC; code: TCodeEC); // @addr 0x637018
procedure SF_CustomWeaponType(av: array of TVarEC; code: TCodeEC); // @addr 0x6370E8
procedure SF_ItemName(av: array of TVarEC; code: TCodeEC); // @addr 0x6371E0
procedure SF_ItemFullName(av: array of TVarEC; code: TCodeEC); // @addr 0x6372E4
procedure SF_ItemSize(av: array of TVarEC; code: TCodeEC); // @addr 0x6373EC
procedure SF_ItemOwner(av: array of TVarEC; code: TCodeEC); // @addr 0x637824
procedure SF_ItemSubrace(av: array of TVarEC; code: TCodeEC); // @addr 0x63790C
procedure SF_ItemIsInUse(av: array of TVarEC; code: TCodeEC); // @addr 0x637AE4
procedure SF_ItemIsInSet(av: array of TVarEC; code: TCodeEC); // @addr 0x637D84
procedure SF_PlayerEqSet(av: array of TVarEC; code: TCodeEC); // @addr 0x637F44
procedure SF_ItemIsBroken(av: array of TVarEC; code: TCodeEC); // @addr 0x63804C
procedure SF_ShipCanUseEq(av: array of TVarEC; code: TCodeEC); // @addr 0x638178
procedure SF_ShipCanRepairEq(av: array of TVarEC; code: TCodeEC); // @addr 0x638278
procedure SF_ShipTechLevelKnowledge(av: array of TVarEC; code: TCodeEC); // @addr 0x63837C
procedure SF_WeaponTarget(av: array of TVarEC; code: TCodeEC); // @addr 0x63842C
procedure SF_GetEquipmentStats(av: array of TVarEC; code: TCodeEC); // @addr 0x638554
procedure SF_SetEquipmentStats(av: array of TVarEC; code: TCodeEC); // @addr 0x638CB8
procedure SF_CreateHull(av: array of TVarEC; code: TCodeEC); // @addr 0x6390D8
procedure SF_CreateEquipment(av: array of TVarEC; code: TCodeEC); // @addr 0x6391E8
procedure SF_CreateArt(av: array of TVarEC; code: TCodeEC); // @addr 0x6392DC
procedure SF_CreateCustomWeapon(av: array of TVarEC; code: TCodeEC); // @addr 0x63937C
procedure SF_CreateCustomArt(av: array of TVarEC; code: TCodeEC); // @addr 0x639488
procedure SF_CustomArtData(av: array of TVarEC; code: TCodeEC); // @addr 0x6395C8
procedure SF_CustomArtTextData(av: array of TVarEC; code: TCodeEC); // @addr 0x6397C0
procedure SF_CreateMM(av: array of TVarEC; code: TCodeEC); // @addr 0x639A28
procedure SF_CreateNodes(av: array of TVarEC; code: TCodeEC); // @addr 0x639AC4
procedure SF_CreateCustomCountableItem(av: array of TVarEC; code: TCodeEC); // @addr 0x639BA4
procedure SF_CreateZond(av: array of TVarEC; code: TCodeEC); // @addr 0x639CC0
procedure SF_ExistingZonds(av: array of TVarEC; code: TCodeEC); // @addr 0x639DC0
procedure SF_FreeItem(av: array of TVarEC; code: TCodeEC); // @addr 0x639E98
procedure SF_ShipJoinsClan(av: array of TVarEC; code: TCodeEC); // @addr 0x639F74
procedure SF_AddItemToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x63A030
procedure SF_GetItemFromShip(av: array of TVarEC; code: TCodeEC); // @addr 0x63A27C
procedure SF_GetArtFromShip(av: array of TVarEC; code: TCodeEC); // @addr 0x63A624
procedure SF_ArrangeItems(av: array of TVarEC; code: TCodeEC); // @addr 0x63A75C
procedure SF_AddItemToPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x63A7F4
procedure SF_GetItemFromPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x63A8BC
procedure SF_AddItemToShop(av: array of TVarEC; code: TCodeEC); // @addr 0x63A9C8
procedure SF_GetItemFromShop(av: array of TVarEC; code: TCodeEC); // @addr 0x63AB84
procedure SF_AddItemToStorage(av: array of TVarEC; code: TCodeEC); // @addr 0x63AD64
procedure SF_GetItemFromStorage(av: array of TVarEC; code: TCodeEC); // @addr 0x63AFA4
procedure SF_FindItemInStorage(av: array of TVarEC; code: TCodeEC); // @addr 0x63B098
procedure SF_PutItemInVault(av: array of TVarEC; code: TCodeEC); // @addr 0x63B178
procedure SF_GetItemFromVault(av: array of TVarEC; code: TCodeEC); // @addr 0x63B288
procedure SF_DropItemInSystem(av: array of TVarEC; code: TCodeEC); // @addr 0x63B36C
procedure SF_StopMovingItem(av: array of TVarEC; code: TCodeEC); // @addr 0x63B57C
procedure SF_StarItems(av: array of TVarEC; code: TCodeEC); // @addr 0x63B724
procedure SF_GetItemFromStar(av: array of TVarEC; code: TCodeEC); // @addr 0x63B814
procedure SF_PlanetItems(av: array of TVarEC; code: TCodeEC); // @addr 0x63B9AC
procedure SF_StorageItems(av: array of TVarEC; code: TCodeEC); // @addr 0x63BABC
procedure SF_StorageItemLocation(av: array of TVarEC; code: TCodeEC); // @addr 0x63BB5C
procedure SF_ShopItems(av: array of TVarEC; code: TCodeEC); // @addr 0x63BC20
procedure SF_AddDialogOverride(av: array of TVarEC; code: TCodeEC); // @addr 0x63BF10
procedure SF_AddDialogInject(av: array of TVarEC; code: TCodeEC); // @addr 0x63C110
procedure SF_InjectAnswer(av: array of TVarEC; code: TCodeEC); // @addr 0x63C3B4
procedure SF_AddDialogBlock(av: array of TVarEC; code: TCodeEC); // @addr 0x63C858
procedure SF_GotoGov(av: array of TVarEC; code: TCodeEC); // @addr 0x63CA04
procedure SF_GetShipPlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x63CA64
procedure SF_GetShipHomePlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x63CB14
procedure SF_GetShipRuins(av: array of TVarEC; code: TCodeEC); // @addr 0x63CBA0
procedure SF_GetTalkShip(av: array of TVarEC; code: TCodeEC); // @addr 0x63CC50
procedure SF_GetTalkType(av: array of TVarEC; code: TCodeEC); // @addr 0x63CCE0
procedure SF_TalkByAI(av: array of TVarEC; code: TCodeEC); // @addr 0x63CC8C
procedure SF_ScriptRun(av: array of TVarEC; code: TCodeEC); // @addr 0x63CD20
procedure SF_CreateABShip(av: array of TVarEC; code: TCodeEC); // @addr 0x63D288
procedure SF_ConvertToABShip(av: array of TVarEC; code: TCodeEC); // @addr 0x63D4C0
procedure SF_ABShipModifiers(av: array of TVarEC; code: TCodeEC); // @addr 0x63D870
procedure SF_StartAB(av: array of TVarEC; code: TCodeEC); // @addr 0x63DB44
procedure SF_StartTextQuest(av: array of TVarEC; code: TCodeEC); // @addr 0x63D104 @note "No arguments returns queue length; otherwise queues name and optional success/failure captions, setting GQuestStatus to 1."
procedure SF_StartRobots(av: array of TVarEC; code: TCodeEC); // @addr 0x63DD3C
procedure SF_MarkRobotsMapAsUsed(av: array of TVarEC; code: TCodeEC); // @addr 0x63DF54
procedure SF_ShipOwner(av: array of TVarEC; code: TCodeEC); // @addr 0x63E1E4
procedure SF_ShipPilotRace(av: array of TVarEC; code: TCodeEC); // @addr 0x63E314
procedure SF_ShipSkill(av: array of TVarEC; code: TCodeEC); // @addr 0x63E3D0
procedure SF_ShipFace(av: array of TVarEC; code: TCodeEC); // @addr 0x63E968
procedure SF_ShipFreeExp(av: array of TVarEC; code: TCodeEC); // @addr 0x63EC24
procedure SF_GetShipExpByType(av: array of TVarEC; code: TCodeEC); // @addr 0x63ECD0
procedure SF_CoordX(av: array of TVarEC; code: TCodeEC); // @addr 0x63EE6C @note "Moving a star updates its drawn StarLinks, but not distance caches, sector boundaries or adjacency."
procedure SF_CoordY(av: array of TVarEC; code: TCodeEC); // @addr 0x63F404 @note "Moving a star updates its drawn StarLinks, but not distance caches, sector boundaries or adjacency."
procedure SF_ShipSetCoords(av: array of TVarEC; code: TCodeEC); // @addr 0x63F99C
procedure SF_ShipAngle(av: array of TVarEC; code: TCodeEC); // @addr 0x63FA60
procedure SF_ObjectType(av: array of TVarEC; code: TCodeEC); // @addr 0x63FB34
procedure SF_ShipInHyperSpace(av: array of TVarEC; code: TCodeEC); // @addr 0x63FCD8
procedure SF_ShipStatus(av: array of TVarEC; code: TCodeEC); // @addr 0x63FDA4
procedure SF_BuyRanger(av: array of TVarEC; code: TCodeEC); // @addr 0x63FEC0
procedure SF_BuyWarrior(av: array of TVarEC; code: TCodeEC); // @addr 0x63FF70
procedure SF_BuyBigWarrior(av: array of TVarEC; code: TCodeEC); // @addr 0x640020
procedure SF_BuyDomik(av: array of TVarEC; code: TCodeEC); // @addr 0x6400D4
procedure SF_BuyDomikExtremal(av: array of TVarEC; code: TCodeEC); // @addr 0x640168
procedure SF_BuyTranclucator(av: array of TVarEC; code: TCodeEC); // @addr 0x640274
procedure SF_TransferShip(av: array of TVarEC; code: TCodeEC); // @addr 0x640324
procedure SF_OrderForsage(av: array of TVarEC; code: TCodeEC); // @addr 0x6406B8
procedure SF_OrderNone(av: array of TVarEC; code: TCodeEC); // @addr 0x64081C
procedure SF_OrderMove(av: array of TVarEC; code: TCodeEC); // @addr 0x640924
procedure SF_OrderTeleport(av: array of TVarEC; code: TCodeEC); // @addr 0x640B4C
procedure SF_OrderTakeOff(av: array of TVarEC; code: TCodeEC); // @addr 0x640CF4
procedure SF_OrderFollowShip(av: array of TVarEC; code: TCodeEC); // @addr 0x640D9C
procedure SF_OrderJumpHole(av: array of TVarEC; code: TCodeEC); // @addr 0x640F04
procedure SF_RelationToRanger(av: array of TVarEC; code: TCodeEC); // @addr 0x641048
procedure SF_RelationToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x641298
procedure SF_StarOwner(av: array of TVarEC; code: TCodeEC); // @addr 0x641388
procedure SF_StarBattle(av: array of TVarEC; code: TCodeEC); // @addr 0x641438
procedure SF_StarSeries(av: array of TVarEC; code: TCodeEC); // @addr 0x6414D0
procedure SF_StarHoles(av: array of TVarEC; code: TCodeEC); // @addr 0x641580
procedure SF_StarNearbyStars(av: array of TVarEC; code: TCodeEC); // @addr 0x6416A0
procedure SF_StarNearbyStarsDist(av: array of TVarEC; code: TCodeEC); // @addr 0x641770
procedure SF_StarSetGraph(av: array of TVarEC; code: TCodeEC); // @addr 0x641844
procedure SF_CreatePlanet(av: array of TVarEC; code: TCodeEC); // @addr 0x641990
procedure SF_PlanetSetGraph(av: array of TVarEC; code: TCodeEC); // @addr 0x641AF0
procedure SF_PlanetGetGraph(av: array of TVarEC; code: TCodeEC); // @addr 0x641CEC
procedure SF_PlanetPopulation(av: array of TVarEC; code: TCodeEC); // @addr 0x641D78
procedure SF_PlanetOwner(av: array of TVarEC; code: TCodeEC); // @addr 0x641E24 @note "Updates planet ownership flags, not the containing star's faction or its other planets."
procedure SF_PlanetRace(av: array of TVarEC; code: TCodeEC); // @addr 0x641ED4
procedure SF_PlanetGov(av: array of TVarEC; code: TCodeEC); // @addr 0x641F78
procedure SF_PlanetEco(av: array of TVarEC; code: TCodeEC); // @addr 0x64201C
procedure SF_PlanetTerrain(av: array of TVarEC; code: TCodeEC); // @addr 0x6420C0
procedure SF_PlanetTerrainExplored(av: array of TVarEC; code: TCodeEC); // @addr 0x64229C
procedure SF_PlanetOrbitRadius(av: array of TVarEC; code: TCodeEC); // @addr 0x642418
procedure SF_PlanetOrbitalVelocity(av: array of TVarEC; code: TCodeEC); // @addr 0x6424CC
procedure SF_PlanetSize(av: array of TVarEC; code: TCodeEC); // @addr 0x6425A0
procedure SF_PlanetCurInvention(av: array of TVarEC; code: TCodeEC); // @addr 0x64263C
procedure SF_PlanetCurInventionPoints(av: array of TVarEC; code: TCodeEC); // @addr 0x6426E4
procedure SF_PlanetInventionLevel(av: array of TVarEC; code: TCodeEC); // @addr 0x642798
procedure SF_PlanetBoostInventions(av: array of TVarEC; code: TCodeEC); // @addr 0x64285C
procedure SF_PlanetWarriors(av: array of TVarEC; code: TCodeEC); // @addr 0x64291C
procedure SF_GalaxySectors(av: array of TVarEC; code: TCodeEC); // @addr 0x642A04
procedure SF_GalaxyTechLevel(av: array of TVarEC; code: TCodeEC); // @addr 0x642AA8
procedure SF_GalaxyDominatorResearchPercent(av: array of TVarEC; code: TCodeEC); // @addr 0x642AEC
procedure SF_GalaxyDominatorResearchMaterial(av: array of TVarEC; code: TCodeEC); // @addr 0x642BC4
procedure SF_GalaxyDiffLevels(av: array of TVarEC; code: TCodeEC); // @addr 0x642C9C
procedure SF_SectorVisible(av: array of TVarEC; code: TCodeEC); // @addr 0x642D44
procedure SF_HullHP(av: array of TVarEC; code: TCodeEC); // @addr 0x642E68
procedure SF_HullDamageSuspectibility(av: array of TVarEC; code: TCodeEC); // @addr 0x6432FC
procedure SF_HullType(av: array of TVarEC; code: TCodeEC); // @addr 0x643468
procedure SF_HullSpecial(av: array of TVarEC; code: TCodeEC); // @addr 0x64359C
procedure SF_HullSeries(av: array of TVarEC; code: TCodeEC); // @addr 0x6436D4
procedure SF_GalaxyHoles(av: array of TVarEC; code: TCodeEC); // @addr 0x643808
procedure SF_HoleCreate2(av: array of TVarEC; code: TCodeEC); // @addr 0x6438A4
procedure SF_HoleStar1(av: array of TVarEC; code: TCodeEC); // @addr 0x643BB4
procedure SF_HoleStar2(av: array of TVarEC; code: TCodeEC); // @addr 0x643C58
procedure SF_HoleX1(av: array of TVarEC; code: TCodeEC); // @addr 0x643CFC
procedure SF_HoleY1(av: array of TVarEC; code: TCodeEC); // @addr 0x643DA8
procedure SF_HoleX2(av: array of TVarEC; code: TCodeEC); // @addr 0x643E54
procedure SF_HoleY2(av: array of TVarEC; code: TCodeEC); // @addr 0x643F00
procedure SF_HoleTurnCreate(av: array of TVarEC; code: TCodeEC); // @addr 0x643FAC
procedure SF_HoleMap(av: array of TVarEC; code: TCodeEC); // @addr 0x644060
procedure SF_HoleGraph(av: array of TVarEC; code: TCodeEC); // @addr 0x64414C
procedure SF_StarRuins(av: array of TVarEC; code: TCodeEC); // @addr 0x644298
procedure SF_CreateQuestItem(av: array of TVarEC; code: TCodeEC); // @addr 0x644500
procedure SF_ShipOrder(av: array of TVarEC; code: TCodeEC); // @addr 0x64469C
procedure SF_ShipTurnBeforeEndOrder(av: array of TVarEC; code: TCodeEC); // @addr 0x644608
procedure SF_ShipOrderData1(av: array of TVarEC; code: TCodeEC); // @addr 0x644928
procedure SF_ShipOrderData2(av: array of TVarEC; code: TCodeEC); // @addr 0x6449F8
procedure SF_ShipOrderObj(av: array of TVarEC; code: TCodeEC); // @addr 0x644AC8
procedure SF_ShipDestination(av: array of TVarEC; code: TCodeEC); // @addr 0x644BC4
procedure SF_BuildRuins(av: array of TVarEC; code: TCodeEC); // @addr 0x644D9C
procedure SF_BuildCustomRuins(av: array of TVarEC; code: TCodeEC); // @addr 0x644E60
procedure SF_RuinsChangeType(av: array of TVarEC; code: TCodeEC); // @addr 0x644F74
procedure SF_ShipStanding(av: array of TVarEC; code: TCodeEC); // @addr 0x6450AC
procedure SF_ShipSlots(av: array of TVarEC; code: TCodeEC); // @addr 0x64515C
procedure SF_MissileStar(av: array of TVarEC; code: TCodeEC); // @addr 0x6452EC
procedure SF_MissileType(av: array of TVarEC; code: TCodeEC); // @addr 0x645370
procedure SF_CustomMissileType(av: array of TVarEC; code: TCodeEC); // @addr 0x6453F4
procedure SF_MissileOwner(av: array of TVarEC; code: TCodeEC); // @addr 0x645480
procedure SF_MissileWeaponID(av: array of TVarEC; code: TCodeEC); // @addr 0x645524
procedure SF_MissileTarget(av: array of TVarEC; code: TCodeEC); // @addr 0x6455AC
procedure SF_MissileMaxDamage(av: array of TVarEC; code: TCodeEC); // @addr 0x645670
procedure SF_MissileMinDamage(av: array of TVarEC; code: TCodeEC); // @addr 0x645718
procedure SF_MissileLive(av: array of TVarEC; code: TCodeEC); // @addr 0x6457C0
procedure SF_MissileSpeed(av: array of TVarEC; code: TCodeEC); // @addr 0x645864
procedure SF_MissileAngle(av: array of TVarEC; code: TCodeEC); // @addr 0x645918
procedure SF_AsteroidMinerals(av: array of TVarEC; code: TCodeEC); // @addr 0x6459CC
procedure SF_AsteroidGraph(av: array of TVarEC; code: TCodeEC); // @addr 0x645A74
procedure SF_AsteroidRespawn(av: array of TVarEC; code: TCodeEC); // @addr 0x645BB0
procedure SF_ArrayAdd(Args: array of TVarEC; Code: TCodeEC); // @addr 0x645C3C
procedure SF_ArrayDelete(Args: array of TVarEC; Code: TCodeEC); // @addr 0x645DA4
procedure SF_ArrayClear(Args: array of TVarEC; Code: TCodeEC); // @addr 0x645F1C
procedure SF_ArrayDim(Args: array of TVarEC; Code: TCodeEC); // @addr 0x646004
procedure SF_ArraySort(Args: array of TVarEC; Code: TCodeEC); // @addr 0x6460D4
procedure SF_ArraySortPartial(Args: array of TVarEC; Code: TCodeEC); // @addr 0x646378
procedure SF_ArrayRandomize(Args: array of TVarEC; Code: TCodeEC); // @addr 0x646630
procedure SF_ArrayFind(Args: array of TVarEC; Code: TCodeEC); // @addr 0x64694C
procedure SF_ArrayFindInSorted(Args: array of TVarEC; Code: TCodeEC); // @addr 0x646C30
procedure SF_DistToNearestEnemySystem(av: array of TVarEC; code: TCodeEC); // @addr 0x646F54
procedure SF_StarEnemyThreatLevel(av: array of TVarEC; code: TCodeEC); // @addr 0x647064
procedure SF_BuildListOfQuestPossibleLocations(av: array of TVarEC; code: TCodeEC); // @addr 0x647390
procedure SF_FindItemInShip(av: array of TVarEC; code: TCodeEC); // @addr 0x647824
procedure SF_GalaxyRangers(av: array of TVarEC; code: TCodeEC); // @addr 0x647940
procedure SF_MakeShipEnterStar(av: array of TVarEC; code: TCodeEC); // @addr 0x6479DC
procedure SF_ShipGetBad(av: array of TVarEC; code: TCodeEC); // @addr 0x647BB0
procedure SF_ShipAddDropItem(av: array of TVarEC; code: TCodeEC); // @addr 0x647C40
procedure SF_OrderLock(av: array of TVarEC; code: TCodeEC); // @addr 0x64060C
procedure SF_BonusCount(av: array of TVarEC; code: TCodeEC); // @addr 0x647CF4
procedure SF_SeriesCount(av: array of TVarEC; code: TCodeEC); // @addr 0x647D30
procedure SF_BonusPriority(av: array of TVarEC; code: TCodeEC); // @addr 0x647D6C
procedure SF_BonusIsSpecial(av: array of TVarEC; code: TCodeEC); // @addr 0x647E74
procedure SF_BonusName(av: array of TVarEC; code: TCodeEC); // @addr 0x647F78
procedure SF_BonusNumInCfg(av: array of TVarEC; code: TCodeEC); // @addr 0x648074
procedure SF_SeriesNumInCfg(av: array of TVarEC; code: TCodeEC); // @addr 0x648198
procedure SF_BonusValue(av: array of TVarEC; code: TCodeEC); // @addr 0x6482BC
procedure SF_FindBonusByName(av: array of TVarEC; code: TCodeEC); // @addr 0x6483CC
procedure SF_FindSeriesByName(av: array of TVarEC; code: TCodeEC); // @addr 0x6484D4
procedure SF_FindBonusByCustomTag(av: array of TVarEC; code: TCodeEC); // @addr 0x6485E0
procedure SF_FindBonusByNameInCfg(av: array of TVarEC; code: TCodeEC); // @addr 0x64870C
procedure SF_BonusCustomTag(av: array of TVarEC; code: TCodeEC); // @addr 0x648818
procedure SF_CreateEquipmentWithSpecial(av: array of TVarEC; code: TCodeEC); // @addr 0x64896C
procedure SF_SpecialToEquipment(av: array of TVarEC; code: TCodeEC); // @addr 0x648B04
procedure SF_ModuleToEquipment(av: array of TVarEC; code: TCodeEC); // @addr 0x648F24
procedure SF_EqSpecial(av: array of TVarEC; code: TCodeEC); // @addr 0x649208
procedure SF_EqModule(av: array of TVarEC; code: TCodeEC); // @addr 0x649360
procedure SF_MayAddBonusToEq(av: array of TVarEC; code: TCodeEC); // @addr 0x6494B8
procedure SF_BuildListOfMMByPriority(av: array of TVarEC; code: TCodeEC); // @addr 0x649658
procedure SF_BuildListOfNewShips(av: array of TVarEC; code: TCodeEC); // @addr 0x649B30
procedure SF_PlanetToStar(av: array of TVarEC; code: TCodeEC); // @addr 0x64A244
procedure SF_Chameleon(av: array of TVarEC; code: TCodeEC); // @addr 0x64A2C8
procedure SF_IsChameleon(av: array of TVarEC; code: TCodeEC); // @addr 0x64A570
procedure SF_PlayerChameleonCharges(av: array of TVarEC; code: TCodeEC); // @addr 0x64A620
procedure SF_PlayerChameleonCurType(av: array of TVarEC; code: TCodeEC); // @addr 0x64A6E4
procedure SF_PlayerChameleonDetected(av: array of TVarEC; code: TCodeEC); // @addr 0x64A78C
procedure SF_PlayerLogicChameleon(av: array of TVarEC; code: TCodeEC); // @addr 0x64A858
procedure SF_SwitchToMirrorImage(av: array of TVarEC; code: TCodeEC); // @addr 0x64A91C
procedure SF_EquipmentImageName(av: array of TVarEC; code: TCodeEC); // @addr 0x64ABC4
procedure SF_StarFonImage(av: array of TVarEC; code: TCodeEC); // @addr 0x64AECC
procedure SF_ExtremalTakeOff(av: array of TVarEC; code: TCodeEC); // @addr 0x64AF6C
procedure SF_ForceNextDay(av: array of TVarEC; code: TCodeEC); // @addr 0x64AFA0
procedure SF_ScriptActionsRun(av: array of TVarEC; code: TCodeEC); // @addr 0x64AFD4
procedure SF_StarListToPlanetList(av: array of TVarEC; code: TCodeEC); // @addr 0x64B00C
procedure SF_EndGame(av: array of TVarEC; code: TCodeEC); // @addr 0x64B568
procedure SF_CustomWin(av: array of TVarEC; code: TCodeEC); // @addr 0x64B618
procedure SF_CustomLose(av: array of TVarEC; code: TCodeEC); // @addr 0x64B750
procedure SF_PirateWin(av: array of TVarEC; code: TCodeEC); // @addr 0x64B88C @note "Returns the previous ending; accepts only 1..5 when setting. Does not remove clan objects. Calling at turn zero leaves the ending timestamp zero."
procedure SF_StartVideo(av: array of TVarEC; code: TCodeEC); // @addr 0x64B924
procedure SF_StartMusic(av: array of TVarEC; code: TCodeEC); // @addr 0x64BC84
procedure SF_NoComeKlingToStar(av: array of TVarEC; code: TCodeEC); // @addr 0x64C078
procedure SF_NoDropToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x64C144
procedure SF_NoTargetToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x64C20C
procedure SF_NoTalkToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x64C2BC
procedure SF_NoScanToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x64C3C0
procedure SF_NoJump(av: array of TVarEC; code: TCodeEC); // @addr 0x64C4C4
procedure SF_NoLanding(av: array of TVarEC; code: TCodeEC); // @addr 0x64C53C
procedure SF_NoShopUpdate(av: array of TVarEC; code: TCodeEC); // @addr 0x64C688
procedure SF_PlanetExtraFlags(av: array of TVarEC; code: TCodeEC); // @addr 0x64C7C0
procedure SF_NoDropItem(av: array of TVarEC; code: TCodeEC); // @addr 0x64C8AC
procedure SF_CanSellItem(av: array of TVarEC; code: TCodeEC); // @addr 0x64C994
procedure SF_TruceBetweenShips(av: array of TVarEC; code: TCodeEC); // @addr 0x64CA8C
procedure SF_ShipInPrison(av: array of TVarEC; code: TCodeEC); // @addr 0x64CBDC
procedure SF_ShipPartners(av: array of TVarEC; code: TCodeEC); // @addr 0x64CD3C
procedure SF_PlayerPirates(av: array of TVarEC; code: TCodeEC); // @addr 0x64CE58
procedure SF_ShipIsPartner(av: array of TVarEC; code: TCodeEC); // @addr 0x64CF08
procedure SF_ShipFreeSpace(av: array of TVarEC; code: TCodeEC); // @addr 0x64CFC4
procedure SF_ShipWealth(av: array of TVarEC; code: TCodeEC); // @addr 0x64D058
procedure SF_DomiksDefeated(av: array of TVarEC; code: TCodeEC); // @addr 0x64D0E8
procedure SF_CoalitionDefeated(av: array of TVarEC; code: TCodeEC); // @addr 0x64D300
procedure SF_ShipRefuel(av: array of TVarEC; code: TCodeEC); // @addr 0x64D394
procedure SF_ShipRepairEq(av: array of TVarEC; code: TCodeEC); // @addr 0x64D434
procedure SF_ItemInScript(av: array of TVarEC; code: TCodeEC); // @addr 0x64D538
procedure SF_FindPlanetByAdvancement(av: array of TVarEC; code: TCodeEC); // @addr 0x64D680
procedure SF_StarListToTransitPlanetList(av: array of TVarEC; code: TCodeEC); // @addr 0x64D940
procedure SF_GalaxyEvents(av: array of TVarEC; code: TCodeEC); // @addr 0x64DF0C
procedure SF_GalaxyEventDate(av: array of TVarEC; code: TCodeEC); // @addr 0x64DF50
procedure SF_GalaxyEventType(av: array of TVarEC; code: TCodeEC); // @addr 0x64E018
procedure SF_GalaxyEventData(av: array of TVarEC; code: TCodeEC); // @addr 0x64E0E0
procedure SF_GalaxyEventsTextData(av: array of TVarEC; code: TCodeEC); // @addr 0x64E1E8
procedure SF_PlanetNews(av: array of TVarEC; code: TCodeEC); // @addr 0x64E328
procedure SF_PlanetNewsDate(av: array of TVarEC; code: TCodeEC); // @addr 0x64E36C
procedure SF_PlanetNewsType(av: array of TVarEC; code: TCodeEC); // @addr 0x64E430
procedure SF_PlanetNewsText(av: array of TVarEC; code: TCodeEC); // @addr 0x64E4F4
procedure SF_ControlledSystems(av: array of TVarEC; code: TCodeEC); // @addr 0x64E61C
procedure SF_DeltaWin(av: array of TVarEC; code: TCodeEC); // @addr 0x64E704
procedure SF_ShipInFear(av: array of TVarEC; code: TCodeEC); // @addr 0x64E7BC
procedure SF_CreateGoods(av: array of TVarEC; code: TCodeEC); // @addr 0x64E860
procedure SF_GetNodesFromShip(av: array of TVarEC; code: TCodeEC); // @addr 0x64E924
procedure SF_GetNodesFromStorage(av: array of TVarEC; code: TCodeEC); // @addr 0x64EAE0
procedure SF_RangerBaseNodes(av: array of TVarEC; code: TCodeEC); // @addr 0x64EC94
procedure SF_RuinsAllowModernization(av: array of TVarEC; code: TCodeEC); // @addr 0x64ED44
procedure SF_RuinsMicromoduleChain(av: array of TVarEC; code: TCodeEC); // @addr 0x64EE14
procedure SF_DomikKilledInCurSystem(av: array of TVarEC; code: TCodeEC); // @addr 0x64EFA4
procedure SF_ShipTypeN(av: array of TVarEC; code: TCodeEC); // @addr 0x64F008
procedure SF_ShipSubType(av: array of TVarEC; code: TCodeEC); // @addr 0x64F090
procedure SF_ShipChangeStar(av: array of TVarEC; code: TCodeEC); // @addr 0x64F2BC
procedure SF_IsFilm(av: array of TVarEC; code: TCodeEC); // @addr 0x64F39C
procedure SF_FilmFlags(av: array of TVarEC; code: TCodeEC); // @addr 0x64F3FC
procedure SF_ShowEffect(av: array of TVarEC; code: TCodeEC); // @addr 0x64F5B8
procedure SF_ShowStaticEffect(av: array of TVarEC; code: TCodeEC); // @addr 0x64FE5C
procedure SF_ShipConnect(av: array of TVarEC; code: TCodeEC); // @addr 0x650138
procedure SF_FilmSound(av: array of TVarEC; code: TCodeEC); // @addr 0x650318
procedure SF_FireWeapon(av: array of TVarEC; code: TCodeEC); // @addr 0x65056C
procedure SF_WeaponHit(av: array of TVarEC; code: TCodeEC); // @addr 0x6506A4
procedure SF_DealDamageToShip(av: array of TVarEC; code: TCodeEC); // @addr 0x650850
procedure SF_LaunchMissile(av: array of TVarEC; code: TCodeEC); // @addr 0x65098C
procedure SF_SpawnMissile(av: array of TVarEC; code: TCodeEC); // @addr 0x650B2C
procedure SF_BonusText(av: array of TVarEC; code: TCodeEC); // @addr 0x650D68
procedure SF_PlanetPirateClan(av: array of TVarEC; code: TCodeEC); // @addr 0x651138
procedure SF_Blazer(av: array of TVarEC; code: TCodeEC); // @addr 0x651174
procedure SF_Keller(av: array of TVarEC; code: TCodeEC); // @addr 0x6511B0
procedure SF_Terron(av: array of TVarEC; code: TCodeEC); // @addr 0x6511EC
procedure SF_PirateType(av: array of TVarEC; code: TCodeEC); // @addr 0x651228
procedure SF_PlayerQuestInProgress(av: array of TVarEC; code: TCodeEC); // @addr 0x6512D4
procedure SF_PlayerQuestsCompleted(av: array of TVarEC; code: TCodeEC); // @addr 0x6513A0
procedure SF_QuestsStatusByNom(av: array of TVarEC; code: TCodeEC); // @addr 0x65145C
procedure SF_PlayerPlanetaryBattlesCompleted(av: array of TVarEC; code: TCodeEC); // @addr 0x65162C
procedure SF_PlayerMayTakeSubCrack(av: array of TVarEC; code: TCodeEC); // @addr 0x65166C
procedure SF_SubCrackCost(av: array of TVarEC; code: TCodeEC); // @addr 0x6516C4
procedure SF_ShipCalcParam(av: array of TVarEC; code: TCodeEC); // @addr 0x651704
procedure SF_ShipRefit(av: array of TVarEC; code: TCodeEC); // @addr 0x651780
procedure SF_ShipImproveItems(av: array of TVarEC; code: TCodeEC); // @addr 0x6518A4
procedure SF_ItemImprovement(av: array of TVarEC; code: TCodeEC); // @addr 0x6519F0
procedure SF_ShipFreeFlight(av: array of TVarEC; code: TCodeEC); // @addr 0x651B70
procedure SF_ShipKillFactionInCurSystem(av: array of TVarEC; code: TCodeEC); // @addr 0x651C88
procedure SF_CapitalShipStats(av: array of TVarEC; code: TCodeEC); // @addr 0x651E04
procedure SF_PlayerBridge(av: array of TVarEC; code: TCodeEC); // @addr 0x651FB0
procedure SF_PlayerDebt(av: array of TVarEC; code: TCodeEC); // @addr 0x652090
procedure SF_PlayerDebtDate(av: array of TVarEC; code: TCodeEC); // @addr 0x6520F0
procedure SF_PlayerDebtCnt(av: array of TVarEC; code: TCodeEC); // @addr 0x652150
procedure SF_PlayerDeposit(av: array of TVarEC; code: TCodeEC); // @addr 0x6521B0
procedure SF_PlayerDepositDate(av: array of TVarEC; code: TCodeEC); // @addr 0x652210
procedure SF_PlayerDepositDay(av: array of TVarEC; code: TCodeEC); // @addr 0x652270
procedure SF_PlayerDepositPercent(av: array of TVarEC; code: TCodeEC); // @addr 0x6522D0
procedure SF_PlayerMedPolicy(av: array of TVarEC; code: TCodeEC); // @addr 0x65235C
procedure SF_ShipCustomShipInfosCount(av: array of TVarEC; code: TCodeEC); // @addr 0x6523BC
procedure SF_ShipAddCustomShipInfo(av: array of TVarEC; code: TCodeEC); // @addr 0x652498
procedure SF_ShipDeleteCustomShipInfo(av: array of TVarEC; code: TCodeEC); // @addr 0x65277C
procedure SF_ShipFindCustomShipInfoByType(av: array of TVarEC; code: TCodeEC); // @addr 0x652984
procedure SF_ShipCustomShipInfoDescription(av: array of TVarEC; code: TCodeEC); // @addr 0x652AC0
procedure SF_ShipCustomShipInfoData(av: array of TVarEC; code: TCodeEC); // @addr 0x652E18
procedure SF_ShipCustomShipInfoTextData(av: array of TVarEC; code: TCodeEC); // @addr 0x653134
procedure SF_StarCustomStarInfosCount(av: array of TVarEC; code: TCodeEC); // @addr 0x653480
procedure SF_StarAddCustomStarInfo(av: array of TVarEC; code: TCodeEC); // @addr 0x653514
procedure SF_StarDeleteCustomStarInfo(av: array of TVarEC; code: TCodeEC); // @addr 0x6536AC
procedure SF_StarFindCustomStarInfoByType(av: array of TVarEC; code: TCodeEC); // @addr 0x653838
procedure SF_StarCustomStarInfoData(av: array of TVarEC; code: TCodeEC); // @addr 0x653964
procedure SF_ItemCanBeBroken(av: array of TVarEC; code: TCodeEC); // @addr 0x653C40
procedure SF_ItemFragility(av: array of TVarEC; code: TCodeEC); // @addr 0x653D44
procedure SF_ItemDurability(av: array of TVarEC; code: TCodeEC); // @addr 0x653E40
procedure SF_ItemLevel(av: array of TVarEC; code: TCodeEC); // @addr 0x653F98
procedure SF_ContainerFuel(av: array of TVarEC; code: TCodeEC); // @addr 0x65441C
procedure SF_ItemCharge(av: array of TVarEC; code: TCodeEC); // @addr 0x654518
procedure SF_MissilesToRearm(av: array of TVarEC; code: TCodeEC); // @addr 0x6545D4
procedure SF_WeaponAmmunition(av: array of TVarEC; code: TCodeEC); // @addr 0x65475C
procedure SF_WeaponMaxAmmunition(av: array of TVarEC; code: TCodeEC); // @addr 0x654870
procedure SF_ShipSpecialBonuses(av: array of TVarEC; code: TCodeEC); // @addr 0x654984
procedure SF_ItemExtraSpecials(av: array of TVarEC; code: TCodeEC); // @addr 0x654AD4
procedure SF_ItemExtraSpecialsCountByType(av: array of TVarEC; code: TCodeEC); // @addr 0x654BF4
procedure SF_ItemExtraSpecialsAddByType(av: array of TVarEC; code: TCodeEC); // @addr 0x654D18
procedure SF_ItemExtraSpecialsDeleteByType(av: array of TVarEC; code: TCodeEC); // @addr 0x654F2C
procedure SF_ExecuteCodeFromString(av: array of TVarEC; code: TCodeEC); // @addr 0x6550A0
procedure SF_GenerateCodeStringFromBlock(av: array of TVarEC; code: TCodeEC); // @addr 0x655464
procedure SF_ItemOnUseCode(av: array of TVarEC; code: TCodeEC); // @addr 0x6557DC
procedure SF_ItemOnActCode(av: array of TVarEC; code: TCodeEC); // @addr 0x655904
procedure SF_CreateActCodeEvent(av: array of TVarEC; code: TCodeEC); // @addr 0x655B08
procedure SF_CurItem(av: array of TVarEC; code: TCodeEC); // @addr 0x655F40
procedure SF_CurInfo(av: array of TVarEC; code: TCodeEC); // @addr 0x655FB0
procedure SF_ScriptItemActShip(av: array of TVarEC; code: TCodeEC); // @addr 0x656018
procedure SF_ScriptItemActObject1(av: array of TVarEC; code: TCodeEC); // @addr 0x656080
procedure SF_ScriptItemActObject2(av: array of TVarEC; code: TCodeEC); // @addr 0x6560E8
procedure SF_ScriptItemActParam(av: array of TVarEC; code: TCodeEC); // @addr 0x656234
procedure SF_ScriptItemActionType(av: array of TVarEC; code: TCodeEC); // @addr 0x656150
procedure SF_OnUseCodeTranclucator(av: array of TVarEC; code: TCodeEC); // @addr 0x6562C8
procedure SF_OnUseCodeTransmitter(av: array of TVarEC; code: TCodeEC); // @addr 0x656854
procedure SF_OnUseCodeBlackHole(av: array of TVarEC; code: TCodeEC); // @addr 0x656BF4
procedure SF_OnUseCodeMissileDef(av: array of TVarEC; code: TCodeEC); // @addr 0x6571AC
procedure SF_MessageBox(av: array of TVarEC; code: TCodeEC); // @addr 0x657368
procedure SF_MessageBoxYesNo(av: array of TVarEC; code: TCodeEC); // @addr 0x65747C
procedure SF_CountBox(av: array of TVarEC; code: TCodeEC); // @addr 0x6575C0
procedure SF_NumberBox(av: array of TVarEC; code: TCodeEC); // @addr 0x6577E0
procedure SF_TextBox(av: array of TVarEC; code: TCodeEC); // @addr 0x657AF8
procedure SF_ListBox(av: array of TVarEC; code: TCodeEC); // @addr 0x657C4C
procedure SF_FormCurShip(av: array of TVarEC; code: TCodeEC); // @addr 0x657E90
procedure SF_UselessItemText(av: array of TVarEC; code: TCodeEC); // @addr 0x657F3C
procedure SF_UselessItemData(av: array of TVarEC; code: TCodeEC); // @addr 0x6580A0
procedure SF_GetAchievementSHU(av: array of TVarEC; code: TCodeEC); // @addr 0x6581DC
procedure SF_GetAchievementGIRLSHIRE(av: array of TVarEC; code: TCodeEC); // @addr 0x65821C
procedure SF_GetAchievementGIRLSQUEST(av: array of TVarEC; code: TCodeEC); // @addr 0x658268
procedure SF_GetAchievementPIRATEWIN(av: array of TVarEC; code: TCodeEC); // @addr 0x6582B8
procedure SF_GetAchievementCOALLITION(av: array of TVarEC; code: TCodeEC); // @addr 0x658304
procedure SF_GetAchievementHULL(av: array of TVarEC; code: TCodeEC); // @addr 0x658354
procedure SF_UICheckElement(av: array of TVarEC; code: TCodeEC); // @addr 0x658398
procedure SF_InterfaceState(av: array of TVarEC; code: TCodeEC); // @addr 0x658FAC
procedure SF_InterfaceText(av: array of TVarEC; code: TCodeEC); // @addr 0x659350
procedure SF_InterfaceImage(av: array of TVarEC; code: TCodeEC); // @addr 0x659730
procedure SF_InterfacePos(av: array of TVarEC; code: TCodeEC); // @addr 0x659C98
procedure SF_InterfaceSize(av: array of TVarEC; code: TCodeEC); // @addr 0x659FB4
procedure SF_ButtonClick(av: array of TVarEC; code: TCodeEC); // @addr 0x65A298
procedure SF_SetFocus(av: array of TVarEC; code: TCodeEC); // @addr 0x65A5B4
procedure SF_CurrentForm(av: array of TVarEC; code: TCodeEC); // @addr 0x65AF20
procedure SF_FormShipCurItem(av: array of TVarEC; code: TCodeEC); // @addr 0x65A744
procedure SF_UpdateFormShip(av: array of TVarEC; code: TCodeEC); // @addr 0x65AEAC
procedure SF_FormChange(av: array of TVarEC; code: TCodeEC); // @addr 0x65AF5C
procedure SF_RunChildForm(av: array of TVarEC; code: TCodeEC); // @addr 0x65B208
procedure SF_OpenCustomForm(av: array of TVarEC; code: TCodeEC); // @addr 0x65B580
procedure SF_CloseCustomForm(av: array of TVarEC; code: TCodeEC); // @addr 0x65B644
procedure SF_CustomInterfaceState(av: array of TVarEC; code: TCodeEC); // @addr 0x65B6F4
procedure SF_CustomInterfaceText(av: array of TVarEC; code: TCodeEC); // @addr 0x65B8FC
procedure SF_CustomInterfaceImage(av: array of TVarEC; code: TCodeEC); // @addr 0x65BC7C
procedure SF_CustomInterfacePos(av: array of TVarEC; code: TCodeEC); // @addr 0x65C100
procedure SF_CustomInterfacePosZ(av: array of TVarEC; code: TCodeEC); // @addr 0x65C2A0
procedure SF_CustomInterfaceSize(av: array of TVarEC; code: TCodeEC); // @addr 0x65C438
procedure SF_StarMapCenterView(av: array of TVarEC; code: TCodeEC); // @addr 0x65C5D8
procedure SF_StarMapCurPosX(av: array of TVarEC; code: TCodeEC); // @addr 0x65C780
procedure SF_StarMapCurPosY(av: array of TVarEC; code: TCodeEC); // @addr 0x65C7C8
procedure SF_StarMapCustomSelectionMode(av: array of TVarEC; code: TCodeEC); // @addr 0x65C810
procedure SF_StarMapBlinkingMessage(av: array of TVarEC; code: TCodeEC); // @addr 0x65CA54
procedure SF_CustomWeaponTypes(av: array of TVarEC; code: TCodeEC); // @addr 0x65CD10
procedure SF_InventNewCustomWeapon(av: array of TVarEC; code: TCodeEC); // @addr 0x65CDB8
procedure SF_GetCustomWeaponInfo(av: array of TVarEC; code: TCodeEC); // @addr 0x65D0E0
procedure SF_GetCustomWeaponData(av: array of TVarEC; code: TCodeEC); // @addr 0x65D1AC
procedure SF_GetCustomWeaponPrimaryDamageType(av: array of TVarEC; code: TCodeEC); // @addr 0x65DAB8
procedure SF_SetCustomWeaponAvailability(av: array of TVarEC; code: TCodeEC); // @addr 0x65DBD8
procedure SF_SetCustomWeaponSE(av: array of TVarEC; code: TCodeEC); // @addr 0x65E70C
procedure SF_SetCustomWeaponPrimaryData(av: array of TVarEC; code: TCodeEC); // @addr 0x65DEF4
procedure SF_SetCustomWeaponSizeAndCost(av: array of TVarEC; code: TCodeEC); // @addr 0x65DFD0
procedure SF_SetCustomWeaponDamageData(av: array of TVarEC; code: TCodeEC); // @addr 0x65E084
procedure SF_SetCustomWeaponShotData(av: array of TVarEC; code: TCodeEC); // @addr 0x65E340
procedure SF_SetCustomMissileWeaponStats(av: array of TVarEC; code: TCodeEC); // @addr 0x65E630
procedure SF_StarCustomFaction(av: array of TVarEC; code: TCodeEC); // @addr 0x65E838
procedure SF_ShipCustomFaction(av: array of TVarEC; code: TCodeEC); // @addr 0x65E940
procedure SF_EqCustomFaction(av: array of TVarEC; code: TCodeEC); // @addr 0x65EB08
procedure SF_PlanetCustomFaction(av: array of TVarEC; code: TCodeEC); // @addr 0x65EBE8
procedure SF_ImportedFunction(av: array of TVarEC; code: TCodeEC); // @addr 0x65ECD0
procedure SF_ImportAll(av: array of TVarEC; code: TCodeEC); // @addr 0x65EE00
procedure SF_GalaxyPtr(av: array of TVarEC; code: TCodeEC); // @addr 0x65EEEC

procedure SF_MusicControls(av: array of TVarEC; code: TCodeEC); // @addr 0x64BE14
procedure SF_BlinkingWarning(av: array of TVarEC; code: TCodeEC); // @addr 0x65CB14
procedure InitializeScriptBuiltinsAndConstants(Scope: TVarArrayEC); // @addr 0x65F050
...
{ @routine $623834 SF_GLastTurnRun }
...
{ @routine $623A34 SF_IsScriptActive }
...
{ @routine $623B1C SF_GetValueFromScript }
...
{ @routine $623F84 SF_RunFunctionFromScript }
...
{ @routine $624450 SF_GetVariableName }
...
{ @routine $6244D4 SF_GetVariableType }
...
{ @routine $62455C SF_AddPlanetNews }
...
{ @routine $624654 SF_AddJournalRecord }
...
{ @routine $624A5C SF_GiveRewardByNom }
...
{ @routine $624D74 SF_CountRewardByNom }
...
{ @routine $624E6C SF_DeleteRewardByNom }
...
{ @routine $624FA0 SF_ShipPicksItem }
...
{ @routine $625490 SF_DropScriptItem }
...
{ @routine $625598 SF_DeleteEquipment }
...
{ @routine $6257A8 SF_GameDateTxtByTurn }
...
{ @routine $625868 SF_StatusPlayer }
...
{ @routine $625D7C SF_UseTranclucator }
...
{ @routine $626304 SF_ChangeGlobalRelationsShips }
...
begin
  ...
  begin
    ...
    ShipTypes := av[5].GetDword;
    Owners := av[6].GetDword;
    TRanger(Ranger).ChangeShipRelations(Scope, Mode, av[4].GetInt, THullShipTypeMask(ShipTypes), TOwnerMask(Owners));
  end;
end;
{ @end $626304 }

{ @routine $62649C SF_ChangeGlobalRelationsPlanets }
...
{ @routine $626610 SF_GlobalRelationsShips }
...
{ @routine $626758 SF_GlobalRelationsPlanets }
...
{ @routine $62688C SF_SetRelationGroup }
...
{ @routine $62692C SF_SetRelationPlanet }
...
{ @routine $6269CC SF_GetRelationPlanet }
...
{ @routine $626E88 SF_StarMapLabel }
...
{ @routine $6271B4 SF_PlanetSetGoods }
...
{ @routine $6273A4 SF_ShipRankPoints }
...
{ @routine $627458 SF_ShipNextRankPoints }
...
{ @routine $627500 SF_ShipRaiseRank }
...
{ @routine $627A08 SF_StarAngleBetween }
...
{ @routine $628130 SF_ShipInPlanet }
...
{ @routine $6281D4 SF_ShipStatistic }
...
{ @routine $6286A0 SF_PlayerDominatorStatistic }
...
{ @routine $6289EC SF_ShipStrengthInBestRanger }
...
{ @routine $628A8C SF_ShipStrengthInAverageRanger }
...
{ @routine $628BFC SF_RangerStatus }
...
begin
  ...
  if High(av) > 1 then
  begin
    if av[2].GetString = 'EminentWarrior' then av[0].SetInt(Ord(Galaxy.EminentCareerShips[Ord(rcWarrior)] = Obj))
    else if av[2].GetString = 'EminentTrader' then av[0].SetInt(Ord(Galaxy.EminentCareerShips[Ord(rcTrader)] = Obj))
    else if av[2].GetString = 'EminentPirate' then av[0].SetInt(Ord(Galaxy.EminentCareerShips[Ord(rcPirate)] = Obj))
...
{ @routine $628F04 SF_RangerPlaceInRating }
...
{ @routine $628FF8 SF_RangerExcludedFromRating }
...
begin
  ...
  begin
    ...
    begin
      if Galaxy.EminentCareerShips[Ord(rcTrader)] = Ranger then Galaxy.EminentCareerShips[Ord(rcTrader)] := nil;
      if Galaxy.EminentCareerShips[Ord(rcPirate)] = Ranger then Galaxy.EminentCareerShips[Ord(rcPirate)] := nil;
      if Galaxy.EminentCareerShips[Ord(rcWarrior)] = Ranger then Galaxy.EminentCareerShips[Ord(rcWarrior)] := nil;
    end;
  end;
end;
{ @end $628FF8 }

{ @routine $629174 SF_ShipFind }
...
{ @routine $629340 SF_ShipDestroyType }
...
{ @routine $629550 SF_RangersCapital }
...
{ @routine $6298DC SF_OrderLanding }
...
{ @routine $62A3B4 SF_NearestGroup }
...
{ @routine $62B2D4 SF_EtherIdDelete }
...
{ @routine $62B484 SF_ConChangeRelationToRanger }
...
{ @routine $62EC78 SF_UpsurgeGoods }
...
{ @routine $62EF9C SF_GoodsRuinsForBuy }
...
{ @routine $62F18C SF_ShipGoodsIllegalOnPlanet }
...
{ @routine $62F558 SF_UselessItemCreate }
...
{ @routine $62F798 SF_GoodsSellPrice }
...
{ @routine $62F8BC SF_GoodsBuyPrice }
...
{ @routine $62FFB0 SF_ShipSetPartner }
...
{ @routine $6305F0 SF_ShipInScript }
...
{ @routine $6306B4 SF_ShipInGameEvent }
...
{ @routine $6307AC SF_ShipInCurScript }
...
{ @routine $630870 SF_ShipInNormalSpace }
...
{ @routine $6309F4 SF_ShipIsTakeoff }
...
{ @routine $630A98 SF_ShipCntWeapon }
...
{ @routine $630BDC SF_ShipEqInSlot }
...
{ @routine $630CC4 SF_ArtefactTypeInUse }
...
{ @routine $630EB8 SF_ArtefactTypeBoosted }
...
{ @routine $631320 SF_ShipProtectability }
...
{ @routine $6313C4 SF_ShipDroidRepair }
...
{ @routine $631480 SF_ShipRadarRange }
...
{ @routine $631508 SF_ShipScanerPower }
...
{ @routine $631594 SF_ShipHookPower }
...
{ @routine $63164C SF_ShipHookRange }
...
{ @routine $6316FC SF_ShipAverageDamage }
...
{ @routine $6318F0 SF_ShipHealthFactor }
...
{ @routine $631BC0 SF_ShipHealthFactorStatus }
...
{ @routine $631CF0 SF_PlayerImmunity }
...
{ @routine $631D50 SF_ShipStatusEffect }
...
{ @routine $632BB4 SF_BuyTransport }
...
{ @routine $63306C SF_FirstGiveMoney }
...
{ @routine $6330D0 SF_HaveProgramm }
...
{ @routine $6332AC SF_DomikProgramm }
...
{ @routine $6333D0 SF_DomikProgrammDate }
...
{ @routine $63347C SF_HoleMamaCreate }
...
{ @routine $633C10 SF_TerronWeaponLock }
...
{ @routine $633C54 SF_TerronGrowLock }
...
{ @routine $633C98 SF_TerronLandingLock }
...
{ @routine $633CDC SF_TerronToStar }
...
{ @routine $633D64 SF_KellerNewResearch }
...
{ @routine $633DDC SF_BlazerLanding }
...
{ @routine $633ED0 SF_BlazerSelfDestruction }
...
{ @routine $633F14 SF_GalaxyShipId }
...
{ @routine $633F54 SF_NearCivilPlanet }
...
{ @routine $634060 SF_SkipGreeting }
...
{ @routine $6343C0 SF_CT }
procedure SF_CT(av: array of TVarEC; code: TCodeEC);
var Text: WideString; Block: TBlockParEC;
  // @nested $634240 AddConfigBlock
  procedure AddConfigBlock(Block: TBlockParEC; Dest: TVarEC); // @addr 0x634240 @ida "void __usercall $name(TBlockParEC *Block@<eax>, TVarEC *Dest@<edx>, void *ParentFrame@<^0>);" @note "Nested in SF_CT. Appends to Dest's existing array; empty child blocks contain one vkEmpty placeholder."
...
{ @routine $634B3C SF_GetMainData }
procedure SF_GetMainData(av: array of TVarEC; code: TCodeEC);
var Block: TBlockParEC;
  // @nested $6349BC AddMainDataBlock
  procedure AddMainDataBlock(Block: TBlockParEC; Dest: TVarEC); // @addr 0x6349BC @ida "void __usercall $name(TBlockParEC *Block@<eax>, TVarEC *Dest@<edx>, void *ParentFrame@<^0>);" @note "Nested in SF_GetMainData. Appends to Dest's existing array; empty child blocks contain one vkEmpty placeholder."
  var I: Integer; Value: TVarEC;
  begin
    for I := 0 to Block.GetParamCount - 1 do
    begin
...
{ @routine $634D9C SF_GetGameOptions }
...
{ @routine $634F40 SF_ResourceExist }
...
{ @routine $635374 SF_StarMissiles }
...
{ @routine $635458 SF_StarAsteroids }
...
{ @routine $635810 SF_PlayerTranclucators }
...
{ @routine $635928 SF_ArtTranclucatorToShip }
...
{ @routine $635A18 SF_TranclucatorData }
...
begin
  ...
  case Kind of
    ...
    7: begin
      ...
      if WriteValue then Ship.StoragePermissions[1] := av[3].GetInt <> 0;
    end;
    8: begin
      av[0].SetInt(Ord(Ship.StoragePermissions[2]));
      if WriteValue then Ship.StoragePermissions[2] := av[3].GetInt <> 0;
    end;
    9: begin
      av[0].SetInt(Ord(Ship.CollectionPermissions[0]));
      if WriteValue then Ship.CollectionPermissions[0] := av[3].GetInt <> 0;
    end;
    10: begin
      av[0].SetInt(Ord(Ship.CollectionPermissions[1]));
      if WriteValue then Ship.CollectionPermissions[1] := av[3].GetInt <> 0;
    end;
    11: begin
      av[0].SetInt(Ord(Ship.CollectionPermissions[2]));
      if WriteValue then Ship.CollectionPermissions[2] := av[3].GetInt <> 0;
    end;
    12: begin
      av[0].SetInt(Ord(Ship.CollectionPermissions[3]));
      if WriteValue then Ship.CollectionPermissions[3] := av[3].GetInt <> 0;
    end;
    13: begin
      av[0].SetInt(Ord(Ship.CollectionPermissions[4]));
      if WriteValue then Ship.CollectionPermissions[4] := av[3].GetInt <> 0;
    end;
    14: begin
      av[0].SetInt(Ord(Ship.CollectionPermissions[5]));
      if WriteValue then Ship.CollectionPermissions[5] := av[3].GetInt <> 0;
    end;
    15: begin
      av[0].SetInt(Ord(Ship.CollectionPermissions[6]));
      if WriteValue then Ship.CollectionPermissions[6] := av[3].GetInt <> 0;
    end;
...
{ @routine $6364C0 SF_LinkItemToScript }
...
{ @routine $6366BC SF_ReleaseItemFromScript }
...
{ @routine $636790 SF_ScriptItemData }
...
{ @routine $636928 SF_ScriptItemTextData }
...
{ @routine $636B24 SF_ScriptItemToItem }
...
{ @routine $636BF8 SF_GetShipPirateRank }
...
{ @routine $636C8C SF_ShipPirateRankPoints }
...
{ @routine $636D44 SF_ShipNextPirateRankPoints }
...
{ @routine $636DF4 SF_ShipInPirateClan }
...
{ @routine $636EAC SF_ShipOnSidePirateClan }
...
{ @routine $636F44 SF_RaisePirateRank }
...
{ @routine $6370E8 SF_CustomWeaponType }
...
{ @routine $6372E4 SF_ItemFullName }
...
{ @routine $63804C SF_ItemIsBroken }
...
{ @routine $638178 SF_ShipCanUseEq }
...
{ @routine $638278 SF_ShipCanRepairEq }
...
{ @routine $63837C SF_ShipTechLevelKnowledge }
...
{ @routine $63842C SF_WeaponTarget }
...
{ @routine $638554 SF_GetEquipmentStats }
...
{ @routine $638CB8 SF_SetEquipmentStats }
...
{ @routine $6391E8 SF_CreateEquipment }
...
{ @routine $63937C SF_CreateCustomWeapon }
...
{ @routine $639488 SF_CreateCustomArt }
...
{ @routine $6395C8 SF_CustomArtData }
...
{ @routine $6397C0 SF_CustomArtTextData }
...
{ @routine $639BA4 SF_CreateCustomCountableItem }
...
{ @routine $639DC0 SF_ExistingZonds }
...
{ @routine $639F74 SF_ShipJoinsClan }
...
{ @routine $63A030 SF_AddItemToShip }
...
{ @routine $63A27C SF_GetItemFromShip }
...
{ @routine $63A624 SF_GetArtFromShip }
...
{ @routine $63A75C SF_ArrangeItems }
...
{ @routine $63A7F4 SF_AddItemToPlanet }
...
{ @routine $63A8BC SF_GetItemFromPlanet }
...
{ @routine $63A9C8 SF_AddItemToShop }
...
{ @routine $63AB84 SF_GetItemFromShop }
...
{ @routine $63AD64 SF_AddItemToStorage }
...
{ @routine $63AFA4 SF_GetItemFromStorage }
...
{ @routine $63B098 SF_FindItemInStorage }
...
{ @routine $63B178 SF_PutItemInVault }
...
{ @routine $63B288 SF_GetItemFromVault }
...
{ @routine $63B36C SF_DropItemInSystem }
...
{ @routine $63B57C SF_StopMovingItem }
...
{ @routine $63B814 SF_GetItemFromStar }
...
{ @routine $63BABC SF_StorageItems }
...
{ @routine $63BB5C SF_StorageItemLocation }
...
{ @routine $63BF10 SF_AddDialogOverride }
...
{ @routine $63C110 SF_AddDialogInject }
...
{ @routine $63C3B4 SF_InjectAnswer }
...
{ @routine $63C858 SF_AddDialogBlock }
...
{ @routine $63CA64 SF_GetShipPlanet }
...
{ @routine $63CB14 SF_GetShipHomePlanet }
...
{ @routine $63CBA0 SF_GetShipRuins }
...
{ @routine $63D008 SF_SFT }
procedure SF_SFT(av: array of TVarEC; code: TCodeEC);
var I: Integer;
  // @nested $63CE8C LogArray
  procedure LogArray(Prefix: WideString; Value: TVarEC); // @addr 0x63CE8C @ida "void __usercall $name(unsigned __int16 *Prefix@<eax>, TVarEC *Value@<edx>, void *ParentFrame@<^0>);" @note "Nested in SF_SFT; Value must resolve to an array."
...
{ @routine $63D104 SF_StartTextQuest }
...
{ @routine $63D288 SF_CreateABShip }
...
{ @routine $63D4C0 SF_ConvertToABShip }
...
{ @routine $63D870 SF_ABShipModifiers }
...
{ @routine $63DF54 SF_MarkRobotsMapAsUsed }
...
begin
  ...
  // Native $63E0E2 falls through after matches; the error is unconditional.
  raise Exception.Create(AnsiString('Error.Script MarkRobotsMapAsUsed map not found ' + Name));
end;
{ @end $63DF54 }

{ @routine $63E1E4 SF_ShipOwner }
...
{ @routine $63E314 SF_ShipPilotRace }
...
begin
  ...
  else av[0].SetInt(Ship.BaseSkills[Byte(Skill)]);
  if High(av) > 2 then
  begin
    Value := av[3].GetInt;
...
{ @routine $63ECD0 SF_GetShipExpByType }
...
{ @routine $63F99C SF_ShipSetCoords }
...
{ @routine $63FCD8 SF_ShipInHyperSpace }
...
begin
  ...
  if High(av) > 2 then Ranger.CareerStatus[Index] := av[3].GetInt;
end;
{ @end $63FDA4 }

{ @routine $63FEC0 SF_BuyRanger }
...
{ @routine $640020 SF_BuyBigWarrior }
...
{ @routine $640168 SF_BuyDomikExtremal }
...
{ @routine $640274 SF_BuyTranclucator }
...
{ @routine $640324 SF_TransferShip }
...
{ @routine $6406B8 SF_OrderForsage }
...
{ @routine $640B4C SF_OrderTeleport }
...
{ @routine $640CF4 SF_OrderTakeOff }
...
{ @routine $640D9C SF_OrderFollowShip }
...
{ @routine $640F04 SF_OrderJumpHole }
...
{ @routine $641048 SF_RelationToRanger }
...
{ @routine $641298 SF_RelationToShip }
...
{ @routine $6416A0 SF_StarNearbyStars }
...
{ @routine $641770 SF_StarNearbyStarsDist }
...
{ @routine $641844 SF_StarSetGraph }
...
{ @routine $641990 SF_CreatePlanet }
...
{ @routine $641AF0 SF_PlanetSetGraph }
...
{ @routine $641CEC SF_PlanetGetGraph }
...
{ @routine $641D78 SF_PlanetPopulation }
...
{ @routine $6420C0 SF_PlanetTerrain }
...
{ @routine $64229C SF_PlanetTerrainExplored }
...
{ @routine $642418 SF_PlanetOrbitRadius }
...
{ @routine $6424CC SF_PlanetOrbitalVelocity }
...
{ @routine $64263C SF_PlanetCurInvention }
...
{ @routine $6426E4 SF_PlanetCurInventionPoints }
...
{ @routine $642798 SF_PlanetInventionLevel }
...
{ @routine $64285C SF_PlanetBoostInventions }
...
{ @routine $64291C SF_PlanetWarriors }
...
{ @routine $642A04 SF_GalaxySectors }
...
{ @routine $642AA8 SF_GalaxyTechLevel }
...
{ @routine $642AEC SF_GalaxyDominatorResearchPercent }
...
{ @routine $642BC4 SF_GalaxyDominatorResearchMaterial }
...
{ @routine $642C9C SF_GalaxyDiffLevels }
...
{ @routine $642D44 SF_SectorVisible }
...
{ @routine $6432FC SF_HullDamageSuspectibility }
...
{ @routine $643FAC SF_HoleTurnCreate }
...
{ @routine $644500 SF_CreateQuestItem }
...
{ @routine $644608 SF_ShipTurnBeforeEndOrder }
...
{ @routine $644928 SF_ShipOrderData1 }
...
{ @routine $6449F8 SF_ShipOrderData2 }
...
{ @routine $644AC8 SF_ShipOrderObj }
...
{ @routine $644BC4 SF_ShipDestination }
...
{ @routine $644E60 SF_BuildCustomRuins }
...
{ @routine $644F74 SF_RuinsChangeType }
...
{ @routine $6450AC SF_ShipStanding }
...
{ @routine $6453F4 SF_CustomMissileType }
...
{ @routine $645480 SF_MissileOwner }
...
{ @routine $645524 SF_MissileWeaponID }
...
{ @routine $6455AC SF_MissileTarget }
...
{ @routine $645670 SF_MissileMaxDamage }
...
{ @routine $645718 SF_MissileMinDamage }
...
{ @routine $645864 SF_MissileSpeed }
...
{ @routine $645918 SF_MissileAngle }
...
{ @routine $6459CC SF_AsteroidMinerals }
...
{ @routine $645A74 SF_AsteroidGraph }
...
{ @routine $645BB0 SF_AsteroidRespawn }
...
{ @routine $646378 SF_ArraySortPartial }
...
{ @routine $646630 SF_ArrayRandomize }
...
{ @routine $646C30 SF_ArrayFindInSorted }
...
{ @routine $646F54 SF_DistToNearestEnemySystem }
...
{ @routine $647064 SF_StarEnemyThreatLevel }
...
{ @routine $647390 SF_BuildListOfQuestPossibleLocations }
...
{ @routine $647824 SF_FindItemInShip }
...
{ @routine $647940 SF_GalaxyRangers }
...
{ @routine $6479DC SF_MakeShipEnterStar }
...
{ @routine $647C40 SF_ShipAddDropItem }
...
{ @routine $647D6C SF_BonusPriority }
...
{ @routine $647E74 SF_BonusIsSpecial }
...
{ @routine $648074 SF_BonusNumInCfg }
...
{ @routine $648198 SF_SeriesNumInCfg }
...
{ @routine $6483CC SF_FindBonusByName }
...
{ @routine $6484D4 SF_FindSeriesByName }
...
{ @routine $6485E0 SF_FindBonusByCustomTag }
...
{ @routine $64870C SF_FindBonusByNameInCfg }
...
{ @routine $648818 SF_BonusCustomTag }
...
{ @routine $64896C SF_CreateEquipmentWithSpecial }
...
{ @routine $648B04 SF_SpecialToEquipment }
...
{ @routine $648F24 SF_ModuleToEquipment }
...
{ @routine $6494B8 SF_MayAddBonusToEq }
...
{ @routine $649658 SF_BuildListOfMMByPriority }
...
{ @routine $649B30 SF_BuildListOfNewShips }
...
var MinimumId: Cardinal; Mask: TShipTypeMask; IncludeScripted: Boolean;
  ...
  // @nested $649928 CheckShip
  procedure CheckShip(Ship: TShip); // @addr 0x649928 @ida "void __usercall $name(TShip *Ship@<eax>, void *ParentFrame@<^0>);" @note "Requires SF_BuildListOfNewShips' live frame. The custom-type filter is applied only when the faction filter is enabled."
  ...
  // @nested $649AF0 CheckItem
  procedure CheckItem(Item: TItem); // @addr 0x649AF0 @ida "void __usercall $name(TItem *Item@<eax>, void *ParentFrame@<^0>);" @note "Requires SF_BuildListOfNewShips' live frame. Ignores nil and non-Tranclucator artefacts."
  begin
    if Item <> nil then
...
{ @routine $64A244 SF_PlanetToStar }
...
{ @routine $64A620 SF_PlayerChameleonCharges }
...
{ @routine $64A6E4 SF_PlayerChameleonCurType }
...
{ @routine $64A78C SF_PlayerChameleonDetected }
...
{ @routine $64A858 SF_PlayerLogicChameleon }
...
{ @routine $64A91C SF_SwitchToMirrorImage }
...
{ @routine $64ABC4 SF_EquipmentImageName }
...
begin
  ...
  begin
    Kind := av[1].GetDword;
    if Kind < 256 then av[0].SetString(ItemTypeNames[Byte(Kind)])
    else
    begin
      Obj := TObject(Kind);
      av[0].SetString('');
...
{ @routine $64AECC SF_StarFonImage }
...
{ @routine $64AF6C SF_ExtremalTakeOff }
...
{ @routine $64AFA0 SF_ForceNextDay }
...
{ @routine $64AFD4 SF_ScriptActionsRun }
...
{ @routine $64B00C SF_StarListToPlanetList }
...
{ @routine $64BE14 SF_MusicControls }
...
{ @routine $64C078 SF_NoComeKlingToStar }
...
{ @routine $64C144 SF_NoDropToShip }
...
{ @routine $64C20C SF_NoTargetToShip }
...
{ @routine $64C2BC SF_NoTalkToShip }
...
{ @routine $64C3C0 SF_NoScanToShip }
...
{ @routine $64C688 SF_NoShopUpdate }
...
{ @routine $64C7C0 SF_PlanetExtraFlags }
...
{ @routine $64CA8C SF_TruceBetweenShips }
...
{ @routine $64CBDC SF_ShipInPrison }
...
{ @routine $64CD3C SF_ShipPartners }
...
{ @routine $64CE58 SF_PlayerPirates }
...
{ @routine $64CF08 SF_ShipIsPartner }
...
{ @routine $64CFC4 SF_ShipFreeSpace }
...
{ @routine $64D0E8 SF_DomiksDefeated }
...
{ @routine $64D300 SF_CoalitionDefeated }
...
{ @routine $64D434 SF_ShipRepairEq }
...
{ @routine $64D538 SF_ItemInScript }
...
{ @routine $64D680 SF_FindPlanetByAdvancement }
...
var Score: Integer; Planet: TPlanet; MaxScore, MinScore, TargetScore, BestDistance, Percent, I, J, Faction: Integer; Star: TStar; BestPlanet: TPlanet;
  // @nested $64D5F0 CalcValue
  procedure CalcValue; // @addr 0x64D5F0 @ida "void __cdecl $name(void *ParentFrame);" @note "Nested in SF_FindPlanetByAdvancement; reads its selected planet and writes its local score."
  var I: Byte;
  begin
    Score := 0;
...
{ @routine $64D940 SF_StarListToTransitPlanetList }
...
{ @routine $64DF0C SF_GalaxyEvents }
...
{ @routine $64DF50 SF_GalaxyEventDate }
...
{ @routine $64E018 SF_GalaxyEventType }
...
{ @routine $64E0E0 SF_GalaxyEventData }
...
{ @routine $64E1E8 SF_GalaxyEventsTextData }
...
{ @routine $64E36C SF_PlanetNewsDate }
...
{ @routine $64E430 SF_PlanetNewsType }
...
{ @routine $64E4F4 SF_PlanetNewsText }
...
{ @routine $64E61C SF_ControlledSystems }
...
{ @routine $64E924 SF_GetNodesFromShip }
...
{ @routine $64EAE0 SF_GetNodesFromStorage }
...
{ @routine $64EC94 SF_RangerBaseNodes }
...
{ @routine $64ED44 SF_RuinsAllowModernization }
...
{ @routine $64EE14 SF_RuinsMicromoduleChain }
...
{ @routine $64EFA4 SF_DomikKilledInCurSystem }
...
{ @routine $64F2BC SF_ShipChangeStar }
...
{ @routine $64FE5C SF_ShowStaticEffect }
...
{ @routine $650850 SF_DealDamageToShip }
...
{ @routine $65098C SF_LaunchMissile }
...
{ @routine $650B2C SF_SpawnMissile }
...
{ @routine $650D68 SF_BonusText }
procedure SF_BonusText(av: array of TVarEC; code: TCodeEC);
var Index, Count: Integer; Text: WideString; Bonus: Byte; Value: Integer;
begin
...
{ @routine $651138 SF_PlanetPirateClan }
...
{ @routine $6512D4 SF_PlayerQuestInProgress }
...
{ @routine $6513A0 SF_PlayerQuestsCompleted }
...
{ @routine $65145C SF_QuestsStatusByNom }
...
{ @routine $65162C SF_PlayerPlanetaryBattlesCompleted }
...
{ @routine $65166C SF_PlayerMayTakeSubCrack }
...
{ @routine $6516C4 SF_SubCrackCost }
...
{ @routine $651704 SF_ShipCalcParam }
...
{ @routine $6518A4 SF_ShipImproveItems }
...
{ @routine $6519F0 SF_ItemImprovement }
...
{ @routine $651B70 SF_ShipFreeFlight }
...
{ @routine $651E04 SF_CapitalShipStats }
...
{ @routine $651FB0 SF_PlayerBridge }
...
{ @routine $6520F0 SF_PlayerDebtDate }
...
{ @routine $652150 SF_PlayerDebtCnt }
...
{ @routine $6521B0 SF_PlayerDeposit }
...
{ @routine $652210 SF_PlayerDepositDate }
...
{ @routine $652270 SF_PlayerDepositDay }
...
{ @routine $6522D0 SF_PlayerDepositPercent }
...
{ @routine $65235C SF_PlayerMedPolicy }
...
{ @routine $6523BC SF_ShipCustomShipInfosCount }
...
{ @routine $652498 SF_ShipAddCustomShipInfo }
...
{ @routine $65277C SF_ShipDeleteCustomShipInfo }
...
{ @routine $652984 SF_ShipFindCustomShipInfoByType }
...
{ @routine $652AC0 SF_ShipCustomShipInfoDescription }
...
{ @routine $652E18 SF_ShipCustomShipInfoData }
...
{ @routine $653134 SF_ShipCustomShipInfoTextData }
...
{ @routine $653480 SF_StarCustomStarInfosCount }
...
{ @routine $653514 SF_StarAddCustomStarInfo }
...
{ @routine $6536AC SF_StarDeleteCustomStarInfo }
...
{ @routine $653838 SF_StarFindCustomStarInfoByType }
...
{ @routine $653964 SF_StarCustomStarInfoData }
...
{ @routine $653C40 SF_ItemCanBeBroken }
...
begin
  ...
  if Obj is TItem then Item := TItem(Obj);
  if Obj is TScriptItem then Item := TScriptItem(Obj).Item;
  if Item <> nil then CanBreak := (Byte(Item.ItemType) in [Ord(t_FuelTanks)..Ord(t_CustomWeapon), Ord(t_Satellite)]) or (Byte(Item.ItemType) in [Ord(t_Artefact), Ord(t_ArtefactHull)..Ord(t_ArtefactAntigrav), Ord(t_ArtDefToEnergy)..Ord(t_ArtGiperJump), Ord(t_ArtBio)..Ord(t_ArtFastRacks)]);
  av[0].SetDword(Ord(CanBreak));
end;
{ @end $653C40 }

{ @routine $653D44 SF_ItemFragility }
...
{ @routine $653E40 SF_ItemDurability }
...
{ @routine $65441C SF_ContainerFuel }
...
{ @routine $6545D4 SF_MissilesToRearm }
...
{ @routine $65475C SF_WeaponAmmunition }
...
{ @routine $654870 SF_WeaponMaxAmmunition }
...
{ @routine $654984 SF_ShipSpecialBonuses }
...
{ @routine $654AD4 SF_ItemExtraSpecials }
...
begin
  ...
  if (High(av) = 1) and (Byte(TItem(av[1].GetDword).ItemType) in [Ord(t_Food)..Ord(t_Narcotics)]) then
  begin
    av[0].SetInt(0);
    Exit;
  end;
...
{ @routine $654BF4 SF_ItemExtraSpecialsCountByType }
...
{ @routine $654D18 SF_ItemExtraSpecialsAddByType }
...
{ @routine $654F2C SF_ItemExtraSpecialsDeleteByType }
...
{ @routine $6550A0 SF_ExecuteCodeFromString }
...
{ @routine $655464 SF_GenerateCodeStringFromBlock }
...
{ @routine $6557DC SF_ItemOnUseCode }
...
{ @routine $655904 SF_ItemOnActCode }
...
{ @routine $655B08 SF_CreateActCodeEvent }
...
{ @routine $656018 SF_ScriptItemActShip }
...
{ @routine $656080 SF_ScriptItemActObject1 }
...
{ @routine $6560E8 SF_ScriptItemActObject2 }
...
{ @routine $656150 SF_ScriptItemActionType }
...
{ @routine $656234 SF_ScriptItemActParam }
...
{ @routine $6562C8 SF_OnUseCodeTranclucator }
...
{ @routine $656854 SF_OnUseCodeTransmitter }
...
{ @routine $656BF4 SF_OnUseCodeBlackHole }
...
{ @routine $6571AC SF_OnUseCodeMissileDef }
...
{ @routine $65747C SF_MessageBoxYesNo }
...
{ @routine $657F3C SF_UselessItemText }
...
{ @routine $6580A0 SF_UselessItemData }
...
{ @routine $6581DC SF_GetAchievementSHU }
...
{ @routine $65821C SF_GetAchievementGIRLSHIRE }
...
{ @routine $658268 SF_GetAchievementGIRLSQUEST }
...
{ @routine $6582B8 SF_GetAchievementPIRATEWIN }
...
{ @routine $658304 SF_GetAchievementCOALLITION }
...
{ @routine $658354 SF_GetAchievementHULL }
...
{ @routine $658398 SF_UICheckElement }
...
begin
  ...
  begin
    if Control is TgaiGI then av[0].SetString(TgaiGI(Control).GetImagePath)
...
{ @routine $658FAC SF_InterfaceState }
...
{ @routine $659350 SF_InterfaceText }
...
{ @routine $659730 SF_InterfaceImage }
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        else if Control is TgaiGI then TgaiGI(Control).SetImagePath(av[3].GetString)
...
{ @routine $659C98 SF_InterfacePos }
...
{ @routine $659FB4 SF_InterfaceSize }
...
{ @routine $65A744 SF_FormShipCurItem }
...
{ @routine $65AEAC SF_UpdateFormShip }
...
{ @routine $65AF5C SF_FormChange }
procedure SF_FormChange(av: array of TVarEC; code: TCodeEC);
var Id: TGameScreenId; Name: WideString;
begin
  if High(av) < 1 then
  begin
    if TMessageLoopGI(RegisteredScreens[Ord(RequestedScreenId)]) = nil then av[0].SetString('')
    else av[0].SetString(TMessageLoopGI(RegisteredScreens[Ord(RequestedScreenId)]).RegisteredLoopName);
    Exit;
  end;

  Name := av[1].GetString;
  for Id := screenNone to screenAchievements do
    if (TMessageLoopGI(RegisteredScreens[Ord(Id)]) <> nil) and
      (TObject(RegisteredScreens[Ord(Id)]) is TMessageLoopGI) and
      ((TObject(RegisteredScreens[Ord(Id)]) as TMessageLoopGI).RegisteredLoopName = Name) then
    begin
      ...
      begin
        ...
        if not ((CurrentScreenId <> screenStarMap) and
          (TMessageLoopGI(RegisteredScreens[Ord(CurrentScreenId)]) is TMessageLoopGIWithMainPanel) and
          (TMessageLoopGIWithMainPanel(TMessageLoopGI(RegisteredScreens[Ord(CurrentScreenId)])).MainPanel <> nil)) then
        begin
          ShipReturnScreenId := CurrentScreenId;
          GetInnermostScreenLoop.RequestClose(1);
        end
        else TMessageLoopGIWithMainPanel(TMessageLoopGI(RegisteredScreens[Ord(CurrentScreenId)])).MainPanel.ShipClicked(nil);
      end
      else
      begin
...
{ @routine $65B208 SF_RunChildForm }
...
{ @routine $65B580 SF_OpenCustomForm }
...
{ @routine $65B644 SF_CloseCustomForm }
...
{ @routine $65B6F4 SF_CustomInterfaceState }
...
{ @routine $65B8FC SF_CustomInterfaceText }
...
{ @routine $65BC7C SF_CustomInterfaceImage }
...
begin
  ...
  begin
    if (CountDelimitedPartsW(av[2].GetString, ':') > 1) and
        ...
        else if Control is TgaiGI then TgaiGI(Control).SetImagePath(av[2].GetString)
...
{ @routine $65C100 SF_CustomInterfacePos }
...
{ @routine $65C2A0 SF_CustomInterfacePosZ }
...
{ @routine $65C438 SF_CustomInterfaceSize }
...
{ @routine $65C5D8 SF_StarMapCenterView }
...
begin
  ...
  if (High(av) >= 3) and (TMessageLoopGI(RegisteredScreens[Ord(CurrentScreenId)]) = StarMapScreen) then
  begin
    Count := av[3].GetInt;
    for Index := 0 to Count - 1 do
...
{ @routine $65C780 SF_StarMapCurPosX }
...
{ @routine $65C7C8 SF_StarMapCurPosY }
...
{ @routine $65C810 SF_StarMapCustomSelectionMode }
...
{ @routine $65CA54 SF_StarMapBlinkingMessage }
...
{ @routine $65CB14 SF_BlinkingWarning }
...
begin
  ...
  begin
    ...
    else if TMessageLoopGI(RegisteredScreens[Ord(CurrentScreenId)]) is TMessageLoopGIWithMainPanel then
      TMessageLoopGIWithMainPanel(TMessageLoopGI(RegisteredScreens[Ord(CurrentScreenId)])).MainPanel.FlashMoneyWarning;
  end
  ...
  begin
    if (CurrentScreenId = screenGoodsShop) and GetPlayer.InNormalSpace then GoodsShopScreen.FlashCargoWarning
      ...
      TMessageLoopGIWithMainPanel(TMessageLoopGI(RegisteredScreens[Ord(CurrentScreenId)])).MainPanel.FlashCargoWarning;
  end;
end;
{ @end $65CB14 }

{ @routine $65CD10 SF_CustomWeaponTypes }
...
{ @routine $65CDB8 SF_InventNewCustomWeapon }
...
{ @routine $65D0E0 SF_GetCustomWeaponInfo }
...
{ @routine $65D1AC SF_GetCustomWeaponData }
...
{ @routine $65DAB8 SF_GetCustomWeaponPrimaryDamageType }
...
{ @routine $65DBD8 SF_SetCustomWeaponAvailability }
...
{ @routine $65DEF4 SF_SetCustomWeaponPrimaryData }
...
{ @routine $65DFD0 SF_SetCustomWeaponSizeAndCost }
...
{ @routine $65E084 SF_SetCustomWeaponDamageData }
procedure SF_SetCustomWeaponDamageData(av: array of TVarEC; code: TCodeEC);
type TWeaponDamageFlags = set of 0..31;
const EmptyFlags = [];
var Info: PWeaponInfo; Flag: Byte; Flags: Cardinal; I, Count: Integer; Text: WideString;
begin
  ...
  TWeaponDamageFlags(Flags) := EmptyFlags;
  if av[4].RealVType = vkString then
  begin
    Text := ',' + av[4].GetString + ',';
    for Flag := Low(WeaponDamageFlagNames) to High(WeaponDamageFlagNames) do
      if Pos(',' + WeaponDamageFlagNames[Flag] + ',', Text) > 0 then Include(TWeaponDamageFlags(Flags), Flag);
  end
...
{ @routine $65E340 SF_SetCustomWeaponShotData }
...
{ @routine $65E630 SF_SetCustomMissileWeaponStats }
...
{ @routine $65E70C SF_SetCustomWeaponSE }
...
{ @routine $65E838 SF_StarCustomFaction }
...
{ @routine $65E940 SF_ShipCustomFaction }
...
{ @routine $65EB08 SF_EqCustomFaction }
...
{ @routine $65EBE8 SF_PlanetCustomFaction }
...
{ @routine $65ECD0 SF_ImportedFunction }
...
{ @routine $65F050 InitializeScriptBuiltinsAndConstants }
