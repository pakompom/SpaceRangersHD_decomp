unit ab_W17;
// Unit bracket (inferred): .text 0x0055AEB0..0x0055B759; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
// Native TabW17 projectile family: $55AF18..$55B75A.
...
type
  ...
  public
    ...
    constructor Create; // @addr $55AF18 @ida "TabW17 *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr $55AFA0 @ida "void __usercall $name(TabW17 *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure Launch(Owner: TabObject; Amount: Integer); // @addr $55B014 @ida "void __usercall $name(TabW17 *Self@<eax>, TabObject *Owner@<edx>, int Amount@<ecx>);"
    procedure LaunchPartner(Other: TabW17; Owner: TabObject; Amount: Integer); // @addr $55B164 @ida "void __userpurge $name(TabW17 *Self@<eax>, TabW17 *Other@<edx>, TabObject *Owner@<ecx>, int Amount@<^0>);"
    procedure Advance; override; // @addr $55B2A4
    procedure UpdateVisuals; override; // @addr $55B748
  end;
...
{ @routine $55B164 TabW17_LaunchPartner }
...
{ @routine $55B748 TabW17_UpdateVisuals }
