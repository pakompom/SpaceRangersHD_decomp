unit ab_MainForm;
// Unit bracket (inferred): .text 0x0068ECE0..0x0069F5CF; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  // $6978E0/$696B68. Offsets are relative to the start of each color block.
  ...
  public
    ...
    constructor Create; // @addr $68ED94 @ida "TfAB *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr $68EE00 @ida "void __usercall $name(TfAB *Self@<eax>, __int8 DestroyFlags@<dl>);"
    function ScreenPointToSphere(Point: TPoint; var Longitude, PolarAngle: Double): Boolean; // @addr $6926F0 @ida "bool __userpurge $name@<al>(TfAB *Self@<eax>, TPoint *Point@<edx>, double *Longitude@<ecx>, double *PolarAngle@<^0>);"
    function RandomRange(BoundA, BoundB: Integer): Integer; // @addr $69EE78
    function RandomFloat(BoundA, BoundB: Double): Double; // @addr $69EF04 @ida "double __userpurge $name@<st0>(TfAB *Self@<eax>, double BoundA@<^8>, double BoundB@<^0>);"
    procedure UpdateHelp(Sender: TObjectGI; Show: Boolean); // @addr $69EF98
    procedure ControlMouseEnter(Sender: TObjectGI); // @addr $69EFD8
    procedure ControlMouseLeave(Sender: TObjectGI); // @addr $69EFF8
    procedure HideHelp; // @addr $69F010
    procedure HideObjectInfo; // @addr $69D8A4
    procedure TogglePause(Sender: TObjectGI); // @addr $6948EC
    procedure WeaponSelect(Sender: TObjectGI); // @addr $6945AC
    procedure ToggleWeaponGroup(Sender: TObjectGI); // @addr $694604
    procedure WeaponButtonClick(Sender: TObjectGI); // @addr $694700
    procedure NormalizeWeaponSelection; // @addr $69471C
    procedure ClearWeaponPanel; // @addr $693AA8
    procedure InvalidateFrame; // @addr $699FE4
    procedure DrawShipHealthBars; // @addr $69A06C
    procedure UpdateShipStatusIcons; // @addr $69A598
    procedure WeaponStateChanged(Sender: TObjectGI); // @addr $693650
    procedure UpdateWeaponPanel; // @addr $6928BC
    procedure UpdateWeaponHighlights(Force: Boolean); // @addr $693CC4
    procedure OpenShipEquipment(Sender: TObjectGI); // @addr $69E838
    procedure RequestExit(Sender: TObjectGI); // @addr $691084
    procedure BeginKellerDialogTransition; // @addr $69C730
    procedure FinishCampaignTransition; // @addr $699DE8
    procedure ReportSurvivingShips; // @addr $694998
    procedure BeginBattleExit; // @addr $69C750
    procedure SyncWeaponInventory; // @addr $69EA20
    procedure EnterMapView; // @addr $696754
    procedure AdvanceMapColors; // @addr $6978E0
    procedure EnterCurrentSpace; // @addr $696B68
    procedure BattleKeyDown(Sender: TObjectGI; VirtualKey: Cardinal); // @addr $691234
    procedure BattleKeyUp(Sender: TObjectGI; VirtualKey: Cardinal); // @addr $691C08
    procedure BattleMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $691DE4 @ida "void __userpurge $name(TfAB *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure BattleMouseUp(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $692148 @ida "void __userpurge $name(TfAB *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure BattleRightMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $69216C @ida "void __userpurge $name(TfAB *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure BattleRightMouseUp(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $692214 @ida "void __userpurge $name(TfAB *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure BattleMouseMove(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $692298 @ida "void __userpurge $name(TfAB *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure BuildSpaceRoute(Route: TList; Origin, Destination: TabSpace); // @addr $69BF98 @ida "void __userpurge $name(TfAB *Self@<eax>, TList *Route@<edx>, TabSpace *Origin@<ecx>, TabSpace *Destination@<^0>);"
    procedure AppendShipPathArc(Destination: TPointF); // @addr $69B968 @ida "void __usercall $name(TfAB *Self@<eax>, TPointF *Destination@<edx>);"
    procedure AppendShipPathLine(Destination: TPointF); // @addr $69BC68 @ida "void __usercall $name(TfAB *Self@<eax>, TPointF *Destination@<edx>);"
    procedure AppendShipPath(Destination: TPointF); // @addr $69BF14 @ida "void __usercall $name(TfAB *Self@<eax>, TPointF *Destination@<edx>);"
    procedure UpdateShipPathImages; // @addr $69C56C
    procedure RebuildShipPath; // @addr $69C1FC
    procedure BuildShipPathImages; // @addr $69C268
    procedure ShowSpaceInfo(Space: TabSpace); // @addr $69C8FC
    procedure ShowItemInfo(Item: TabItem); // @addr $69D928
    procedure UpdateAutopilotButtons; // @addr $694878
    procedure ToggleAutopilot(Sender: TObjectGI); // @addr $6948B4
    procedure ResetBattleControls; // @addr $6965F4
    procedure BeginMapTransition; // @addr $6966DC
    procedure CancelCargoPickup; // @addr $69E7B4
    procedure PickUpItem(Item: TabItem); // @addr $69EBE0
    procedure ShowVictory; // @addr $69F02C
    procedure CloseVictory(Sender: TObjectGI; VirtualKey: Cardinal); // @addr $69F518
    procedure ClearEnemyStatus(Index: Integer); // @addr $69A450
    procedure ClearTrackedShipStatus(Index: Integer); // @addr $69A524
    procedure ClearShipPath; // @addr $69C6B4
    procedure DrawFrame; override; // @addr $69B6BC
    procedure OnOpen; override; // @addr $68FDA0
    procedure OnClose; override; // @addr $690EC0
    procedure SelectMusic; override; // @addr $69F59C
    procedure InitializeLayout; override; // @addr $68EE7C
    procedure ABSpaceBuild(GridSize: Integer; Angle: Single); // @addr 0x6952F0 @ida "void __userpurge $name(TfAB *Self@<eax>, int GridSize@<edx>, float Angle@<^0>);"
    procedure WorldImageCycleComplete(Sender: TObjectGI); // @addr $69B92C
    procedure ClearOverlaySegments; // @addr $692698
    procedure ClearBattle; // @addr $694B58
    procedure ClearMap; // @addr $694BD0
    procedure LoadMap(Buffer: TBufEC; LoadPolygons: Boolean); // @addr $694C20
    procedure LoadMapResource(Path: WideString; LoadPolygons: Boolean); // @addr $694D4C
    procedure LoadMapFile(Path: WideString; LoadPolygons: Boolean); // @addr $694ED4
    procedure ClearGrid; // @addr $695000
    procedure BuildGrid; // @addr $69506C
    procedure ScrollMapTimer(Timer: PCallbackTimerGI; UserData: Integer); // @addr $699B54
    procedure TimerTakt(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6979A4
  end;

var
  ActiveArcadeRequestShips: TObjectList = nil; // @addr $87B868 Borrowed ActiveArcadeRequest.Ships.
  ActiveArcadeRequest: PScriptABRequest = nil; // @addr $87B86C Borrowed head of QueuedArcadeBattles.
...
{ @routine $68EE7C TfAB_InitializeLayout }
...
{ @routine $691084 TfAB_RequestExit }
...
{ @routine $691234 TfAB_BattleKeyDown }
...
{ @routine $691C08 TfAB_BattleKeyUp }
...
{ @routine $691DE4 TfAB_BattleMouseDown }
...
{ @routine $692214 TfAB_BattleRightMouseUp }
...
{ @routine $692298 TfAB_BattleMouseMove }
...
{ @routine $692698 TfAB_ClearOverlaySegments }
...
{ @routine $6926F0 TfAB_ScreenPointToSphere }
...
{ @routine $6928BC TfAB_UpdateWeaponPanel }
...
{ @routine $693650 TfAB_WeaponStateChanged }
...
{ @routine $693AA8 TfAB_ClearWeaponPanel }
...
{ @routine $693CC4 TfAB_UpdateWeaponHighlights }
...
{ @routine $6945AC TfAB_WeaponSelect }
...
{ @routine $694604 TfAB_ToggleWeaponGroup }
...
{ @routine $694700 TfAB_WeaponButtonClick }
...
{ @routine $69471C TfAB_NormalizeWeaponSelection }
...
{ @routine $694878 TfAB_UpdateAutopilotButtons }
...
{ @routine $6948B4 TfAB_ToggleAutopilot }
...
{ @routine $6948EC TfAB_TogglePause }
...
{ @routine $694998 TfAB_ReportSurvivingShips }
...
{ @routine $694B58 TfAB_ClearBattle }
...
{ @routine $694D4C TfAB_LoadMapResource }
...
{ @routine $694ED4 TfAB_LoadMapFile }
...
{ @routine $6952F0 TfAB_ABSpaceBuild }
...
{ @routine $6965F4 TfAB_ResetBattleControls }
...
{ @routine $6966DC TfAB_BeginMapTransition }
...
{ @routine $696754 TfAB_EnterMapView }
...
{ @routine $696B68 TfAB_EnterCurrentSpace }
...
{ @routine $6978E0 TfAB_AdvanceMapColors }
...
{ @routine $699B54 TfAB_ScrollMapTimer }
...
{ @routine $699DE8 TfAB_FinishCampaignTransition }
...
{ @routine $699FE4 TfAB_InvalidateFrame }
...
{ @routine $69A06C TfAB_DrawShipHealthBars }
...
{ @routine $69A450 TfAB_ClearEnemyStatus }
...
{ @routine $69A524 TfAB_ClearTrackedShipStatus }
...
{ @routine $69A598 TfAB_UpdateShipStatusIcons }
...
{ @routine $69B92C TfAB_WorldImageCycleComplete }
...
{ @routine $69B968 TfAB_AppendShipPathArc }
...
{ @routine $69BC68 TfAB_AppendShipPathLine }
...
{ @routine $69BF14 TfAB_AppendShipPath }
...
{ @routine $69BF98 TfAB_BuildSpaceRoute }
...
{ @routine $69C1FC TfAB_RebuildShipPath }
...
{ @routine $69C268 TfAB_BuildShipPathImages }
...
{ @routine $69C56C TfAB_UpdateShipPathImages }
...
{ @routine $69C6B4 TfAB_ClearShipPath }
...
{ @routine $69C730 TfAB_BeginKellerDialogTransition }
...
{ @routine $69C750 TfAB_BeginBattleExit }
...
{ @routine $69C8FC TfAB_ShowSpaceInfo }
...
{ @routine $69D8A4 TfAB_HideObjectInfo }
...
{ @routine $69D928 TfAB_ShowItemInfo }
...
{ @routine $69E7B4 TfAB_CancelCargoPickup }
...
{ @routine $69E838 TfAB_OpenShipEquipment }
...
{ @routine $69EA20 TfAB_SyncWeaponInventory }
...
var
  ...
  // @nested $69E970 SaveWeaponInventory
  procedure SaveWeaponInventory; // @addr $69E970 @ida "void __usercall $name(void *ParentFrame@<^0>);" @stackpop 0 @calls "0x69EA38"
  var
    Index: Integer;
  begin
    for Index := 0 to 4 do
  ...
  // @nested $69E9DC FindSavedWeaponAmmo
  function FindSavedWeaponAmmo(Weapon: TWeapon): Integer; // @addr $69E9DC @ida "int __usercall $name@<eax>(TWeapon *Weapon@<eax>, void *ParentFrame@<^0>);" @stackpop 0 @calls "0x69EB60"
  var
    Index: Integer;
  begin
    Result := 0;
...
{ @routine $69EBE0 TfAB_PickUpItem }
...
{ @routine $69EE78 TfAB_RandomRange }
...
{ @routine $69EF04 TfAB_RandomFloat }
...
{ @routine $69EF98 TfAB_UpdateHelp }
...
{ @routine $69EFD8 TfAB_ControlMouseEnter }
...
{ @routine $69EFF8 TfAB_ControlMouseLeave }
...
{ @routine $69F02C TfAB_ShowVictory }
...
{ @routine $69F518 TfAB_CloseVictory }
...
{ @routine $69F59C TfAB_SelectMusic }
