unit ab_Object;
// Unit bracket (inferred): .text 0x00681B40..0x00682EE7; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
// Native TabObject VMT and methods: $681B8C..$682EE8.
...
type
  ...
  public
    ...
    // Non-owning original firing object: Launch stores Owner ($562008), child
    // projectiles inherit it, and hits pass it as damage source ($5621B8).
    ...
    LuckScale: Single; // @offset $AC  Default 1; SF_ABShipModifiers exposes luck at $63D9FE. Multiplies the random reward roll.

    constructor Create; // @addr $681BBC @ida "TabObject *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr $681CD8 @ida "void __usercall $name(TabObject *Self@<eax>, __int8 DestroyFlags@<dl>);"
    function GetWorldPosition: TVector3D; // @addr $681D60 @ida "void __usercall $name(TabObject *Self@<eax>, TVector3D *Result@<edx>);"
    function GetProjectedPosition: TVector3D; // @addr $681DAC @ida "void __usercall $name(TabObject *Self@<eax>, TVector3D *Result@<edx>);"
    function DistanceTo(Other: TabObject): Double; // @addr $681DEC
    function BearingAndDistanceTo(Other: TabObject): TSphericalBearingDistance; // @addr $681F4C @ida "void __usercall $name(TabObject *Self@<eax>, TabObject *Other@<edx>, TSphericalBearingDistance *Result@<ecx>);"
    function GetProjectedHeading(Position: TVector3D): Double; // @addr $681F74 @ida "double __usercall $name@<st0>(TabObject *Self@<eax>, TVector3D *Position@<edx>);"
    procedure ChangeSpeed(Delta: Double); // @addr $682084 @ida "void __userpurge $name(TabObject *Self@<eax>, double Delta@<^0>);"
    function CollidesWith(Other: TabObject): Boolean; // @addr $682160
    function FindCollision: TabObject; // @addr $68220C
    procedure ApplyDamage(Amount: Integer; Source: TabObject; Disrupt: Boolean); virtual; // @addr $682270 @slot $00
    procedure UpdateState; virtual; // @addr $682288 @slot $04
    procedure Advance; virtual; // @addr $682294 @slot $08
    procedure UpdateVisuals; virtual; // @addr $682AD8 @slot $0C
    procedure QueueImageLoad(PendingLoads: TList; Owner: TObjectGI); virtual; // @addr $682AE4 @slot $10
    function RandomRange(BoundA, BoundB: Integer): Integer; // @addr $682AF8
  end;

procedure ab_Object_Clear; // @addr $682B9C
procedure ab_Object_Add(Obj: TabObject); // @addr $682BB4
procedure ab_Object_Delete(Obj: TabObject); // @addr $682C00
procedure ab_Object_QueueImageLoads(PendingLoads: TList; Owner: TObjectGI); // @addr $682C6C
procedure ab_Object_UpdateSounds; // @addr $682CAC

var
  FirstArcadeObject: TabObject = nil; // @addr $87B7F8
  LastArcadeObject: TabObject = nil; // @addr $87B7FC

implementation

uses Math, aMyFunction, Globals, GlobalsV, ab_Hit, ab_Ship, ab_ShipAI, ab_Zone, ab_StopLine;

{ @routine $681BBC TabObject_Create }
...
{ @routine $681CD8 TabObject_Destroy }
...
{ @routine $681D60 TabObject_GetWorldPosition }
...
{ @routine $681DAC TabObject_GetProjectedPosition }
...
{ @routine $681DEC TabObject_DistanceTo }
...
{ @routine $681F4C TabObject_BearingAndDistanceTo }
...
{ @routine $681F74 TabObject_GetProjectedHeading }
...
{ @routine $682084 TabObject_ChangeSpeed }
...
{ @routine $682160 TabObject_CollidesWith }
...
{ @routine $68220C TabObject_FindCollision }
...
{ @routine $682AD8 TabObject_UpdateVisuals }
procedure TabObject.UpdateVisuals;
begin
end;
{ @end $682AD8 }

{ @routine $682AE4 TabObject_QueueImageLoad }
procedure TabObject.QueueImageLoad(PendingLoads: TList; Owner: TObjectGI);
begin
end;
{ @end $682AE4 }

{ @routine $682AF8 TabObject_RandomRange }
...
{ @routine $682B9C ab_Object_Clear }
...
{ @routine $682C00 ab_Object_Delete }
...
{ @routine $682C6C ab_Object_QueueImageLoads }
...
{ @routine $682CAC ab_Object_UpdateSounds }
