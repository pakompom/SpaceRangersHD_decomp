unit ab_W08;
// Unit bracket (inferred): .text 0x0055F0A8..0x0055F73D; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
// Native TabW08 projectile family: $55F110..$55F73E.
...
type
  ...
  public
    ...
    constructor Create; // @addr $55F110 @ida "TabW08 *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr $55F198 @ida "void __usercall $name(TabW08 *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure Launch(Owner: TabObject; Amount: Integer; Angle: Single; AGeneration: Integer; Origin: TabObject); // @addr $55F1F0 @ida "void __userpurge $name(TabW08 *Self@<eax>, TabObject *Owner@<edx>, int Amount@<ecx>, float Angle@<^8>, int AGeneration@<^4>, TabObject *Origin@<^0>);"
    procedure Advance; override; // @addr $55F438
    procedure UpdateVisuals; override; // @addr $55F72C
  end;
...
{ @routine $55F72C TabW08_UpdateVisuals }
