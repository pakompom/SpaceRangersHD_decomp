unit ab_WorldLine;
// Unit bracket (inferred): .text 0x0068BBE4..0x0068C107; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
procedure ab_WorldLine_Clear; // @addr $68BBE4
function ab_WorldLine_Add: PabWorldLine; // @addr $68BC18 @note "Allocates and links a node owned by the world list."
procedure ab_WorldLine_Delete(Line: PabWorldLine); // @addr $68BCDC
function ab_WorldLine_Create(First, Last: TVector3D; Kind: Integer; FrontColor, BackColor: Cardinal; ShowBehindSphere: Boolean): PabWorldLine; // @addr $68BD7C @ida "TabWorldLine *__userpurge $name@<eax>(TVector3D *First@<eax>, TVector3D *Last@<edx>, int Kind@<ecx>, unsigned int FrontColor@<^8>, unsigned int BackColor@<^4>, bool ShowBehindSphere@<^0>);"
procedure ab_WorldLine_Set(Line: PabWorldLine; First, Last: TVector3D; Kind: Integer; FrontColor, BackColor: Cardinal; ShowBehindSphere: Boolean); // @addr $68BE00 @ida "void __userpurge $name(TabWorldLine *Line@<eax>, TVector3D *First@<edx>, TVector3D *Last@<ecx>, int Kind@<^12>, unsigned int FrontColor@<^8>, unsigned int BackColor@<^4>, bool ShowBehindSphere@<^0>);"
procedure ab_WorldLine_Update; // @addr $68BEA4

var
  WorldLineHeap: Cardinal = 0; // @addr $87B830
  FirstWorldLine: PabWorldLine = nil; // @addr $87B834
  LastWorldLine: PabWorldLine = nil; // @addr $87B838

implementation

uses Windows, Classes, SysUtils, EC_Mem, GI_Tail, ab_Global, Globals;

{ @routine $68BBE4 ab_WorldLine_Clear }
...
{ @routine $68BC18 ab_WorldLine_Add }
...
{ @routine $68BCDC ab_WorldLine_Delete }
...
{ @routine $68BD7C ab_WorldLine_Create }
...
{ @routine $68BE00 ab_WorldLine_Set }
...
{ @routine $68BEA4 ab_WorldLine_Update }
