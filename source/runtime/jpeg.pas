unit jpeg;
// Unit bracket (inferred): .text 0x0045F28C..0x004725F3; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
// Unit bracket (inferred): .itext 0x00875730..0x008757C2; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    procedure FreeHandle; virtual; // @addr 0x45F598 @slot 0x00 @note "Empty; the stream is released by Destroy."
  end;
  ...
  public
    ...
    procedure Changed(Sender: TObject); override; // @addr 0x45FADC @slot 0x10
    ...
    procedure SetHeight(Value: Integer); virtual; // @addr 0x46076C @slot 0x34 @note "Always raises an invalid-operation error."
    ...
    procedure SetWidth(Value: Integer); virtual; // @addr 0x46080C @slot 0x40 @note "Always raises an invalid-operation error."
    ...
    procedure NewBitmap;
    procedure FreeBitmap; // @addr 0x45FEC8
    ...
    procedure EnsureJpegData; // @addr 0x460510
...
function JpegAllocate(ByteCount: Integer): Pointer; cdecl; // @addr 0x45F3CC
procedure JpegFree(Block: Pointer); cdecl; // @addr 0x45F3DC
procedure JpegFill(Buffer: Pointer; Value: Byte; ByteCount: Integer); cdecl;
procedure JpegMove(Dest, Source: Pointer; ByteCount: Integer); cdecl; // @addr 0x45F400
