unit fPanelLoad;
// Unit bracket (inferred): .text 0x0083AB50..0x0083C126; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    function GetProgressSegmentCount: Integer; // @addr 0x83B580
    procedure Show; // @addr 0x83B598
    ...
    procedure UpdateClosingShutters(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x83BFE4
    function IsAnimatingShutters: Boolean; // @addr 0x83C0D8
    function GetShutterDirection: Integer; // @addr 0x83C0F8 @note "Returns zero without an active timer."
  end;

var
  ActiveLoadPanel: TfPanelLoad; // @addr 0x88C348

implementation

uses Classes, GR_Main, Globals, GlobalsV, SysUtils, aMyFunction, aPlayer;

{ @routine $83ABA8 TfPanelLoad_Create }
...
{ @routine $83ABF0 TfPanelLoad_Destroy }
...
{ @routine $83AC24 TfPanelLoad_InitializeLayout }
...
{ @routine $83B3FC TfPanelLoad_OnOpen }
...
{ @routine $83B538 TfPanelLoad_OnClose }
...
{ @routine $83B580 TfPanelLoad_GetProgressSegmentCount }
...
{ @routine $83B598 TfPanelLoad_Show }
...
{ @routine $83B5D4 TfPanelLoad_Hide }
...
{ @routine $83B610 TfPanelLoad_SelectBackgroundStyle }
...
{ @routine $83B734 TfPanelLoad_RefreshBackgroundImages }
...
{ @routine $83BAC4 TfPanelLoad_SetProgress }
...
{ @routine $83BC5C TfPanelLoad_SetShutterOpenFraction }
...
{ @routine $83BDC4 TfPanelLoad_StartOpeningShutters }
...
{ @routine $83BE58 TfPanelLoad_StartClosingShutters }
...
{ @routine $83BF24 TfPanelLoad_UpdateOpeningShutters }
...
{ @routine $83BFE4 TfPanelLoad_UpdateClosingShutters }
...
{ @routine $83C0D8 TfPanelLoad_IsAnimatingShutters }
...
{ @routine $83C0F8 TfPanelLoad_GetShutterDirection }
