unit fHangar;
// Unit bracket (inferred): .text 0x0061B080..0x00621E80; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    constructor Create; // @addr 0x61B118 @ida "TfHangar *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x61B1D0 @ida "void __usercall $name(TfHangar *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure OnOpen; override; // @addr 0x61BD38
    procedure OnClose; override; // @addr 0x61C8DC
    procedure SelectMusic; override; // @addr 0x61D718
    procedure InitializeLayout; override; // @addr 0x61B2B8
    procedure ExecuteUiCode(Block: TBlockParEC; Key: Cardinal); override; // @addr 0x621DFC

    procedure RepairHullClicked(Sender: TObjectGI); // @addr 0x61DE0C @note "Insufficient funds buy a proportional partial repair."
    procedure RefuelClicked(Sender: TObjectGI); // @addr 0x61E1B8 @note "Requires enough money to fill the tank completely."
    procedure TakeOffClicked(Sender: TObjectGI); // @addr 0x61E470
    function TryTakeOff: Boolean; // @addr $61CF4C @note "Orders player takeoff and runs campaign turn/transitions when accepted. Self is unused."
    procedure ShipClicked(Sender: TObjectGI); // @addr 0x61D348
    function RefreshTakeOffStatus: Boolean; // @addr $61E68C Refreshes hull, fuel and engine warnings and reports whether takeoff is allowed.
    procedure RefreshServiceButtons; // @addr 0x61DA58
    procedure MainMouseMove(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $620094 @ida "void __userpurge $name(TfHangar *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0.4>);"
    procedure MainRightButtonDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $620244 @ida "void __userpurge $name(TfHangar *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0.4>);"
    procedure EndTurnClicked(Sender: TObjectGI); // @addr $61D0C8
    procedure BeginTakeOff; // @addr $61D490
    procedure MainKeyDown(Sender: TObjectGI; Key: Cardinal); // @addr $61D4F0
    function IsServiceButtonDown: Boolean; // @addr $61D990
    procedure StopAnimation(Sender: TObjectGI); // @addr $61E658
    procedure AmbientAnimationComplete(Sender: TObjectGI); // @addr $61F1F0
    procedure StartAmbientAnimation(Timer: PCallbackTimerGI; UserData: Integer); // @addr $61F300
    procedure ShowShipInfo(Ship: TShip); // @addr $62048C
    procedure HideShipInfo(Timer: PCallbackTimerGI; UserData: Integer); // @addr $620434
    procedure CaptureDispatcherMirror(Sender: TObjectGI); // @addr $61CAD8
    procedure DispatcherAnimationComplete(Sender: TObjectGI); // @addr $61CC48
    function GetShipPortraitScale(Ship: TShip): Single; // @addr $61F3D8
    procedure LoadDockedShipImage(Index: Integer; ImagePath: WideString; LargeHull: Boolean; Scale: Single); // @addr $61F478 @ida "void __userpurge $name(TfHangar *Self@<eax>, int Index@<edx>, unsigned __int16 *ImagePath@<ecx>, bool LargeHull@<^4.4>, float Scale@<^0.4>);"
    procedure SetDockedShipOpacity(Index: Integer; Alpha: Byte); // @addr $61F6D0
    procedure AnimateDockedShips(Timer: PCallbackTimerGI; UserData: Integer); // @addr $61F864
    procedure RefreshDockedShips; // @addr 0x61FA28
  end;
...
const
  HangarDominatorPortraitScales: array[0..2,0..7] of Single = (
    ...
    (1.0,1.1,0.9,0.7,0.6,0.5,1.0,0.5)); // @addr $87B740
...
{ @routine $61B118 TfHangar_Create }
...
{ @routine $61B1D0 TfHangar_Destroy }
...
{ @routine $61B2B8 TfHangar_InitializeLayout }
...
{ @routine $61BD38 TfHangar_OnOpen }
...
{ @routine $61C8DC TfHangar_OnClose }
...
{ @routine $61CAD8 TfHangar_CaptureDispatcherMirror }
...
{ @routine $61CC48 TfHangar_DispatcherAnimationComplete }
...
{ @routine $61CF4C TfHangar_TryTakeOff }
...
{ @routine $61D0C8 TfHangar_EndTurnClicked }
...
{ @routine $61D348 TfHangar_ShipClicked }
...
{ @routine $61D490 TfHangar_BeginTakeOff }
...
{ @routine $61D4F0 TfHangar_MainKeyDown }
...
{ @routine $61D718 TfHangar_SelectMusic }
...
{ @routine $61D990 TfHangar_IsServiceButtonDown }
...
{ @routine $61DA58 TfHangar_RefreshServiceButtons }
...
{ @routine $61DE0C TfHangar_RepairHullClicked }
...
{ @routine $61E1B8 TfHangar_RefuelClicked }
...
{ @routine $61E470 TfHangar_TakeOffClicked }
...
{ @routine $61E658 TfHangar_StopAnimation }
...
{ @routine $61E68C TfHangar_RefreshTakeOffStatus }
...
{ @routine $61F1F0 TfHangar_AmbientAnimationComplete }
...
{ @routine $61F300 TfHangar_StartAmbientAnimation }
...
{ @routine $61F3D8 TfHangar_GetShipPortraitScale }
...
{ @routine $61F478 TfHangar_LoadDockedShipImage }
...
{ @routine $61F6D0 TfHangar_SetDockedShipOpacity }
...
{ @routine $61F864 TfHangar_AnimateDockedShips }
...
{ @routine $61FA28 TfHangar_RefreshDockedShips }
...
{ @routine $620094 TfHangar_MainMouseMove }
...
{ @routine $620244 TfHangar_MainRightButtonDown }
...
{ @routine $620434 TfHangar_HideShipInfo }
...
{ @routine $62048C TfHangar_ShowShipInfo }
...
{ @routine $621DFC TfHangar_ExecuteUiCode }
