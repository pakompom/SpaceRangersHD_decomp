unit fPlanetNO;
// Unit bracket (inferred): .text 0x0050B8E4..0x00513303; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    constructor Create; // @addr 0x50B97C @ida "TfPlanetNO *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x50B9D4 @ida "void __usercall $name(TfPlanetNO *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure InitializeLayout; override; // @addr 0x50BA2C
    procedure OnOpen; override; // @addr 0x50C354
    procedure OnClose; override; // @addr 0x50C4D8
    procedure TakeoffClicked(Sender: TObjectGI); // @addr 0x50C570
    procedure RefreshPlanetInfo; // @addr 0x50CBE4
    procedure RefreshTextQuestPrompt; // @addr 0x50D004
    procedure StartTextQuest(Sender: TObjectGI); // @addr 0x50CA64
    procedure EndTurnClicked(Sender: TObjectGI); // @addr 0x50D7F8
    procedure ShipClicked(Sender: TObjectGI); // @addr 0x50D8F0
    procedure GalaxyClicked(Sender: TObjectGI); // @addr 0x50D97C
    procedure QuestClicked(Sender: TObjectGI); // @addr 0x50D9D4
    procedure ToggleResearchPanel(Sender: TObjectGI); // @addr 0x50DA2C
    procedure OpenResearchPanel; // @addr 0x50DA84
    procedure CloseResearchPanel; // @addr 0x50DDEC @note "Returns a held probe to its origin list before destroying research controls."
    procedure BuildTrajectory(TrajectoryIndex: Integer); // @addr 0x50DF40 @note "Requires index 0..5 and an empty point count. Builds at most 256 points from connected image markers."
    function GetRandomTrajectoryPoint(TrajectoryIndex: Integer): TPoint; // @addr 0x50E78C @ida "void __usercall $name(TfPlanetNO *Self@<eax>, int TrajectoryIndex@<edx>, TPoint *Result@<ecx>);" @note "Requires a nonempty trajectory."
    function ProjectPointOntoTrajectory(TrajectoryIndex: Integer; Point: TPoint): TPoint; // @addr 0x50E804 @ida "void __userpurge $name(TfPlanetNO *Self@<eax>, int TrajectoryIndex@<edx>, TPoint *Point@<ecx>, TPoint *Result@<^0>);" @note "Requires a trajectory spanning a positive X range. Result is untouched if no segment matches."
    function AdvanceTrajectoryPoint(TrajectoryIndex: Integer; Point: TPoint): TPoint; // @addr 0x50EA7C @ida "void __userpurge $name(TfPlanetNO *Self@<eax>, int TrajectoryIndex@<edx>, TPoint *Point@<ecx>, TPoint *Result@<^0>);" @note "Advances four pixels along the projected segment; Result is untouched if no segment matches."
    function FindTrajectoryAtCursor: Integer; // @addr 0x50ED24 @note "Returns -1 on a miss; searches only the current planet's available probe orbits."
    function IsCursorOverTrajectory(TrajectoryIndex: Integer): Boolean; // @addr 0x50ED7C
    procedure ResearchMapMouseMove(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x50EE68 @ida "void __userpurge $name(TfPlanetNO *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure ResearchMapMouseLeave(Sender: TObjectGI); // @addr 0x50F3C0
    procedure RefreshResearchPanel; // @addr 0x50F5EC
    procedure ScrollSatellitePageLeft(Sender: TObjectGI); // @addr 0x51104C
    procedure ScrollSatellitePageRight(Sender: TObjectGI); // @addr 0x511080
    procedure ProcessMouseWheel(KeyState: Cardinal; Point: TPoint; Delta: Integer); override; // @addr 0x5110C0 @ida "void __userpurge $name(TfPlanetNO *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>, int Delta@<^0>);"
    procedure MainPanelMouseMove(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x511100 @ida "void __userpurge $name(TfPlanetNO *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure SatelliteInventoryMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x5111CC @ida "void __userpurge $name(TfPlanetNO *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure ResearchMapMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x511410 @ida "void __userpurge $name(TfPlanetNO *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);" @note "Collects accessible surface loot or exchanges the held probe with the selected orbit."
    procedure MainPanelRightButtonDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x511974 @ida "void __userpurge $name(TfPlanetNO *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure UpdateActionCursor(ForceHand: Boolean); override; // @addr 0x5119AC
    procedure ReturnHeldSatellite; // @addr 0x511B80
    function FindDeployedSatellite(TrajectoryIndex: Integer): TSatellite; // @addr 0x511C64 @note "Borrowed probe on the current planet, or nil; -1 always returns nil."
    function CountDeployedSatellites: Integer; // @addr 0x511CE0
    procedure AdvanceSatelliteMarkers(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x511D40
    procedure UpdateProbeSignalSound(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x511DF8
    procedure UpdateItemInfoPopup(Item: TItem); // @addr 0x512078 @note "Borrows Item; nil schedules a delayed hide."
    procedure ShowGoodsInfoPopup(Item: TGoods); // @addr 0x512A70
    procedure HideItemInfoPopup(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x512EFC
    procedure MainPanelKeyDown(Sender: TObjectGI; Key: Cardinal); // @addr 0x512F64
    procedure ExecuteUiCode(Block: TBlockParEC; Key: Cardinal); override; // @addr 0x51315C
    procedure SelectMusic; override; // @addr 0x5131D0
  end;

const
  ProbeTrajectoryHitRadiusSquared: Single = 400.0; // @addr $87AA00
...
{ @routine $50B97C TfPlanetNO_Create }
...
{ @routine $50B9D4 TfPlanetNO_Destroy }
...
{ @routine $50BA2C TfPlanetNO_InitializeLayout }
...
{ @routine $50C354 TfPlanetNO_OnOpen }
...
{ @routine $50C4D8 TfPlanetNO_OnClose }
...
{ @routine $50C570 TfPlanetNO_TakeoffClicked }
...
{ @routine $50CA64 TfPlanetNO_StartTextQuest }
...
{ @routine $50CBE4 TfPlanetNO_RefreshPlanetInfo }
...
{ @routine $50D004 TfPlanetNO_RefreshTextQuestPrompt }
...
{ @routine $50D7F8 TfPlanetNO_EndTurnClicked }
...
{ @routine $50D8F0 TfPlanetNO_ShipClicked }
...
{ @routine $50D97C TfPlanetNO_GalaxyClicked }
...
{ @routine $50D9D4 TfPlanetNO_QuestClicked }
...
{ @routine $50DA2C TfPlanetNO_ToggleResearchPanel }
...
{ @routine $50DA84 TfPlanetNO_OpenResearchPanel }
...
{ @routine $50DDEC TfPlanetNO_CloseResearchPanel }
...
{ @routine $50DF40 TfPlanetNO_BuildTrajectory }
...
{ @routine $50E78C TfPlanetNO_GetRandomTrajectoryPoint }
...
{ @routine $50E804 TfPlanetNO_ProjectPointOntoTrajectory }
...
{ @routine $50EA7C TfPlanetNO_AdvanceTrajectoryPoint }
...
{ @routine $50ED24 TfPlanetNO_FindTrajectoryAtCursor }
...
{ @routine $50ED7C TfPlanetNO_IsCursorOverTrajectory }
...
{ @routine $50EE68 TfPlanetNO_ResearchMapMouseMove }
...
{ @routine $50F3C0 TfPlanetNO_ResearchMapMouseLeave }
...
{ @routine $50F5EC TfPlanetNO_RefreshResearchPanel }
...
{ @routine $51104C TfPlanetNO_ScrollSatellitePageLeft }
...
{ @routine $511080 TfPlanetNO_ScrollSatellitePageRight }
...
{ @routine $5110C0 TfPlanetNO_ProcessMouseWheel }
...
{ @routine $511100 TfPlanetNO_MainPanelMouseMove }
...
{ @routine $5111CC TfPlanetNO_SatelliteInventoryMouseDown }
...
{ @routine $511410 TfPlanetNO_ResearchMapMouseDown }
...
{ @routine $511974 TfPlanetNO_MainPanelRightButtonDown }
...
{ @routine $5119AC TfPlanetNO_UpdateActionCursor }
...
{ @routine $511B80 TfPlanetNO_ReturnHeldSatellite }
...
{ @routine $511C64 TfPlanetNO_FindDeployedSatellite }
...
{ @routine $511CE0 TfPlanetNO_CountDeployedSatellites }
...
{ @routine $511D40 TfPlanetNO_AdvanceSatelliteMarkers }
...
{ @routine $511DF8 TfPlanetNO_UpdateProbeSignalSound }
...
{ @routine $512078 TfPlanetNO_UpdateItemInfoPopup }
...
{ @routine $512A70 TfPlanetNO_ShowGoodsInfoPopup }
...
begin
  ...
  begin
    SetImagePath(GetFactionEmblemPath(OwnerInfo[Integer(RaceToOwner(GetPlayer.PilotRace)) and $7F].InternalName));
    SetImageKindX(ikxCenter);
    SetImageKindY(ikyCenter);
  end;
...
{ @routine $512EFC TfPlanetNO_HideItemInfoPopup }
...
{ @routine $512F64 TfPlanetNO_MainPanelKeyDown }
...
{ @routine $51315C TfPlanetNO_ExecuteUiCode }
...
{ @routine $5131D0 TfPlanetNO_SelectMusic }
