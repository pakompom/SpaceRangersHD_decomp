unit fGameEnd;
// Unit bracket (inferred): .text 0x0054EAA4..0x00551DD7; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    procedure ScrollBackground(Timer: PCallbackTimerGI; UserData: Integer); // @addr $5518E8
    procedure ScrollEndingText(Timer: PCallbackTimerGI; UserData: Integer); // @addr $5519AC
    procedure ContinueClicked(Sender: TObjectGI); // @addr $551AB4
    procedure LoadClicked(Sender: TObjectGI); // @addr $551B58
    procedure ShowControlHelp(Sender: TObjectGI; Show: Boolean); // @addr $551BC8
    procedure MainPanelKeyDown(Sender: TObjectGI; Key: Cardinal); // @addr $551C60

    procedure OnOpen; override; // @addr $54FDA0
    procedure OnClose; override; // @addr $55184C
    procedure SelectMusic; override; // @addr $551CC8
    procedure InitializeLayout; override; // @addr $54EB3C
  end;
...
{ @routine $54EB3C TfGameEnd_InitializeLayout }
...
{ @routine $54FDA0 TfGameEnd_OnOpen }
...
begin
  ...
  GetByName('PirateWin1Maloc').SetActive((GameEndReason in [5,9,11]) and (Score.PilotRace = Byte(oiMaloc)));
  GetByName('PirateWin1Peleng').SetActive((GameEndReason in [5,9,11]) and (Score.PilotRace = Byte(oiPeleng)));
  GetByName('PirateWin1People').SetActive((GameEndReason in [5,9,11]) and (Score.PilotRace = Byte(oiHuman)));
  GetByName('PirateWin1Fei').SetActive((GameEndReason in [5,9,11]) and (Score.PilotRace = Byte(oiFeyan)));
  GetByName('PirateWin1Gaal').SetActive((GameEndReason in [5,9,11]) and (Score.PilotRace = Byte(oiGaal)));
  GetByName('PirateWin2').SetActive(GameEndReason in [6,10]);
  GetByName('PirateWin3Maloc').SetActive((GameEndReason in [7,18]) and (Score.PilotRace = Byte(oiMaloc)));
  GetByName('PirateWin3Peleng').SetActive((GameEndReason in [7,18]) and (Score.PilotRace = Byte(oiPeleng)));
  GetByName('PirateWin3People').SetActive((GameEndReason in [7,18]) and (Score.PilotRace = Byte(oiHuman)));
  GetByName('PirateWin3Fei').SetActive((GameEndReason in [7,18]) and (Score.PilotRace = Byte(oiFeyan)));
  GetByName('PirateWin3Gaal').SetActive((GameEndReason in [7,18]) and (Score.PilotRace = Byte(oiGaal)));
  GetByName('PirateWin4Maloc').SetActive((GameEndReason = 8) and (Score.PilotRace = Byte(oiMaloc)));
  GetByName('PirateWin4Peleng').SetActive((GameEndReason = 8) and (Score.PilotRace = Byte(oiPeleng)));
  GetByName('PirateWin4People').SetActive((GameEndReason = 8) and (Score.PilotRace = Byte(oiHuman)));
  ...
  GetByName('PirateWin5Maloc').SetActive((GameEndReason in [12..14]) and (Score.PilotRace = Byte(oiMaloc)));
  GetByName('PirateWin5Peleng').SetActive((GameEndReason in [12..14]) and (Score.PilotRace = Byte(oiPeleng)));
  GetByName('PirateWin5People').SetActive((GameEndReason in [12..14]) and (Score.PilotRace = Byte(oiHuman)));
  GetByName('PirateWin5Fei').SetActive((GameEndReason in [12..14]) and (Score.PilotRace = Byte(oiFeyan)));
  GetByName('PirateWin5Gaal').SetActive((GameEndReason in [12..14]) and (Score.PilotRace = Byte(oiGaal)));
...
{ @routine $55184C TfGameEnd_OnClose }
...
{ @routine $5518E8 TfGameEnd_ScrollBackground }
...
{ @routine $5519AC TfGameEnd_ScrollEndingText }
...
{ @routine $551AB4 TfGameEnd_ContinueClicked }
...
{ @routine $551B58 TfGameEnd_LoadClicked }
...
{ @routine $551BC8 TfGameEnd_ShowControlHelp }
...
{ @routine $551C60 TfGameEnd_MainPanelKeyDown }
...
{ @routine $551CC8 TfGameEnd_SelectMusic }
