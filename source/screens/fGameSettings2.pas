unit fGameSettings2;
// Unit bracket (inferred): .text 0x005D6D94..0x005E4A45; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    procedure InitializeLayout; override; // @addr 0x5D6E44
    procedure OnOpen; override; // @addr 0x5D86C0
    procedure OnClose; override; // @addr 0x5DD628
    procedure SelectMusic; override; // @addr 0x5E1EBC
    procedure ExecuteUiCode(Block: TBlockParEC; Key: Cardinal); override; // @addr 0x5E4A28
    procedure ProcessMouseWheel(KeyState: Cardinal; Point: TPoint; Delta: Integer); override; // @addr 0x5E4194 @ida "void __userpurge $name(TfGameSettings2 *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>, int Delta@<^0>);"
    procedure AddIronWillChoice(Value, X, Y: Integer; Caption, Help: WideString; Selected, Disabled: Boolean); // @addr 0x5DD6CC
    procedure IronWillMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x5DDAF0 @ida "void __userpurge $name(TfGameSettings2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure IronWillMouseEnter(Sender: TObjectGI); // @addr 0x5DDCE8
    procedure IronWillMouseLeave(Sender: TObjectGI); // @addr 0x5DDE24
    procedure GeneratePlayerName; // @addr 0x5DDF60
    procedure PlayerNameMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x5DE0EC @ida "void __userpurge $name(TfGameSettings2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure ToggleLevelPanel(Sender: TObjectGI); // @addr 0x5DE140
    procedure AnimateLevelPanel(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x5DE218
    procedure RaceClicked(Sender: TObjectGI); // @addr 0x5DE4BC
    procedure CharacterPresetClicked(Sender: TObjectGI); // @addr 0x5DE6C4
    procedure PreviousPortraitClicked(Sender: TObjectGI); // @addr 0x5DEB10
    procedure NextPortraitClicked(Sender: TObjectGI); // @addr 0x5DEB34
    procedure StartingSkillClicked(Sender: TObjectGI); // @addr 0x5DEC98
    procedure StartingItemClicked(Sender: TObjectGI); // @addr 0x5DEE9C
    procedure DifficultyComponentClicked(Sender: TObjectGI); // @addr 0x5DF448
    procedure DifficultyPresetClicked(Sender: TObjectGI); // @addr 0x5DF798
    procedure CustomDifficultyClicked(Sender: TObjectGI); // @addr 0x5DFE44
    procedure ApplyClicked(Sender: TObjectGI); // @addr 0x5DFFA4
    procedure CancelClicked(Sender: TObjectGI); // @addr 0x5E16AC
    procedure PlayerNameChanged(Sender: TObjectGI); // @addr 0x5E1818
    procedure HelpMouseEnter(Sender: TObjectGI); // @addr 0x5E1E7C
    procedure HelpMouseLeave(Sender: TObjectGI); // @addr 0x5E1E9C
    procedure ExtendedSettingsPressed(Sender: TObjectGI); // @addr 0x5E1EE8
    procedure ToggleExtendedSettings(Sender: TObjectGI); // @addr 0x5E1EF8
    procedure ResetExtendedSettingsClicked(Sender: TObjectGI); // @addr 0x5E1FE0
    procedure ExtendedGroupClicked(Sender: TObjectGI); // @addr 0x5E274C
    procedure RefreshPortrait; // @addr 0x5DE814
    procedure RefreshStartingSkills; // @addr 0x5DEB58
    procedure RefreshStartingItems; // @addr 0x5DED3C
    procedure RefreshDifficulty; // @addr 0x5DEF3C
    procedure StartNewGameGeneration; // @addr 0x5DFE9C
    procedure RefreshExtendedGroup; // @addr 0x5E2840
    procedure IncreaseAllDifficulties; // @addr 0x5E4284
    procedure DecreaseAllDifficulties; // @addr 0x5E4324
    procedure RefreshDifficultyHelp; // @addr 0x5E43BC
    procedure CustomDifficultyMouseUp(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x5DFE68 @ida "void __userpurge $name(TfGameSettings2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure MainPanelKeyDown(Sender: TObjectGI; Key: Cardinal); // @addr 0x5E1710
    function ValidatePlayerName(Name: WideString): Boolean; // @addr 0x5E1A28 @note "Also removes <>{} from the edit control and adjusts its caret; rejects empty names and unsupported glyphs."
    procedure ShowControlHelp(Sender: TObjectGI; Show: Boolean); // @addr 0x5E1C88
    function AddExtendedOptionLabel(OptionName, Caption: WideString; UnusedFlag: Boolean): TLabelGI; // @addr 0x5E29D4
    procedure AddExtendedOptionChoice(Value: Integer; Caption: WideString; Selected, Disabled: Boolean); // @addr 0x5E2C60
    procedure AddExtendedOptionSlider(ValueLabel: TLabelGI; Minimum, Maximum, Position, UnusedStep: Integer; Callback: TNewGameSliderEvent); // @addr 0x5E324C @note "Invokes Callback immediately with the new slider."
    procedure ExtendedChoiceMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x5E30CC @ida "void __userpurge $name(TfGameSettings2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    function GetExtendedOptionValue(OptionName: WideString): Integer; // @addr 0x5E3944 @note "Searches only the active extended group; raises when no value is found."
    procedure SetExtendedOptionValue(OptionName: WideString; Value: Integer); // @addr 0x5E3AD0 @note "Searches only the active extended group; missing options are ignored."
    procedure FormatExtendedInteger(Sender: TCountBarGI); // @addr 0x5E3BD8
    procedure FormatExtendedAutoPercent(Sender: TCountBarGI); // @addr 0x5E3CDC
    procedure FormatExtendedDifficultyPercent(Sender: TCountBarGI); // @addr 0x5E3F4C
    procedure FormatExtendedPercent(Sender: TCountBarGI); // @addr 0x5E407C
  end;
...
{ @routine $5D6E44 TfGameSettings2_InitializeLayout }
...
{ @routine $5D86C0 TfGameSettings2_OnOpen }
...
var
  ...
  // @nested $5D8608 GetNewGameCustomRule
  function GetNewGameCustomRule(Path: WideString): WideString; // @addr 0x5D8608 @ida "void __usercall $name(unsigned __int16 *Path@<eax>, unsigned __int16 **Result@<edx>, void *ParentFrame@<^0>);" @stackpop 0 @calls "0x5d90ea,0x5d9180,0x5d9216,0x5d92ac,0x5d9342,0x5d93d9,0x5d9471,0x5d9506,0x5d95b9,0x5d966c,0x5d971f,0x5d9829,0x5d98c0,0x5d9957,0x5d99ee,0x5d9a85,0x5d9b1c,0x5d9bdc,0x5d9c8f,0x5d9d42,0x5d9df5,0x5d9ea8,0x5d9f5b,0x5d9ff2,0x5da089,0x5da13c,0x5da1d3,0x5da26a,0x5da301,0x5da398,0x5da44b,0x5da4fe,0x5da595,0x5da648,0x5da6fb,0x5da7ae,0x5da861,0x5da914" @note "Nested in OnOpen; static link unused. Returns an empty string for an absent CustomRules block or key."
  begin
    Result := '';
...
{ @routine $5DD628 TfGameSettings2_OnClose }
...
{ @routine $5DD6CC TfGameSettings2_AddIronWillChoice }
...
{ @routine $5DDAF0 TfGameSettings2_IronWillMouseDown }
...
{ @routine $5DDCE8 TfGameSettings2_IronWillMouseEnter }
...
{ @routine $5DDE24 TfGameSettings2_IronWillMouseLeave }
...
{ @routine $5DDF60 TfGameSettings2_GeneratePlayerName }
...
{ @routine $5DE0EC TfGameSettings2_PlayerNameMouseDown }
...
{ @routine $5DE140 TfGameSettings2_ToggleLevelPanel }
...
{ @routine $5DE218 TfGameSettings2_AnimateLevelPanel }
...
{ @routine $5DE4BC TfGameSettings2_RaceClicked }
...
{ @routine $5DE6C4 TfGameSettings2_CharacterPresetClicked }
...
{ @routine $5DE814 TfGameSettings2_RefreshPortrait }
...
{ @routine $5DEB10 TfGameSettings2_PreviousPortraitClicked }
...
{ @routine $5DEB34 TfGameSettings2_NextPortraitClicked }
...
{ @routine $5DEB58 TfGameSettings2_RefreshStartingSkills }
...
{ @routine $5DEC98 TfGameSettings2_StartingSkillClicked }
...
{ @routine $5DED3C TfGameSettings2_RefreshStartingItems }
...
{ @routine $5DEE9C TfGameSettings2_StartingItemClicked }
...
{ @routine $5DEF3C TfGameSettings2_RefreshDifficulty }
...
{ @routine $5DF448 TfGameSettings2_DifficultyComponentClicked }
...
{ @routine $5DF798 TfGameSettings2_DifficultyPresetClicked }
...
{ @routine $5DFE44 TfGameSettings2_CustomDifficultyClicked }
...
{ @routine $5DFE68 TfGameSettings2_CustomDifficultyMouseUp }
...
{ @routine $5DFE9C TfGameSettings2_StartNewGameGeneration }
...
{ @routine $5DFFA4 TfGameSettings2_ApplyClicked }
...
{ @routine $5E16AC TfGameSettings2_CancelClicked }
...
{ @routine $5E1710 TfGameSettings2_MainPanelKeyDown }
...
{ @routine $5E1818 TfGameSettings2_PlayerNameChanged }
...
{ @routine $5E1A28 TfGameSettings2_ValidatePlayerName }
...
{ @routine $5E1C88 TfGameSettings2_ShowControlHelp }
...
{ @routine $5E1E7C TfGameSettings2_HelpMouseEnter }
...
{ @routine $5E1E9C TfGameSettings2_HelpMouseLeave }
...
{ @routine $5E1EBC TfGameSettings2_SelectMusic }
...
{ @routine $5E1EE8 TfGameSettings2_ExtendedSettingsPressed }
...
{ @routine $5E1EF8 TfGameSettings2_ToggleExtendedSettings }
...
{ @routine $5E1FE0 TfGameSettings2_ResetExtendedSettingsClicked }
...
{ @routine $5E274C TfGameSettings2_ExtendedGroupClicked }
...
{ @routine $5E2840 TfGameSettings2_RefreshExtendedGroup }
...
{ @routine $5E29D4 TfGameSettings2_AddExtendedOptionLabel }
...
{ @routine $5E2C60 TfGameSettings2_AddExtendedOptionChoice }
...
{ @routine $5E30CC TfGameSettings2_ExtendedChoiceMouseDown }
...
{ @routine $5E324C TfGameSettings2_AddExtendedOptionSlider }
...
{ @routine $5E3944 TfGameSettings2_GetExtendedOptionValue }
...
{ @routine $5E3AD0 TfGameSettings2_SetExtendedOptionValue }
...
{ @routine $5E3BD8 TfGameSettings2_FormatExtendedInteger }
...
{ @routine $5E3CDC TfGameSettings2_FormatExtendedAutoPercent }
...
{ @routine $5E3F4C TfGameSettings2_FormatExtendedDifficultyPercent }
...
{ @routine $5E407C TfGameSettings2_FormatExtendedPercent }
...
{ @routine $5E4194 TfGameSettings2_ProcessMouseWheel }
...
{ @routine $5E4284 TfGameSettings2_IncreaseAllDifficulties }
...
{ @routine $5E4324 TfGameSettings2_DecreaseAllDifficulties }
...
{ @routine $5E43BC TfGameSettings2_RefreshDifficultyHelp }
...
{ @routine $5E4A28 TfGameSettings2_ExecuteUiCode }
