unit fScaner;
// Unit bracket (inferred): .text 0x0051B140..0x00524713; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    procedure UpdateSkills; // @addr $523924
    procedure BuildAdditionalInfo; // @addr $523F78
    procedure ShowPropertyInfo(Sender: TObjectGI); // @addr $51E260
    procedure ShowItemInfo(Item: TItem); // @addr $522110
    procedure ShowGoodsInfo(ItemType: TItemType); // @addr $523130
    function CreateAdditionalInfoIcon(Sender: TLabelGI; Item: PFontObjectEC): TObjectGI; // @addr $523B10
    procedure BuildRewardStrip(Ship: TShip); // @addr $51D464
    procedure RewardsMouseMove(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $51DA28 @ida "void __userpurge $name(TfScaner *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure ShowRewardInfo(Ship: TNormalShip; AwardId: Integer); // @addr $51DC1C
    procedure HideRewardInfo; // @addr $51E078
    procedure RewardMouseLeave(Sender: TObjectGI); // @addr $51DC04
    procedure AdvancePanelSlide(Timer: PCallbackTimerGI; UserData: Integer); // @addr $51E0A0
    procedure RewardsMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $51E1A0 @ida "void __userpurge $name(TfScaner *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure HidePropertyInfo(Sender: TObjectGI); // @addr $51F95C
    procedure RefreshRewardHint(Timer: PCallbackTimerGI; UserData: Integer); // @addr $51F994
    procedure CountCargoEntries; // @addr $51F9A8
    function GetCargoEntry(Index: Integer; var ItemType: TItemType; var Item: TItem): Boolean; // @addr $51FA74
    procedure ScrollCargoLeft(Sender: TObjectGI); // @addr $521540
    procedure ScrollCargoRight(Sender: TObjectGI); // @addr $521564
    procedure MainPanelKeyDown(Sender: TObjectGI; Key: Cardinal); // @addr $521588
    procedure MainPanelMouseUp(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $5216C0 @ida "void __userpurge $name(TfScaner *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure UpdateItemHover; // @addr $5218B0
    procedure AdvanceItemHover(Timer: PCallbackTimerGI; UserData: Integer); // @addr $521FBC
    procedure HideItemInfo(Timer: PCallbackTimerGI; UserData: Integer); // @addr $521FD8

    procedure OnOpen; override; // @addr 0x51BBBC
    procedure Update; // @addr 0x51FBD8
    procedure OnClose; override; // @addr 0x51D3A4
    procedure SelectMusic; override; // @addr 0x524674
    procedure ProcessMouseWheel(KeyState: Cardinal; Point: TPoint; Delta: Integer); override; // @addr 0x521648 @ida "void __userpurge $name(TfScaner *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>, int Delta@<^0>);"
    procedure InitializeLayout; override; // @addr 0x51B2D0
    procedure ExecuteUiCode(Block: TBlockParEC; Key: Cardinal); override; // @addr 0x524610
    procedure CloseClicked(Sender: TObjectGI); // @addr 0x51E168
  end;

function GetPirateRankSmallImagePath(Rank: Byte): WideString; // @addr $51B204 @ida "void __usercall $name(unsigned __int8 Rank@<al>, unsigned __int16 **Result@<edx>);"
...
{ @routine $51B204 GetPirateRankSmallImagePath }
...
{ @routine $51B2D0 TfScaner_InitializeLayout }
...
{ @routine $51BBBC TfScaner_OnOpen }
...
{ @routine $51D3A4 TfScaner_OnClose }
...
{ @routine $51D464 TfScaner_BuildRewardStrip }
...
{ @routine $51DA28 TfScaner_RewardsMouseMove }
...
{ @routine $51DC04 TfScaner_RewardMouseLeave }
...
{ @routine $51DC1C TfScaner_ShowRewardInfo }
...
{ @routine $51E078 TfScaner_HideRewardInfo }
...
{ @routine $51E0A0 TfScaner_AdvancePanelSlide }
...
{ @routine $51E168 TfScaner_CloseClicked }
...
{ @routine $51E1A0 TfScaner_RewardsMouseDown }
...
{ @routine $51E260 TfScaner_ShowPropertyInfo }
...
{ @routine $51F95C TfScaner_HidePropertyInfo }
...
{ @routine $51F994 TfScaner_RefreshRewardHint }
procedure TfScaner.RefreshRewardHint(Timer: PCallbackTimerGI; UserData: Integer);
begin
end;
{ @end $51F994 }

{ @routine $51F9A8 TfScaner_CountCargoEntries }
...
{ @routine $51FA74 TfScaner_GetCargoEntry }
...
{ @routine $51FBD8 TfScaner_Update }
...
{ @routine $521540 TfScaner_ScrollCargoLeft }
...
{ @routine $521564 TfScaner_ScrollCargoRight }
...
{ @routine $521588 TfScaner_MainPanelKeyDown }
...
{ @routine $521648 TfScaner_ProcessMouseWheel }
...
{ @routine $5216C0 TfScaner_MainPanelMouseUp }
...
{ @routine $5218B0 TfScaner_UpdateItemHover }
...
{ @routine $521FBC TfScaner_AdvanceItemHover }
...
{ @routine $521FD8 TfScaner_HideItemInfo }
...
{ @routine $522110 TfScaner_ShowItemInfo }
...
{ @routine $523130 TfScaner_ShowGoodsInfo }
...
{ @routine $523924 TfScaner_UpdateSkills }
procedure TfScaner.UpdateSkills;
var
  I: Integer;
  // @nested $5236A0 UpdateOne
  procedure UpdateOne(Index, BaseLevel, EffectiveLevel: Integer); // @addr $5236A0 @ida "void __usercall $name(int Index@<eax>, int BaseLevel@<edx>, int EffectiveLevel@<ecx>, void *ParentFrame@<^0>);"
  var
...
{ @routine $523B10 TfScaner_CreateAdditionalInfoIcon }
...
{ @routine $523F78 TfScaner_BuildAdditionalInfo }
...
var
  ...
  // @nested $523C1C AddRow
  procedure AddRow(IconId: Integer; Caption, Help: WideString; Data: Integer); // @addr $523C1C @stackpop $4 @calls "0x524062 0x524344" @ida "void __userpurge $name(int IconId@<eax>, unsigned __int16 *Caption@<edx>, unsigned __int16 *Help@<ecx>, int Data@<^0>, void *ParentFrame@<^4>);"
  begin
...
{ @routine $524610 TfScaner_ExecuteUiCode }
...
{ @routine $524674 TfScaner_SelectMusic }
