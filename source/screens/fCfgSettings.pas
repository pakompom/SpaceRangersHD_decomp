unit fCfgSettings;
// Unit bracket (inferred): .text 0x0053E458..0x0054EAA3; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    procedure InitializeLayout; override; // @addr 0x53E5E0
    procedure OnOpen; override; // @addr 0x53F124
    procedure OnClose; override; // @addr 0x5450B8
    procedure SelectMusic; override; // @addr 0x54E71C
    procedure ExecuteUiCode(Block: TBlockParEC; Key: Cardinal); override; // @addr 0x54EA50
    procedure ProcessMouseWheel(KeyState: Cardinal; Point: TPoint; Delta: Integer); override; // @addr 0x54B604 @ida "void __userpurge $name(TfCfgSettings *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>, int Delta@<^0>);"
    procedure MainPanelMouseMove(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x545108 @ida "void __userpurge $name(TfCfgSettings *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure ShowControlHelp(Sender: TObjectGI; Show: Boolean); // @addr 0x5452E4
    procedure GroupClicked(Sender: TObjectGI); // @addr 0x545358
    procedure RefreshVisibleGroup; // @addr 0x5454BC
    function AddOptionLabel(OptionName, Caption: WideString; UnusedFlag: Boolean): TLabelGI; // @addr 0x5456BC
    procedure AddOptionChoice(Value: Integer; Caption: WideString; Selected, Disabled: Boolean); // @addr 0x5459C0
    procedure OptionChoiceMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x545E88 @ida "void __userpurge $name(TfCfgSettings *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure OptionChoiceMouseEnter(Sender: TObjectGI); // @addr 0x546070
    procedure OptionChoiceMouseLeave(Sender: TObjectGI); // @addr 0x5461AC
    procedure AddOptionSlider(ValueLabel: TLabelGI; Minimum, Maximum, Position, UnusedStep: Integer; Callback: TOptionSliderEvent); // @addr 0x5462E8 @note "Invokes Callback immediately with the new slider."
    function HasOptionValue(OptionName: WideString): Boolean; // @addr 0x546A60 @note "Searches only the active group."
    function GetOptionValue(OptionName: WideString): Integer; // @addr 0x546BC0 @note "Searches only the active group; raises when no selected choice or slider exists."
    procedure SetOptionValue(OptionName: WideString; Value: Integer); // @addr 0x546D7C @note "Searches only the active group; missing options are ignored."
    procedure FormatResolution(Sender: TCountBarGI); // @addr 0x546E84
    procedure FormatRobotResolution(Sender: TCountBarGI); // @addr 0x547078
    procedure FormatRobotFsaaSamples(Sender: TCountBarGI); // @addr 0x54726C
    procedure PreviewBrightness(Sender: TCountBarGI); // @addr 0x54736C @note "Changes display gamma before settings are applied."
    procedure PreviewContrast(Sender: TCountBarGI); // @addr 0x547500 @note "Changes display gamma before settings are applied."
    procedure FormatInteger(Sender: TCountBarGI); // @addr 0x547694
    procedure FormatTurnSaveStep(Sender: TCountBarGI); // @addr 0x547784
    procedure FormatForsageDeactivatePercent(Sender: TCountBarGI); // @addr 0x547A60
    procedure HighPresetClicked(Sender: TObjectGI); // @addr 0x547CBC
    procedure MediumPresetClicked(Sender: TObjectGI); // @addr 0x548600
    procedure LowPresetClicked(Sender: TObjectGI); // @addr 0x548F18
    procedure AutoPresetClicked(Sender: TObjectGI); // @addr 0x5497FC
    procedure CancelClicked(Sender: TObjectGI); // @addr 0x54A530
    procedure ModeMouseEnter(Sender: TObjectGI); // @addr 0x54B2E4
    procedure ModeMouseLeave(Sender: TObjectGI); // @addr 0x54B38C
    procedure RefreshModeUi; // @addr 0x54A55C
    procedure ModeLeaveTimerTick(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x54B3F4
    procedure ModeMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x54B498 @ida "void __userpurge $name(TfCfgSettings *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure ModeMouseUp(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x54B528 @ida "void __userpurge $name(TfCfgSettings *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure MainPanelKeyDown(Sender: TObjectGI; Key: Cardinal); // @addr 0x54B5CC
    procedure ApplyClicked(Sender: TObjectGI); // @addr 0x54B6BC @note "Persists CFG.TXT; changes requiring rebuilt resources request another runtime session."
    function CreateWarningImage(Owner: TLabelGI; Item: PFontObjectEC): TObjectGI; // @addr 0x54E628 @note "Embedded-item data is ignored."
  end;

function EstimateCpuClockMHz: Double; // @addr 0x53E504 @note "Uses the low 32 bits of a timestamp-counter delta across a 200 ms sleep; temporarily raises process/thread priority."

var
  SettingsModeColorNormal: Cardinal; // @addr $889A4C
  SettingsModeColorHighlighted: Cardinal; // @addr $889A50
...
{ @routine $53E504 EstimateCpuClockMHz }
...
{ @routine $53E5E0 TfCfgSettings_InitializeLayout }
...
{ @routine $53F124 TfCfgSettings_OnOpen }
...
{ @routine $5450B8 TfCfgSettings_OnClose }
...
{ @routine $545108 TfCfgSettings_MainPanelMouseMove }
...
{ @routine $5452E4 TfCfgSettings_ShowControlHelp }
...
{ @routine $545358 TfCfgSettings_GroupClicked }
...
{ @routine $5454BC TfCfgSettings_RefreshVisibleGroup }
...
{ @routine $5456BC TfCfgSettings_AddOptionLabel }
...
{ @routine $5459C0 TfCfgSettings_AddOptionChoice }
...
{ @routine $545E88 TfCfgSettings_OptionChoiceMouseDown }
...
{ @routine $546070 TfCfgSettings_OptionChoiceMouseEnter }
...
{ @routine $5461AC TfCfgSettings_OptionChoiceMouseLeave }
...
{ @routine $5462E8 TfCfgSettings_AddOptionSlider }
...
{ @routine $546A60 TfCfgSettings_HasOptionValue }
...
{ @routine $546BC0 TfCfgSettings_GetOptionValue }
...
{ @routine $546D7C TfCfgSettings_SetOptionValue }
...
{ @routine $546E84 TfCfgSettings_FormatResolution }
...
{ @routine $547078 TfCfgSettings_FormatRobotResolution }
...
{ @routine $54726C TfCfgSettings_FormatRobotFsaaSamples }
...
{ @routine $54736C TfCfgSettings_PreviewBrightness }
...
{ @routine $547500 TfCfgSettings_PreviewContrast }
...
{ @routine $547694 TfCfgSettings_FormatInteger }
...
{ @routine $547784 TfCfgSettings_FormatTurnSaveStep }
...
{ @routine $547A60 TfCfgSettings_FormatForsageDeactivatePercent }
...
{ @routine $547CBC TfCfgSettings_HighPresetClicked }
...
{ @routine $548600 TfCfgSettings_MediumPresetClicked }
...
{ @routine $548F18 TfCfgSettings_LowPresetClicked }
...
{ @routine $5497FC TfCfgSettings_AutoPresetClicked }
...
{ @routine $54A530 TfCfgSettings_CancelClicked }
...
{ @routine $54A55C TfCfgSettings_RefreshModeUi }
...
{ @routine $54B2E4 TfCfgSettings_ModeMouseEnter }
...
{ @routine $54B38C TfCfgSettings_ModeMouseLeave }
...
{ @routine $54B3F4 TfCfgSettings_ModeLeaveTimerTick }
...
{ @routine $54B498 TfCfgSettings_ModeMouseDown }
...
{ @routine $54B528 TfCfgSettings_ModeMouseUp }
...
{ @routine $54B5CC TfCfgSettings_MainPanelKeyDown }
...
{ @routine $54B604 TfCfgSettings_ProcessMouseWheel }
...
{ @routine $54B6BC TfCfgSettings_ApplyClicked }
{$I-}
...
{ @routine $54E628 TfCfgSettings_CreateWarningImage }
...
{ @routine $54E71C TfCfgSettings_SelectMusic }
...
{ @routine $54EA50 TfCfgSettings_ExecuteUiCode }
