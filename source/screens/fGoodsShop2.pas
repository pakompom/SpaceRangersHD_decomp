unit fGoodsShop2;
// Unit bracket (inferred): .text 0x00513360..0x0051B0FF; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    procedure GoodsMouseUp(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $5170F8 @ida "void __userpurge $name(TfGoodsShop2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure GoodsRightMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $517F14 @ida "void __userpurge $name(TfGoodsShop2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure GoodsMouseMove(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $517F60 @ida "void __userpurge $name(TfGoodsShop2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure GoodsMouseEnter(Sender: TObjectGI); // @addr $518940
    procedure GoodsMouseLeave(Sender: TObjectGI); // @addr $51895C
    function GetMaximumTradeCount(Index: Integer; IgnoreCargoSpace: Boolean): Integer; // @addr $518978
    function GetAvailableGoodsCount(Index: Integer): Integer; // @addr $518B04
    procedure SavePricesClicked(Sender: TObjectGI); // @addr $519ADC
    procedure EndTurnClicked(Sender: TObjectGI); // @addr $519C40
    procedure GalaxyClicked(Sender: TObjectGI); // @addr $519F18
    procedure QuestClicked(Sender: TObjectGI); // @addr $519F5C
    procedure MenuClicked(Sender: TObjectGI); // @addr $519FA0
    procedure ShipClicked(Sender: TObjectGI); // @addr $519FE4
    procedure FinishModalTrade; // @addr $51A164
    procedure CaptureMerchantBackground(Sender: TObjectGI); // @addr $51A194
    procedure MerchantAnimationComplete(Sender: TObjectGI); // @addr $51A2D4
    procedure CloseClicked(Sender: TObjectGI); // @addr $51A5D0
    procedure RefreshMoneyWarning; // @addr $51A5FC
    procedure FlashMoneyWarning; // @addr $51A74C
    procedure MoneyWarningTick(Timer: PCallbackTimerGI; UserData: Integer); // @addr $51A7C4
    procedure RefreshCargoWarning; // @addr $51A828
    procedure FlashCargoWarning; // @addr $51A974
    procedure CargoWarningTick(Timer: PCallbackTimerGI; UserData: Integer); // @addr $51A9EC
    procedure MainPanelKeyDown(Sender: TObjectGI; Key: Cardinal); // @addr $51AA50
    procedure ShowControlHelp(Sender: TObjectGI; Visible: Boolean); // @addr $51AC10
    procedure ShowHelpText(Value: WideString; Visible: Boolean); // @addr $51ACB8

    constructor Create; // @addr 0x5133FC @ida "TfGoodsShop2 *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x5134CC @ida "void __usercall $name(TfGoodsShop2 *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure OnOpen; override; // @addr 0x513D2C
    procedure RefreshGoodsDisplay; // @addr $515B14 Rebuilds cargo/market controls and prices for the current trading context.
    procedure OnClose; override; // @addr 0x515988
    procedure ProcessCallbackTimers; override; // @addr 0x51AD78
    procedure SelectMusic; override; // @addr 0x51AE2C
    procedure InitializeLayout; override; // @addr 0x51357C
    procedure UpdateActionCursor(CanTake: Boolean); override; // @addr 0x5186CC
    procedure ExecuteUiCode(Block: TBlockParEC; Key: Cardinal); override; // @addr 0x51ADB8
    function BuildPriceText(Location: TObject): WideString; // @addr $518B58 @ida "void __usercall $name(TfGoodsShop2 *Self@<eax>, TObject *Location@<edx>, unsigned __int16 **Result@<ecx>);"
  end;

function RunGoodsShop(ParentLoop: TMessageLoopGI): Boolean; // @addr $51B094 Native modal wrapper used while talking to another ship.

const
  ShopGoodsOrder: TGoodsTextOrder = (0, 1, 5, 4, 3, 2, 6, 7); // @addr $87AA04 Native unit-local copy of the goods presentation order.
...
var
  OutOfStockColor: WideString; // @addr $889A30 Native style-derived out-of-stock price markup.

{ @routine $5133FC TfGoodsShop2_Create }
...
{ @routine $5134CC TfGoodsShop2_Destroy }
...
{ @routine $51357C TfGoodsShop2_InitializeLayout }
...
{ @routine $513D2C TfGoodsShop2_OnOpen }
...
{ @routine $515988 TfGoodsShop2_OnClose }
...
{ @routine $515B14 TfGoodsShop2_RefreshGoodsDisplay }
...
{ @routine $5170F8 TfGoodsShop2_GoodsMouseUp }
...
{ @routine $517F14 TfGoodsShop2_GoodsRightMouseDown }
...
{ @routine $517F60 TfGoodsShop2_GoodsMouseMove }
...
{ @routine $5186CC TfGoodsShop2_UpdateActionCursor }
...
{ @routine $518940 TfGoodsShop2_GoodsMouseEnter }
...
{ @routine $51895C TfGoodsShop2_GoodsMouseLeave }
...
{ @routine $518978 TfGoodsShop2_GetMaximumTradeCount }
...
{ @routine $518B04 TfGoodsShop2_GetAvailableGoodsCount }
...
{ @routine $518B58 TfGoodsShop2_BuildPriceText }
...
{ @routine $519ADC TfGoodsShop2_SavePricesClicked }
...
{ @routine $519C40 TfGoodsShop2_EndTurnClicked }
...
{ @routine $519F18 TfGoodsShop2_GalaxyClicked }
...
{ @routine $519F5C TfGoodsShop2_QuestClicked }
...
{ @routine $519FA0 TfGoodsShop2_MenuClicked }
...
{ @routine $519FE4 TfGoodsShop2_ShipClicked }
...
{ @routine $51A164 TfGoodsShop2_FinishModalTrade }
...
{ @routine $51A194 TfGoodsShop2_CaptureMerchantBackground }
...
{ @routine $51A2D4 TfGoodsShop2_MerchantAnimationComplete }
...
{ @routine $51A5D0 TfGoodsShop2_CloseClicked }
...
{ @routine $51A5FC TfGoodsShop2_RefreshMoneyWarning }
...
{ @routine $51A74C TfGoodsShop2_FlashMoneyWarning }
...
{ @routine $51A7C4 TfGoodsShop2_MoneyWarningTick }
...
{ @routine $51A828 TfGoodsShop2_RefreshCargoWarning }
...
{ @routine $51A974 TfGoodsShop2_FlashCargoWarning }
...
{ @routine $51A9EC TfGoodsShop2_CargoWarningTick }
...
{ @routine $51AA50 TfGoodsShop2_MainPanelKeyDown }
...
{ @routine $51AC10 TfGoodsShop2_ShowControlHelp }
...
{ @routine $51ACB8 TfGoodsShop2_ShowHelpText }
...
{ @routine $51AD78 TfGoodsShop2_ProcessCallbackTimers }
...
{ @routine $51ADB8 TfGoodsShop2_ExecuteUiCode }
...
{ @routine $51AE2C TfGoodsShop2_SelectMusic }
