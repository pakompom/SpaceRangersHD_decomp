unit fJump;
// Unit bracket (inferred): .text 0x0053BA18..0x0053C859; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    constructor Create; // @addr 0x53BAAC @ida "TfJump *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x53BB04 @ida "void __usercall $name(TfJump *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure OnOpen; override; // @addr 0x53BCE8
    procedure OnClose; override; // @addr 0x53C0C8
    procedure SelectMusic; override; // @addr 0x53C850
    procedure InitializeLayout; override; // @addr 0x53BB5C
    procedure AdvanceTravel(Timer: PCallbackTimerGI; UserData: Integer); // @addr $53C150
    procedure AdvanceLoading(Timer: PCallbackTimerGI; UserData: Integer); // @addr $53C470
    procedure AdvanceMovie(Timer: PCallbackTimerGI; UserData: Integer); // @addr $53C730
    function StopMovie: Boolean; // @addr $53C79C
  end;
...
{ @routine $53BB5C TfJump_InitializeLayout }
...
{ @routine $53BCE8 TfJump_OnOpen }
procedure TfJump.OnOpen;
var
  MovieConfig, MoviePath: WideString;
  // @nested $53BC5C BeginTravel
  procedure BeginTravel; cdecl; // @addr $53BC5C @ida "void __cdecl $name(void *ParentFrame);"
  begin
...
{ @routine $53C150 TfJump_AdvanceTravel }
...
{ @routine $53C470 TfJump_AdvanceLoading }
...
{ @routine $53C730 TfJump_AdvanceMovie }
...
{ @routine $53C79C TfJump_StopMovie }
...
{ @routine $53C850 TfJump_SelectMusic }
