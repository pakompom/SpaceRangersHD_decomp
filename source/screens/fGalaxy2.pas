unit fGalaxy2;
// Unit bracket (inferred): .text 0x0069FAEC..0x006A989F; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    destructor Destroy; override; // @addr 0x69FBFC @ida "void __usercall $name(TfGalaxy2 *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure OnOpen; override; // @addr 0x6A0160
    procedure OnClose; override; // @addr 0x6A2DC0
    procedure ProcessCallbackTimers; override; // @addr 0x6A9548
    procedure SelectMusic; override; // @addr 0x6A9214
    procedure InitializeLayout; override; // @addr 0x69FC54
    procedure ExecuteUiCode(Block: TBlockParEC; Key: Cardinal); override; // @addr 0x6A983C
    function GalaxyPointToMapPoint(Point: TPointF): TPoint; // @addr 0x6A32B4 @ida "void __usercall $name(TfGalaxy2 *Self@<eax>, TPointF *Point@<edx>, TPoint *Result@<ecx>);"
    function GalaxyDistanceToMapDistance(Distance: Double): Integer; // @addr 0x6A3358 @ida "int __userpurge $name@<eax>(TfGalaxy2 *Self@<eax>, double Distance@<^0>);" @note "Uses the horizontal projection scale."
    procedure ConfigureReadOnlyMap; // @addr 0x6A3EF0
    procedure ConfigureJumpSelection; // @addr 0x6A4024
    procedure ShowStarInfo(Star: TStar); // @addr 0x6A5078 @note "Nil hides the panel; cancels StarInfoHideTimer."
    procedure HideStarInfo(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6A47B8
    procedure UpdateJumpAnimations(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6A8E40
    function CanShowExtendedRadarInfo(Star: TStar): Boolean; // @addr 0x6A3134 @note "Requires an active Prolonger effect as well as radar coverage."
    function GetRadarSummaryRadius: Integer; // @addr 0x6A31D8 @note "Measured in radar-summary units of 150 range units."
    function CanRevealBossPresence(Ship: TShip): Boolean; // @addr 0x6A73F4 @note "Requires boss-specific scanner technology; does not test general visibility."

    procedure CloseClicked(Sender: TObjectGI); // @addr $6A2F10
    procedure JumpClicked(Sender: TObjectGI); // @addr $6A47D8
    procedure JumpMouseEnter(Sender: TObjectGI); // @addr $6A4E34
    procedure JumpMouseLeave(Sender: TObjectGI); // @addr $6A5018
    procedure CreateMarkerClicked(Sender: TObjectGI); // @addr $6A96D8
    procedure UndoMarkerClicked(Sender: TObjectGI); // @addr $6A97C0
    procedure ClearMarkersClicked(Sender: TObjectGI); // @addr $6A9804
    procedure MainPanelKeyDown(Sender: TObjectGI; Key: Cardinal); // @addr $6A2F3C
    procedure MainPanelMouseUp(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $6A300C @ida "void __userpurge $name(TfGalaxy2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure MapMouseMove(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $6A4250 @ida "void __userpurge $name(TfGalaxy2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure MapLeftButtonDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $6A4280 @ida "void __userpurge $name(TfGalaxy2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure MapRightButtonDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $6A45A4 @ida "void __userpurge $name(TfGalaxy2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure MapButtonUp(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $6A46FC @ida "void __userpurge $name(TfGalaxy2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure MapDoubleClick(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $6A476C @ida "void __userpurge $name(TfGalaxy2 *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure RebuildJumpPath; // @addr $6A339C
    procedure ClearJumpPath; // @addr $6A3E60
    procedure ClearReadOnlyMapCallbacks; // @addr $6A3FEC
    procedure ClearJumpSelectionCallbacks; // @addr $6A41E0
    function MapPointToGalaxyPoint(Point: TPoint): TPointF; // @addr $6A320C @ida "void __usercall $name(TfGalaxy2 *Self@<eax>, TPoint *Point@<edx>, TPointF *Result@<ecx>);"
    function BuildStarShipSummary(Star: TStar; var LineCount: Integer): WideString; // @addr $6A7BA0 @ida "void __userpurge $name(TfGalaxy2 *Self@<eax>, TStar *Star@<edx>, int *LineCount@<ecx>, unsigned __int16 **Result@<^0>);"

    constructor Create; // @addr 0x69FB9C @ida "TfGalaxy2 *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
  end;

procedure CaptureGalaxyPreview(ParentLoop: TMessageLoopGI); // @addr $6A9670
function RunGalaxyMap(ParentLoop: TMessageLoopGI): Boolean; // @addr $6A9588

const
  GalaxyMapFriendlyShipOrder: array[1..7] of Byte = (0, 1, 10, 2, 3, 4, 5); // @addr $87B870
...
{ @routine $69FB9C TfGalaxy2_Create }
...
{ @routine $69FBFC TfGalaxy2_Destroy }
...
{ @routine $69FC54 TfGalaxy2_InitializeLayout }
...
{ @routine $6A0160 TfGalaxy2_OnOpen }
...
{ @routine $6A2DC0 TfGalaxy2_OnClose }
...
{ @routine $6A2F10 TfGalaxy2_CloseClicked }
...
{ @routine $6A2F3C TfGalaxy2_MainPanelKeyDown }
...
{ @routine $6A300C TfGalaxy2_MainPanelMouseUp }
...
{ @routine $6A3134 TfGalaxy2_CanShowExtendedRadarInfo }
...
{ @routine $6A31D8 TfGalaxy2_GetRadarSummaryRadius }
...
{ @routine $6A320C TfGalaxy2_MapPointToGalaxyPoint }
...
{ @routine $6A32B4 TfGalaxy2_GalaxyPointToMapPoint }
...
{ @routine $6A3358 TfGalaxy2_GalaxyDistanceToMapDistance }
...
{ @routine $6A339C TfGalaxy2_RebuildJumpPath }
...
{ @routine $6A3E60 TfGalaxy2_ClearJumpPath }
...
{ @routine $6A3EF0 TfGalaxy2_ConfigureReadOnlyMap }
...
{ @routine $6A3FEC TfGalaxy2_ClearReadOnlyMapCallbacks }
...
{ @routine $6A4024 TfGalaxy2_ConfigureJumpSelection }
...
{ @routine $6A41E0 TfGalaxy2_ClearJumpSelectionCallbacks }
...
{ @routine $6A4250 TfGalaxy2_MapMouseMove }
...
{ @routine $6A4280 TfGalaxy2_MapLeftButtonDown }
...
{ @routine $6A45A4 TfGalaxy2_MapRightButtonDown }
...
{ @routine $6A46FC TfGalaxy2_MapButtonUp }
...
{ @routine $6A476C TfGalaxy2_MapDoubleClick }
...
{ @routine $6A47B8 TfGalaxy2_HideStarInfo }
...
{ @routine $6A47D8 TfGalaxy2_JumpClicked }
...
{ @routine $6A4E34 TfGalaxy2_JumpMouseEnter }
...
{ @routine $6A5018 TfGalaxy2_JumpMouseLeave }
...
{ @routine $6A5078 TfGalaxy2_ShowStarInfo }
...
{ @routine $6A73F4 TfGalaxy2_CanRevealBossPresence }
...
{ @routine $6A7BA0 TfGalaxy2_BuildStarShipSummary }
...
var
  ...
  // @nested $6A74A4 AccumulateShip
  procedure AccumulateShip; cdecl; // @addr $6A74A4 @ida "void __cdecl $name(void *ParentFrame);"
  ...
  // @nested $6A7A88 SeriesColor
  function SeriesColor: WideString; // @addr $6A7A88 @ida "void __usercall $name(unsigned __int16 **Result@<eax>, void *ParentFrame@<^0>);"
  begin
    Result := '';
    case Series of
  ...
  // @nested $6A7B4C AppendLine
  procedure AppendLine; cdecl; // @addr $6A7B4C @ida "void __cdecl $name(void *ParentFrame);"
  begin
    if LineActive then
    begin
...
{ @routine $6A8E40 TfGalaxy2_UpdateJumpAnimations }
...
{ @routine $6A9214 TfGalaxy2_SelectMusic }
...
{ @routine $6A9548 TfGalaxy2_ProcessCallbackTimers }
...
{ @routine $6A9670 CaptureGalaxyPreview }
...
{ @routine $6A96D8 TfGalaxy2_CreateMarkerClicked }
...
{ @routine $6A97C0 TfGalaxy2_UndoMarkerClicked }
...
{ @routine $6A9804 TfGalaxy2_ClearMarkersClicked }
...
{ @routine $6A983C TfGalaxy2_ExecuteUiCode }
