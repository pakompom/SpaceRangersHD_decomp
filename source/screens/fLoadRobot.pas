unit fLoadRobot;
// Unit bracket (inferred): .text 0x005F6550..0x005FAA81; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    procedure CloseClick(Sender: TObjectGI); // @addr $5F7514
    procedure KeyDown(Sender: TObjectGI; Key: Cardinal); // @addr $5F7548
    function InsertEntry(Access: Integer): Integer; // @addr $5F7C40
    procedure RebuildEntries; // @addr $5F7D28
    procedure BuildEntryPanel(Panel: TObjectGI); // @addr $5F848C
    procedure SelectEntry(Index: Integer); // @addr $5F92B8
    procedure UpdateEntryImage(Index: Integer); // @addr $5F9400
    procedure EntryMouseEnter(Sender: TObjectGI); // @addr $5F9634
    procedure EntryMouseLeave(Sender: TObjectGI); // @addr $5F96A0
    procedure EntryMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $5F9700 @ida "void __userpurge $name(TfLoadRobot *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure EntryDoubleClick(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr $5F9778 @ida "void __userpurge $name(TfLoadRobot *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure CategoryClick(Sender: TObjectGI); // @addr $5F97A4
    procedure DifficultyClick(Sender: TObjectGI); // @addr $5F9904
    procedure StartClick(Sender: TObjectGI); // @addr $5F99D8
    procedure UpdateSelectionDetails; // @addr $5F9A60
    function GetUnlockedAccess: Integer; // @addr $5FA764

    constructor Create; // @addr $5F6650 @ida "TfLoadRobot *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr $5F66CC @ida "void __usercall $name(TfLoadRobot *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure OnOpen; override; // @addr $5F6C28
    procedure OnClose; override; // @addr $5F74D4
    procedure SelectMusic; override; // @addr $5FAA78
    procedure ProcessMouseWheel(KeyState: Cardinal; Point: TPoint; Delta: Integer); override; // @addr $5F7AEC @ida "void __userpurge $name(TfLoadRobot *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>, int Delta@<^0>);"
    procedure InitializeLayout; override; // @addr $5F6724
    procedure SaveCompletionData; // @addr $5FA4A8
    procedure RecordCompletion(MapId, Score, Level: Integer); // @addr $5FA61C
    procedure LoadCompletionData; // @addr $5FA300
    function GetCompletionCounts: TPoint; // @addr $5FA8C0 @ida "void __usercall $name(TfLoadRobot *Self@<eax>, TPoint *Result@<edx>);" @note "X completed, Y eligible; groups greater than -1 are eligible."
    function GetCompletionSummary: WideString; // @addr $5FA998 @ida "void __usercall $name(TfLoadRobot *Self@<eax>, unsigned __int16 **Result@<edx>);" @note "Menu summary; displayed total includes groups 0..2."
  end;

var
  RobotMapNameColor: Cardinal; // @addr $889C00
...
{ @routine $5F6650 TfLoadRobot_Create }
...
{ @routine $5F66CC TfLoadRobot_Destroy }
...
{ @routine $5F6724 TfLoadRobot_InitializeLayout }
...
{ @routine $5F6C28 TfLoadRobot_OnOpen }
...
begin
  ...
  begin
    ...
    ReplaceTextToken(StartText, '<Star>', LocalizedText('FormLoadRobot.PStar'), '<color=255,240,100>');
    ReplaceTextToken(StartText, '<Planet>', LocalizedText('FormLoadRobot.PPlanet'), '<color=255,240,100>');
    ReplaceTextToken(StartText, '<Player>', LocalizedText('FormLoadRobot.PPlayer'), '<color=255,240,100>');
    ...
    ReplaceTextToken(WinText, '<Star>', LocalizedText('FormLoadRobot.PStar'), '<color=255,240,100>');
    ReplaceTextToken(WinText, '<Planet>', LocalizedText('FormLoadRobot.PPlanet'), '<color=255,240,100>');
    ReplaceTextToken(WinText, '<Player>', LocalizedText('FormLoadRobot.PPlayer'), '<color=255,240,100>');
    ExpandLocalizedTextMarkupAndPrefixLines(WinText);
    ReplaceTextToken(LossText, '<Star>', LocalizedText('FormLoadRobot.PStar'), '<color=255,240,100>');
    ReplaceTextToken(LossText, '<Planet>', LocalizedText('FormLoadRobot.PPlanet'), '<color=255,240,100>');
    ReplaceTextToken(LossText, '<Player>', LocalizedText('FormLoadRobot.PPlayer'), '<color=255,240,100>');
...
{ @routine $5F74D4 TfLoadRobot_OnClose }
...
{ @routine $5F7514 TfLoadRobot_CloseClick }
...
{ @routine $5F7548 TfLoadRobot_KeyDown }
...
{ @routine $5F7AEC TfLoadRobot_ProcessMouseWheel }
...
{ @routine $5F7C40 TfLoadRobot_InsertEntry }
...
{ @routine $5F7D28 TfLoadRobot_RebuildEntries }
...
{ @routine $5F848C TfLoadRobot_BuildEntryPanel }
...
{ @routine $5F92B8 TfLoadRobot_SelectEntry }
...
{ @routine $5F9400 TfLoadRobot_UpdateEntryImage }
...
{ @routine $5F9634 TfLoadRobot_EntryMouseEnter }
...
{ @routine $5F96A0 TfLoadRobot_EntryMouseLeave }
...
{ @routine $5F9700 TfLoadRobot_EntryMouseDown }
...
{ @routine $5F9778 TfLoadRobot_EntryDoubleClick }
...
{ @routine $5F97A4 TfLoadRobot_CategoryClick }
...
{ @routine $5F9904 TfLoadRobot_DifficultyClick }
...
{ @routine $5F99D8 TfLoadRobot_StartClick }
...
{ @routine $5F9A60 TfLoadRobot_UpdateSelectionDetails }
...
begin
  ...
  begin
    ...
    begin
      ...
      ReplaceTextToken(Text, '<Planet>', LocalizedText('FormLoadRobot.PPlanet'), '<color=0,71,234>');
      ReplaceTextToken(Text, '<Player>', LocalizedText('FormLoadRobot.PPlayer'), '<color=0,71,234>');
...
{ @routine $5FA300 TfLoadRobot_LoadCompletionData }
...
{ @routine $5FA4A8 TfLoadRobot_SaveCompletionData }
...
{ @routine $5FA61C TfLoadRobot_RecordCompletion }
...
{ @routine $5FA764 TfLoadRobot_GetUnlockedAccess }
...
{ @routine $5FA8C0 TfLoadRobot_GetCompletionCounts }
...
{ @routine $5FA998 TfLoadRobot_GetCompletionSummary }
...
{ @routine $5FAA78 TfLoadRobot_SelectMusic }
