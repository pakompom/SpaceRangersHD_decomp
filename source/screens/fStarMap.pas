unit fStarMap;
// Unit bracket (inferred): .text 0x006A48B4..0x006C77AF; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    ReservedEntries1: array of TStarMapReservedEntry; // @offset $1DC 250 entries; native RTTI $6A48B4. Allocated/freed, purpose unresolved.
    ReservedEntries2: array of TStarMapReservedEntry; // @offset $1E0 250 entries; native RTTI $6A48D8. Allocated/freed, purpose unresolved.
    ...
    procedure EndTurnClicked(Sender: TObjectGI); // @addr 0x6A8820
    procedure ClearPathOverlay(PlayerPath: Boolean); // @addr 0x6AA808
    procedure RefreshScoreModsLabel; // @addr 0x6A9198

    procedure ProcessTurnFilm; // @addr 0x6BDC70
    procedure AdvanceFilmFrame(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6BE890
    procedure UpdateTurnCalculation(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6BE9FC
    procedure StartTurnFilm; // @addr 0x6BD45C
    procedure StopTurnFilm(StopTurnProcessing: Boolean); // @addr 0x6BD8AC
    ...
    procedure SaveSpaceBackground; // @addr 0x6A8794
    procedure DeferredEndTurn(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6A87D8
    procedure MapKeyDown(Sender: TObjectGI; Key: Cardinal); // @addr 0x6A8B18
    procedure MapKeyUp(Sender: TObjectGI; Key: Cardinal); // @addr 0x6A9094
    procedure BuildShipPathOverlay(Ship: TShip; DelayEndImage: Boolean; InitialImagePath: WideString); // @addr 0x6A967C @note "May rebuild the ship movement path and update its order destination."
    procedure UpdatePathEndImage(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6AA760
    procedure ShowAsteroidPath(Asteroid: TAsteroid); // @addr 0x6AA974
    procedure ClearAsteroidPath; // @addr 0x6AAC14
    ...
    procedure QueueInterfaceImages; // @addr 0x6AC568
    procedure ShowLargeHelp(const Text: WideString); // @addr 0x6AC5C8
    procedure HideLargeHelp; // @addr 0x6AC660
    procedure AnimateLargeHelp(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6AC6B4
    procedure RedrawMap; // @addr 0x6AC8AC
    procedure RunTalkDialogs; // @addr 0x6ACC4C
    procedure GalaxyClicked(Sender: TObjectGI); // @addr 0x6ACF50
    procedure ShipClicked(Sender: TObjectGI); // @addr 0x6AD020
    procedure StartOrderMode; // @addr 0x6AD138
    procedure StopOrderMode; // @addr 0x6AD6CC
    procedure HideOrderInterface; // @addr 0x6AD8C4
    ...
    procedure CenterShipClicked(Sender: TObjectGI); // @addr 0x6BA310
    procedure CenterShipMouseEnter(Sender: TObjectGI); // @addr 0x6BA330
    procedure CenterShipMouseLeave(Sender: TObjectGI); // @addr 0x6BA37C
    procedure AllWeaponsClicked(Sender: TObjectGI); // @addr 0x6BA398
    procedure ScannerClicked(Sender: TObjectGI); // @addr 0x6BA408
    procedure TalkClicked(Sender: TObjectGI); // @addr 0x6BA4E0
    procedure SelectInterceptorTarget; // @addr 0x6BA5A4
    procedure BeginCustomSelection; // @addr 0x6BA668
    procedure ToggleWeaponPanelClicked(Sender: TObjectGI); // @addr 0x6BA6F0
    procedure WeaponButtonDown(Sender: TObjectGI); // @addr 0x6BA744
    procedure WeaponButtonUp(Sender: TObjectGI); // @addr 0x6BA790
    procedure RefreshWeaponButtons; // @addr 0x6BA8CC
    procedure RefreshActionRanges; // @addr 0x6BB1C0
    procedure HideActionRanges; // @addr 0x6BB97C
    procedure RebuildTargetMarkers; // @addr 0x6BBA10
    procedure ClearTargetMarkers; // @addr 0x6BC198
    procedure UpdateWeaponPanelPosition; // @addr 0x6BCC18
    procedure AnimateWeaponPanel(Target: Integer); // @addr 0x6BCD38 @note "Stores the animation direction; native toggle passes -1 to hide and +1 to show."
    procedure AdvanceWeaponPanel(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6BCDAC
    procedure UpdateSpacePanelPosition; // @addr 0x6BCED4
    procedure AnimateSpacePanel(Target: Integer); // @addr 0x6BCFC4 @note "Stores the signed animation direction."
    procedure AdvanceSpacePanel(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x6BD038
    procedure BreakTurnClicked(Sender: TObjectGI); // @addr 0x6BEB44
    procedure UpdateFilmCamera; // @addr 0x6BEC04
    ...
    procedure WaitForTurnOrTalk; // @addr 0x6C6E58
    procedure UpdateTerronTransformation; // @addr 0x6C6FE8
    procedure TerronTransformationStarted(Sender: TObjectGI); // @addr 0x6C7340
    procedure TerronTransformationFrame(Sender: TObjectGI); // @addr 0x6C73F4
    procedure TerronTransformationFinished(Sender: TObjectGI); // @addr 0x6C75C4
  end;

function GetTurnFilmFrameInterval(Activity: Integer): Integer; // @addr 0x6BD3E8 @note "Returns milliseconds, adjusted by the configured film speed."

var
  PanelSlideCurve: array[0..15] of Single = (0, 0.033, 0.112, 0.269, 0.456, 0.675, 0.882, 1.023, 1.09, 1.127, 1.129, 1.111, 1.064, 1.036, 1.011, 1); // @addr $87BF70
  FilmCameraLookAheadSteps: Integer = 30; // @addr $87BFB0
...
{ @routine $6A4AB8 TfStarMap_Destroy }
...
{ @routine $6A4B5C TfStarMap_GetMapCenter }
...
{ @routine $6A4BC8 TfStarMap_SetMapCenterManually }
...
{ @routine $6A4C64 TfStarMap_SetMapCenter }
...
{ @routine $6A4CF8 TfStarMap_CenterMapForTalk }
...
{ @routine $6A4D9C TfStarMap_InitializeLayout }
...
{ @routine $6A64B8 TfStarMap_OnOpen }
...
{ @routine $6A7408 TfStarMap_OnClose }
...
{ @routine $6A7828 TfStarMap_RestorePendingSceneObjects }
...
{ @routine $6A79E4 TfStarMap_BuildSpaceBackground }
...
{ @routine $6A85D8 TfStarMap_SaveSpaceImageState }
...
{ @routine $6A8794 TfStarMap_SaveSpaceBackground }
...
{ @routine $6A87D8 TfStarMap_DeferredEndTurn }
...
{ @routine $6A8820 TfStarMap_EndTurnClicked }
...
{ @routine $6A9094 TfStarMap_MapKeyUp }
...
{ @routine $6A914C TfStarMap_OpenFilmHistoryClicked }
...
{ @routine $6A9198 TfStarMap_RefreshScoreModsLabel }
...
{ @routine $6A967C TfStarMap_BuildShipPathOverlay }
...
{ @routine $6AA760 TfStarMap_UpdatePathEndImage }
...
{ @routine $6AA808 TfStarMap_ClearPathOverlay }
...
{ @routine $6AA974 TfStarMap_ShowAsteroidPath }
...
{ @routine $6AAC14 TfStarMap_ClearAsteroidPath }
...
{ @routine $6AACBC TfStarMap_ClearPartnerButtons }
...
{ @routine $6AACE8 TfStarMap_RebuildPartnerButtons }
...
{ @routine $6AB5DC TfStarMap_PartnerClicked }
...
{ @routine $6AB888 TfStarMap_PartnerRightButtonDown }
...
{ @routine $6AB98C TfStarMap_PartnerMouseEnter }
...
{ @routine $6AB9E4 TfStarMap_PartnerMouseLeave }
...
{ @routine $6ABA00 TfStarMap_AddMapAnimation }
...
{ @routine $6ABB34 TfStarMap_ClearMapAnimations }
...
{ @routine $6ABB8C TfStarMap_MapAnimationFinished }
...
{ @routine $6ABBB0 TfStarMap_FindObjectAtCursor }
...
{ @routine $6AC568 TfStarMap_QueueInterfaceImages }
...
{ @routine $6AC5C8 TfStarMap_ShowLargeHelp }
...
{ @routine $6AC660 TfStarMap_HideLargeHelp }
...
{ @routine $6AC6B4 TfStarMap_AnimateLargeHelp }
...
{ @routine $6AC8AC TfStarMap_RedrawMap }
...
{ @routine $6AC8EC TfStarMap_DrawFrame }
...
{ @routine $6ACC4C TfStarMap_RunTalkDialogs }
...
{ @routine $6ACF50 TfStarMap_GalaxyClicked }
...
{ @routine $6AD020 TfStarMap_ShipClicked }
...
{ @routine $6AD138 TfStarMap_StartOrderMode }
...
{ @routine $6AD6CC TfStarMap_StopOrderMode }
...
{ @routine $6AD8C4 TfStarMap_HideOrderInterface }
...
{ @routine $6AD978 TfStarMap_ConfigureMiddleButtonAction }
...
{ @routine $6AD9C8 TfStarMap_ScrollMap }
...
{ @routine $6ADB48 TfStarMap_AdvanceSpaceEffects }
...
{ @routine $6ADBB4 TfStarMap_IsMapPointBlocked }
...
{ @routine $6ADE34 TfStarMap_MapLeftButtonDown }
...
{ @routine $6B0418 TfStarMap_MapMiddleButtonDown }
...
{ @routine $6B0CF0 TfStarMap_MapRightButtonDown }
...
{ @routine $6B1A3C TfStarMap_OrderKeyDown }
...
{ @routine $6B222C TfStarMap_OrderKeyUp }
...
{ @routine $6B225C TfStarMap_SelectAllUsableWeapons }
...
{ @routine $6B2308 TfStarMap_SelectUntargetedWeapons }
...
{ @routine $6B2394 TfStarMap_ShowObjectInfo }
...
{ @routine $6B9D40 TfStarMap_MapScrollChanged }
...
{ @routine $6B9D64 TfStarMap_GetPriceSnapshotKey }
...
{ @routine $6B9E74 TfStarMap_SaveVisiblePriceSnapshots }
...
{ @routine $6BA0D0 TfStarMap_CenterOnShip }
...
{ @routine $6BA1FC TfStarMap_CenterOnDominator }
...
{ @routine $6BA310 TfStarMap_CenterShipClicked }
...
{ @routine $6BA330 TfStarMap_CenterShipMouseEnter }
...
{ @routine $6BA37C TfStarMap_CenterShipMouseLeave }
...
{ @routine $6BA398 TfStarMap_AllWeaponsClicked }
...
{ @routine $6BA408 TfStarMap_ScannerClicked }
...
{ @routine $6BA4E0 TfStarMap_TalkClicked }
...
{ @routine $6BA5A4 TfStarMap_SelectInterceptorTarget }
...
{ @routine $6BA668 TfStarMap_BeginCustomSelection }
...
{ @routine $6BA6F0 TfStarMap_ToggleWeaponPanelClicked }
...
{ @routine $6BA744 TfStarMap_WeaponButtonDown }
...
{ @routine $6BA790 TfStarMap_WeaponButtonUp }
...
{ @routine $6BA8CC TfStarMap_RefreshWeaponButtons }
...
{ @routine $6BB1C0 TfStarMap_RefreshActionRanges }
...
{ @routine $6BB97C TfStarMap_HideActionRanges }
...
{ @routine $6BBA10 TfStarMap_RebuildTargetMarkers }
...
{ @routine $6BC198 TfStarMap_ClearTargetMarkers }
...
{ @routine $6BC1F0 TfStarMap_UpdateActionCursor }
...
{ @routine $6BCC18 TfStarMap_UpdateWeaponPanelPosition }
...
{ @routine $6BCD38 TfStarMap_AnimateWeaponPanel }
...
{ @routine $6BCDAC TfStarMap_AdvanceWeaponPanel }
...
{ @routine $6BCED4 TfStarMap_UpdateSpacePanelPosition }
...
{ @routine $6BCFC4 TfStarMap_AnimateSpacePanel }
...
{ @routine $6BD038 TfStarMap_AdvanceSpacePanel }
...
{ @routine $6BD160 TfStarMap_ProcessMouseWheel }
...
{ @routine $6BD3E8 GetTurnFilmFrameInterval }
...
{ @routine $6BD45C TfStarMap_StartTurnFilm }
...
{ @routine $6BD8AC TfStarMap_StopTurnFilm }
...
{ @routine $6BD9BC TfStarMap_RestartTurnFilm }
...
{ @routine $6BDC70 TfStarMap_ProcessTurnFilm }
...
{ @routine $6BE890 TfStarMap_AdvanceFilmFrame }
...
{ @routine $6BE9FC TfStarMap_UpdateTurnCalculation }
...
{ @routine $6BEB44 TfStarMap_BreakTurnClicked }
...
{ @routine $6BEC04 TfStarMap_UpdateFilmCamera }
...
{ @routine $6BF518 TfStarMap_CenterFilmShipClicked }
...
{ @routine $6BF53C TfStarMap_CenterFilmShipMouseEnter }
...
{ @routine $6BF598 TfStarMap_CenterFilmShipMouseLeave }
...
{ @routine $6BF5B4 TfStarMap_FilmMouseMove }
...
{ @routine $6BF660 TfStarMap_FindFilmObjectAtCursor }
...
{ @routine $6BFAF4 TfStarMap_ShowFilmObjectInfo }
...
{ @routine $6C6DA8 TfStarMap_PrepareTalkDisplay }
...
{ @routine $6C6E58 TfStarMap_WaitForTurnOrTalk }
...
{ @routine $6C6FE8 TfStarMap_UpdateTerronTransformation }
...
{ @routine $6C7340 TfStarMap_TerronTransformationStarted }
...
{ @routine $6C73F4 TfStarMap_TerronTransformationFrame }
...
{ @routine $6C75C4 TfStarMap_TerronTransformationFinished }
...
{ @routine $6C7674 TfStarMap_ExecuteUiCode }
...
{ @routine $6C7710 TfStarMap_SelectMusic }
