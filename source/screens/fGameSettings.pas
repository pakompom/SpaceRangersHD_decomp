unit fGameSettings;
// The native thread contribution ends before TfGameSettings2 metadata at $5D6D94.
...
type
  ...
  public
    ...
    procedure Execute; override; // @addr 0x5D36D8
  end;
...
{ @routine $5D36D8 TThreadCreateNewGame_Execute }
