unit GI_MessageBox;
// Unit bracket (inferred): .text 0x004D5528..0x004D6640; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
// Native routines $4D55D4..$4D6641; dialog VMT and managed-field table precede OnOpen.
...
const
  // Native OnOpen ($4D55D4) reads the button, icon and text-alignment bits.
  mbgOK = $01;
  mbgCancel = $02;
...
type
  ...
  public
    ...
    procedure OnOpen; override; // @addr $4D55D4
    procedure AcceptClick(Sender: TObjectGI); // @addr $4D63C8
    procedure CancelClick(Sender: TObjectGI); // @addr $4D6400
    procedure DialogKeyDown(Sender: TObjectGI; VirtualKey: Cardinal); // @addr $4D6438
    procedure ProcessCallbackTimers; override; // @addr $4D64B4
  end;

function ShowMessageBoxGI(Parent: TMessageLoopGI; const Text: WideString; Options: Cardinal; UnusedOption: Integer = 0; OffsetX: Integer = 0; OffsetY: Integer = 0): Cardinal; // @addr $4D64E8
...
{ @routine $4D55D4 TMessageBoxGI_OnOpen }
...
{ @routine $4D63C8 TMessageBoxGI_AcceptClick }
...
{ @routine $4D6400 TMessageBoxGI_CancelClick }
...
{ @routine $4D6438 TMessageBoxGI_DialogKeyDown }
...
{ @routine $4D64B4 TMessageBoxGI_ProcessCallbackTimers }
...
{ @routine $4D64E8 ShowMessageBoxGI }
