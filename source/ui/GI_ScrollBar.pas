unit GI_ScrollBar;
// Unit bracket (inferred): .text 0x00493A6C..0x00497758; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    constructor Create(Owner: TObjectGI); // @addr 0x493B94 @ida "TScrollBarGI *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>, TObjectGI *Owner@<ecx>);"
    destructor Destroy; override; // @addr 0x493FE0 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure Clear; override; // @addr 0x494138 @note "Resets the range to 0..99 and clears callbacks; does not call inherited Clear."
    function GetHitRegion(Point: TPoint): Integer; // @addr 0x4944CC @ida "int __usercall $name@<eax>(TScrollBarGI *Self@<eax>, TPoint *Point@<edx>);" @note "Returns 0 outside, 1/2 arrows, 3/4 page regions, or 5 thumb; only tests the scrolling axis."
    procedure SetRange(MinValue, MaxValue: Integer); // @addr 0x494680
    procedure SetPositionInternal(NewPosition: Integer); // @addr 0x494824 @note "Does not invoke PositionChangedCallback."
    procedure SetPosition(NewPosition: Integer); reintroduce; // @addr 0x4949F8 @note "Notifies only while Active and only when the clamped position changes."
    procedure SetSmallChange(Value: Integer); // @addr 0x494BEC
    procedure SetLargeChange(Value: Integer); // @addr 0x494C34 @note "A value equal to SmallChange is ignored even if LargeChange differs."
    procedure SetPageSize(Value: Integer); // @addr 0x494C7C @note "Caps at Maximum-Minimum+1; no lower bound check."
    procedure SetOrientation(Value: Integer); // @addr 0x494CFC @note "Value 1 is horizontal; other values use vertical layout."
    procedure SetKindCalcMode(Value: Integer); // @addr 0x494D44
    procedure SetConfigPath(const Path: WideString); override; // @addr 0x494D8C
    procedure SetSize(Size: TPoint); override; // @addr 0x494DC4 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Size@<edx>);"
    procedure UpdateLayout; // @addr 0x494E24
    procedure UpdateSizeForOrientation; // @addr 0x496068 @note "Uses the up-arrow image for scrollbar thickness."
    procedure StartAutoRepeat(DelayMs, RepeatMs: Integer); // @addr 0x4968F0
    procedure StopAutoRepeat; // @addr 0x496930
    procedure AutoRepeat(Timer: PCallbackTimerGI; UserData: Integer); // @addr 0x496968
    procedure SetUpPosition(Point: TPoint); // @addr $4941D4 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Point@<edx>);"
    procedure SetBeforeThumbBarPosition(Point: TPoint); // @addr $494220 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Point@<edx>);"
    procedure SetThumbTopPosition(Point: TPoint); // @addr $49426C @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Point@<edx>);"
    procedure SetThumbCenterPosition(Point: TPoint); // @addr $4942B8 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Point@<edx>);"
    procedure SetThumbBottomPosition(Point: TPoint); // @addr $494304 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Point@<edx>);"
    procedure SetAfterThumbBarPosition(Point: TPoint); // @addr $494350 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Point@<edx>);"
    procedure SetDownPosition(Point: TPoint); // @addr $49439C @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Point@<edx>);"
    procedure SetBeforeThumbBarSize(Size: TPoint); // @addr $4943E8 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Size@<edx>);"
    procedure SetThumbCenterSize(Size: TPoint); // @addr $494434 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Size@<edx>);"
    procedure SetAfterThumbBarSize(Size: TPoint); // @addr $494480 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, TPoint *Size@<edx>);"
    procedure SetActive(Enabled: Boolean); override; // @addr $494DF8
    procedure ProcessMouseMove(KeyState: Cardinal; Point: TPoint); override; // @addr $4960D0 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>);"
    procedure ProcessLeftButtonDown(KeyState: Cardinal; Point: TPoint); override; // @addr $496444 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>);"
    procedure ProcessLeftButtonUp(KeyState: Cardinal; Point: TPoint); override; // @addr $49685C @ida "void __usercall $name(TScrollBarGI *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>);"
    procedure ProcessLeftButtonDoubleClick(KeyState: Cardinal; Point: TPoint); override; // @addr $4968D4 @ida "void __usercall $name(TScrollBarGI *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>);"
    procedure OnMouseEnter; override; // @addr $4963E8
    procedure OnMouseLeave; override; // @addr $4963FC
    procedure LoadFromConfigPath(const Path: WideString); override; // @addr 0x496A1C
    procedure LoadFromBlock(Block: TBlockParEC); override; // @addr 0x496A50
    procedure LoadScrollBarProperties(Block: TBlockParEC); // @addr 0x496A78
  end;
...
{ @routine $493B94 TScrollBarGI_Create }
...
{ @routine $493FE0 TScrollBarGI_Destroy }
...
{ @routine $494138 TScrollBarGI_Clear }
...
{ @routine $4941D4 TScrollBarGI_SetUpPosition }
...
{ @routine $494220 TScrollBarGI_SetBeforeThumbBarPosition }
...
{ @routine $49426C TScrollBarGI_SetThumbTopPosition }
...
{ @routine $4942B8 TScrollBarGI_SetThumbCenterPosition }
...
{ @routine $494304 TScrollBarGI_SetThumbBottomPosition }
...
{ @routine $494350 TScrollBarGI_SetAfterThumbBarPosition }
...
{ @routine $49439C TScrollBarGI_SetDownPosition }
...
{ @routine $4943E8 TScrollBarGI_SetBeforeThumbBarSize }
...
{ @routine $494434 TScrollBarGI_SetThumbCenterSize }
...
{ @routine $494480 TScrollBarGI_SetAfterThumbBarSize }
...
{ @routine $4944CC TScrollBarGI_GetHitRegion }
...
{ @routine $494680 TScrollBarGI_SetRange }
...
{ @routine $494824 TScrollBarGI_SetPositionInternal }
...
{ @routine $4949F8 TScrollBarGI_SetPosition }
...
{ @routine $494BEC TScrollBarGI_SetSmallChange }
...
{ @routine $494C34 TScrollBarGI_SetLargeChange }
...
{ @routine $494C7C TScrollBarGI_SetPageSize }
...
{ @routine $494CFC TScrollBarGI_SetOrientation }
...
{ @routine $494D44 TScrollBarGI_SetKindCalcMode }
...
{ @routine $494D8C TScrollBarGI_SetConfigPath }
...
{ @routine $494DC4 TScrollBarGI_SetSize }
...
{ @routine $494DF8 TScrollBarGI_SetActive }
...
{ @routine $494E24 TScrollBarGI_UpdateLayout }
...
{ @routine $496068 TScrollBarGI_UpdateSizeForOrientation }
...
{ @routine $4960D0 TScrollBarGI_ProcessMouseMove }
...
{ @routine $4963E8 TScrollBarGI_OnMouseEnter }
...
{ @routine $4963FC TScrollBarGI_OnMouseLeave }
...
{ @routine $496444 TScrollBarGI_ProcessLeftButtonDown }
...
{ @routine $49685C TScrollBarGI_ProcessLeftButtonUp }
...
{ @routine $4968D4 TScrollBarGI_ProcessLeftButtonDoubleClick }
...
{ @routine $4968F0 TScrollBarGI_StartAutoRepeat }
...
{ @routine $496930 TScrollBarGI_StopAutoRepeat }
...
{ @routine $496968 TScrollBarGI_AutoRepeat }
...
{ @routine $496A1C TScrollBarGI_LoadFromConfigPath }
...
{ @routine $496A50 TScrollBarGI_LoadFromBlock }
...
{ @routine $496A78 TScrollBarGI_LoadScrollBarProperties }
