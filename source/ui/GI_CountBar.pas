unit GI_CountBar;
// Unit bracket (inferred): .text 0x004A3DC0..0x004A4EF0; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    procedure UpdateLayout; // @addr 0x4A43C4
    ...
    procedure LoadFromBlock(Block: TBlockParEC); override; // @addr 0x4A4C20
    procedure LoadCountBarProperties(Block: TBlockParEC); // @addr 0x4A4C48
  end;
...
{ @routine $4A3EE0 TCountBarGI_Create }
...
{ @routine $4A407C TCountBarGI_Destroy }
...
{ @routine $4A41B8 TCountBarGI_SetRange }
...
{ @routine $4A4278 TCountBarGI_SetPositionInternal }
...
{ @routine $4A430C TCountBarGI_SetPosition }
...
{ @routine $4A43C4 TCountBarGI_UpdateLayout }
...
{ @routine $4A46B4 TCountBarGI_AutoRepeat }
...
{ @routine $4A4750 TCountBarGI_DecreasePressed }
...
{ @routine $4A47D0 TCountBarGI_IncreasePressed }
...
{ @routine $4A4850 TCountBarGI_ProcessMouseMove }
...
{ @routine $4A49B8 TCountBarGI_OnMouseEnter }
...
{ @routine $4A49CC TCountBarGI_OnMouseLeave }
...
{ @routine $4A49E0 TCountBarGI_ProcessLeftButtonDown }
...
{ @routine $4A4B98 TCountBarGI_ProcessLeftButtonUp }
...
{ @routine $4A4BEC TCountBarGI_LoadFromConfigPath }
...
{ @routine $4A4C20 TCountBarGI_LoadFromBlock }
...
{ @routine $4A4C48 TCountBarGI_LoadCountBarProperties }
