unit GI_Grid;
// Unit bracket (inferred): .text 0x00498A78..0x0049B9E4; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    constructor Create(Owner: TObjectGI); // @addr 0x498BD0 @ida "TGridGI *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>, TObjectGI *Owner@<ecx>);"
    destructor Destroy; override; // @addr 0x498D00 @ida "void __usercall $name(TGridGI *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure Clear; override; // @addr 0x498D38
    procedure LayoutCell(Child: TObjectGI); // @addr 0x498E28
    procedure LayoutCells; // @addr 0x498F98
    procedure UpdateGridExtent; // @addr 0x498FD4
    procedure RebuildGridLines; // @addr 0x4990E8 @note "Type 0 hides lines, 1 draws both axes, 2 horizontal separators, 3 vertical separators; nonzero types include the outer border."
    procedure UpdateRowAutoHeight(RowIndex: Integer); // @addr 0x499598
    procedure UpdateActiveCellVisibility; // @addr 0x49963C
    procedure SetColumnCount(Value: Integer); // @addr 0x499780 @note "New columns default to 100 pixels."
    procedure SetRowCount(Value: Integer); // @addr 0x4998F0 @note "New rows default to 15 pixels."
    procedure SetGridType(Value: TGridTypeGI); // @addr 0x499A94
    function GetColumnWidth(ColumnIndex: Integer): Integer; // @addr 0x499ADC
    procedure SetColumnWidth(ColumnIndex, Width: Integer); // @addr 0x499C0C
    function GetRowHeight(RowIndex: Integer): Integer; // @addr 0x499C70
    procedure SetRowHeight(RowIndex, Height: Integer); // @addr 0x499D90 @note "Also updates AutoHeightMinimum when the row's AutoHeight flag is set."
    procedure SetRowAutoHeightEnabled(RowIndex: Integer; Enabled: Boolean); // @addr 0x499E50 @note "Does not validate RowIndex."
    function GetCell(CellX, CellY: Integer): TLabelGI; // @addr 0x499E9C @note "Raises for out-of-range coordinates or a missing cell label."
    procedure SetRowSelectEnabled(Value: Boolean); // @addr 0x49A0B8
    procedure SetColSelectEnabled(Value: Boolean); // @addr 0x49A0F0
    procedure SetBackgroundImagePath(Path: WideString); // @addr 0x49A128
    procedure SetActiveCellImagePath(Path: WideString); // @addr 0x49A200
    procedure SetActiveCellImageHalfAlpha(Value: Boolean); // @addr 0x49A320
    procedure SetActiveCell(Cell: TPoint); // @addr 0x49A350 @ida "void __usercall $name(TGridGI *Self@<eax>, TPoint *Cell@<edx>);" @note "Invalid coordinates become (-1,-1); valid cells are scrolled into view."
    procedure SelectCell(Cell: TPoint); // @addr 0x49A700 @ida "void __usercall $name(TGridGI *Self@<eax>, TPoint *Cell@<edx>);" @note "Selection can be vetoed by the callback."
    procedure CellClick(Sender: TObjectGI; MouseState: Cardinal; Point: TPoint); // @addr 0x49A794 @ida "void __userpurge $name(TGridGI *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int MouseState@<ecx>, TPoint *Point@<^0>);"
    procedure LoadFromConfigPath(const Path: WideString); override; // @addr 0x49A9F4
    procedure LoadFromBlock(Block: TBlockParEC); override; // @addr 0x49AA2C
    procedure ProcessLeftButtonDown(KeyState: Cardinal; Point: TPoint); override; // @addr $49A8B0 @ida "void __usercall $name(TGridGI *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>);"
    procedure OnFocusGained; override; // @addr $49A900
    procedure OnFocusLost; override; // @addr $49A914
    procedure ProcessKeyDown(Key: Integer); override; // @addr $49A928
    procedure Draw(ClipRect: TRect); override; // @addr $49B9C0 @ida "void __usercall $name(TGridGI *Self@<eax>, TRect *ClipRect@<edx>);"
    procedure LoadGridProperties(Block: TBlockParEC); // @addr 0x49AA54
  end;
...
{ @routine $498D00 TGridGI_Destroy }
...
{ @routine $498E28 TGridGI_LayoutCell }
...
{ @routine $498F98 TGridGI_LayoutCells }
...
{ @routine $498FD4 TGridGI_UpdateGridExtent }
...
{ @routine $4990E8 TGridGI_RebuildGridLines }
...
{ @routine $499598 TGridGI_UpdateRowAutoHeight }
...
{ @routine $49963C TGridGI_UpdateActiveCellVisibility }
...
{ @routine $499780 TGridGI_SetColumnCount }
...
{ @routine $4998F0 TGridGI_SetRowCount }
...
{ @routine $499A94 TGridGI_SetGridType }
...
{ @routine $499ADC TGridGI_GetColumnWidth }
...
{ @routine $499C0C TGridGI_SetColumnWidth }
...
{ @routine $499C70 TGridGI_GetRowHeight }
...
{ @routine $499D90 TGridGI_SetRowHeight }
...
{ @routine $499E50 TGridGI_SetRowAutoHeightEnabled }
...
{ @routine $499E9C TGridGI_GetCell }
...
{ @routine $49A0B8 TGridGI_SetRowSelectEnabled }
...
{ @routine $49A0F0 TGridGI_SetColSelectEnabled }
...
{ @routine $49A128 TGridGI_SetBackgroundImagePath }
...
{ @routine $49A200 TGridGI_SetActiveCellImagePath }
...
{ @routine $49A320 TGridGI_SetActiveCellImageHalfAlpha }
...
{ @routine $49A350 TGridGI_SetActiveCell }
...
{ @routine $49A700 TGridGI_SelectCell }
...
{ @routine $49A794 TGridGI_CellClick }
...
{ @routine $49A8B0 TGridGI_ProcessLeftButtonDown }
...
{ @routine $49A900 TGridGI_OnFocusGained }
...
{ @routine $49A914 TGridGI_OnFocusLost }
...
{ @routine $49A928 TGridGI_ProcessKeyDown }
...
{ @routine $49A9F4 TGridGI_LoadFromConfigPath }
...
{ @routine $49AA2C TGridGI_LoadFromBlock }
...
{ @routine $49AA54 TGridGI_LoadGridProperties }
