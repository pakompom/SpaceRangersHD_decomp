...
var
  BlasterPalettes: array of TBlasterPalette; // @addr $8895F0
...
type
  ...
  public
    ...
    constructor Create(Owner: TObjectGI; APaletteIndex: Integer); // @addr $4F9CC8 @ida "TPSWeapon07Blaster *__userpurge $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>, TObjectGI *Owner@<ecx>, int APaletteIndex@<^0>);"
    destructor Destroy; override; // @addr $4F9D74 @ida "void __usercall $name(TPSWeapon07Blaster *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure SetPosition(Position: TPoint); override; // @addr $4F9DB0 @ida "void __usercall $name(TPSWeapon07Blaster *Self@<eax>, TPoint *Position@<edx>);"
    procedure SetTargetPoint(Point: TPoint); override; // @addr $4F9DF4 @ida "void __usercall $name(TPSWeapon07Blaster *Self@<eax>, TPoint *Point@<edx>);"
    procedure UpdateProjectionBounds; // @addr $4F9E48
    procedure UpdateHitTestBounds; override; // @addr $4FA18C
    function GetLocalBounds: TRect; override; // @addr $4FA1F8 @ida "void __usercall $name(TPSWeapon07Blaster *Self@<eax>, TRect *Result@<edx>);"
    function AddParticle: PBlasterParticle; // @addr $4FA25C
    procedure ClearParticles; // @addr $4FA2D4
    procedure Invalidate; override; // @addr $4FA3F4 @note "Native empty override."
    procedure InvalidateRect(Rect: TRect); override; // @addr $4FA328 @ida "void __usercall $name(TPSWeapon07Blaster *Self@<eax>, TRect *Rect@<edx>);"
    procedure Advance(Timer: PCallbackTimerGI; UserData: Integer); override; // @addr $4FA400
    procedure Draw(ClipRect: TRect); override; // @addr $4FAC14 @ida "void __usercall $name(TPSWeapon07Blaster *Self@<eax>, TRect *ClipRect@<edx>);"
  end;

function NextBlasterRandom: Integer; // @addr $4F9CA0
procedure LoadBlasterPalettes; // @addr $4FAE88

var
  BlasterRandomIndex: Integer = 0; // @addr $87A9F8

implementation

// @unit-initialization $875848
// @unit-finalization $4FB170

uses SysUtils, Math, EC_BlockPar, EC_Str, EC_Mem, GR_Main, GR_DX, aMyFunction, Globals;

var
  BlasterRandomValues: array[0..127] of Integer; // @addr $8895F8

{ @routine $4F9CA0 NextBlasterRandom }
...
{ @routine $4F9CC8 TPSWeapon07Blaster_Create }
...
{ @routine $4F9D74 TPSWeapon07Blaster_Destroy }
...
{ @routine $4F9DB0 TPSWeapon07Blaster_SetPosition }
...
{ @routine $4F9DF4 TPSWeapon07Blaster_SetTargetPoint }
...
{ @routine $4F9E48 TPSWeapon07Blaster_UpdateProjectionBounds }
...
{ @routine $4FA18C TPSWeapon07Blaster_UpdateHitTestBounds }
...
{ @routine $4FA1F8 TPSWeapon07Blaster_GetLocalBounds }
...
{ @routine $4FA25C TPSWeapon07Blaster_AddParticle }
...
{ @routine $4FA2D4 TPSWeapon07Blaster_ClearParticles }
...
{ @routine $4FA328 TPSWeapon07Blaster_InvalidateRect }
...
{ @routine $4FA3F4 TPSWeapon07Blaster_Invalidate }
procedure TPSWeapon07Blaster.Invalidate;
begin
end;
{ @end $4FA3F4 }

{ @routine $4FA400 TPSWeapon07Blaster_Advance }
...
{ @routine $4FAC14 TPSWeapon07Blaster_Draw }
...
{ @routine $4FAE88 LoadBlasterPalettes }
