...
// Native TPSPDWeaponGI and methods: $4ED898..$4EE1A0.
...
type
  ...
  public
    ...
    constructor Create(Owner: TObjectGI); // @addr $4ED9C8 @ida "TPSPDWeaponGI *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>, TObjectGI *Owner@<ecx>);"
    destructor Destroy; override; // @addr $4EDA5C @ida "void __usercall $name(TPSPDWeaponGI *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure Invalidate; override; // @addr $4EDA98 @note "Native empty override."
    procedure SetPosition(Position: TPoint); override; // @addr $4EDAA4 @ida "void __usercall $name(TPSPDWeaponGI *Self@<eax>, TPoint *Position@<edx>);"
    procedure SetTargetPoint(Point: TPoint); override; // @addr $4EDAE0 @ida "void __usercall $name(TPSPDWeaponGI *Self@<eax>, TPoint *Point@<edx>);"
    procedure UpdateHitTestBounds; override; // @addr $4EDB2C
    procedure SetActive(Enabled: Boolean); override; // @addr $4EDB60
    procedure ClearParticles; // @addr $4EDB7C
    procedure GrowParticles; // @addr $4EDBC4
    function AddParticle: PPDWeaponParticle; // @addr $4EDBFC
    procedure Advance(Timer: PCallbackTimerGI; UserData: Integer); override; // @addr $4EDC54
    procedure Draw(ClipRect: TRect); override; // @addr $4EDEEC @ida "void __usercall $name(TPSPDWeaponGI *Self@<eax>, TRect *ClipRect@<edx>);"
  end;
...
{ @routine $4ED9C8 TPSPDWeaponGI_Create }
...
{ @routine $4EDA5C TPSPDWeaponGI_Destroy }
...
{ @routine $4EDA98 TPSPDWeaponGI_Invalidate }
procedure TPSPDWeaponGI.Invalidate;
begin
end;
{ @end $4EDA98 }

{ @routine $4EDAA4 TPSPDWeaponGI_SetPosition }
...
{ @routine $4EDAE0 TPSPDWeaponGI_SetTargetPoint }
...
{ @routine $4EDB2C TPSPDWeaponGI_UpdateHitTestBounds }
...
{ @routine $4EDB60 TPSPDWeaponGI_SetActive }
...
{ @routine $4EDB7C TPSPDWeaponGI_ClearParticles }
...
{ @routine $4EDBC4 TPSPDWeaponGI_GrowParticles }
...
{ @routine $4EDBFC TPSPDWeaponGI_AddParticle }
...
{ @routine $4EDC54 TPSPDWeaponGI_Advance }
...
{ @routine $4EDEEC TPSPDWeaponGI_Draw }
