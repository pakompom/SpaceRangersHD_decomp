unit SE_Planet;
// Unit bracket (inferred): .text 0x006BFC28..0x006C45FB; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    constructor Create; // @addr 0x6BFD2C @ida "TPlanetSE *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    constructor CreateFromGraph(const AGraphKey: WideString; UnusedPosition: TPoint); // @addr 0x6BFD70 @ida "TPlanetSE *__userpurge $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>, unsigned __int16 *AGraphKey@<ecx>, TPoint *UnusedPosition@<^0>);"
    procedure CopyTo(Destination: TObjectSE); override; // @addr 0x6BFDF8 @slot 0x00 @note "Destination must be a TPlanetSE. Copies configuration, not attached controls/timers."
    procedure AttachToSpace(ASpace: TSpaceSE); override; // @addr 0x6C0068
    procedure DetachFromSpace; override; // @addr 0x6C0FE0
    procedure RebuildRings; // @addr 0x6C1278
    procedure RebuildSurfaceAnimation; // @addr 0x6C1858
    procedure StartRandomSurfaceAnimation; // @addr 0x6C1A18 @note "Requires an allocated image control and a mask with positive total animation weight."
    procedure SetMinimapOwner(Owner: Byte); // @addr 0x6C1C9C
    procedure SetPosition(APosition: TPointF); override; // @addr 0x6C1E40 @ida "void __usercall $name(TPlanetSE *Self@<eax>, TPointF *APosition@<edx>);"
    procedure SetSurfaceMapOffset(Value: Integer); // @addr 0x6C20DC
    procedure SetCloud1MapOffset(Value: Integer); // @addr 0x6C2124
    procedure SetCloud2MapOffset(Value: Integer); // @addr 0x6C2170
    procedure SetCloud3MapOffset(Value: Integer); // @addr 0x6C21BC
    procedure SetLightAngle(Value: Byte); // @addr 0x6C2208
    procedure SetRotationTimerInterval(Value: Cardinal); // @addr 0x6C2250
    procedure SetSurfaceMapStep(Value: Integer); // @addr 0x6C27A0
    procedure SetRingKind(Kind: Byte); // @addr 0x6C27BC @note "Does nothing for ruins; rebuilds rings when attached to space."
    procedure SetSurfaceAnimationMask(Mask: Integer); // @addr 0x6C27F8 @note "Does nothing for ruins; rebuilds the animation when attached to space."
    procedure UpdateLightAngleFromStar; // @addr 0x6C2834
    procedure SurfaceAnimationFinished(Sender: TObjectGI); // @addr 0x6C2904
    procedure AdvanceRotationTimer(Timer: PSpaceTimerSE; UserData: Integer); // @addr 0x6C2A9C
    procedure AdvanceCloudTimer(Timer: PSpaceTimerSE; UserData: Integer); // @addr 0x6C2AD0 @note "UserData selects cloud 1..3."
    function HitTestCursor: Boolean; override; // @addr 0x6C2BD0
    procedure DrawMap; override; // @addr 0x6C2C84
    procedure RenderToBuffer(Screen: TMessageLoopGI; Buffer: TGraphBufGR; SmallPreview: Boolean); // @addr 0x6C3870 @note "SmallPreview affects detached normal planets only. Attached planets reuse their current surface renderer; ruins use their static image."
    procedure LoadTemplate(Block: TBlockParEC); override; // @addr 0x6C3B9C
    procedure ApplyConfig(Block: TBlockParEC); override; // @addr 0x6C4164
    procedure QueueImageLoad(PendingLoads: TList; Owner: TObjectGI); override; // @addr 0x6C435C
  end;

function AllocatePlanetCollisionCircle: PPlanetCollisionCircle; // @addr 0x6C4554 @note "Links a new entry at the head; only links are initialized."
procedure FreePlanetCollisionCircle(Entry: PPlanetCollisionCircle); // @addr 0x6C45A4

var
  FirstPlanetCollisionCircle: PPlanetCollisionCircle = nil; // @addr 0x87B8A4
...
{ @routine $6BFD2C TPlanetSE_Create }
...
{ @routine $6BFD70 TPlanetSE_CreateFromGraph }
...
{ @routine $6BFDF8 TPlanetSE_CopyTo }
...
{ @routine $6C0068 TPlanetSE_AttachToSpace }
...
{ @routine $6C0FE0 TPlanetSE_DetachFromSpace }
...
{ @routine $6C1278 TPlanetSE_RebuildRings }
...
{ @routine $6C1858 TPlanetSE_RebuildSurfaceAnimation }
...
{ @routine $6C1A18 TPlanetSE_StartRandomSurfaceAnimation }
...
{ @routine $6C1C9C TPlanetSE_SetMinimapOwner }
...
{ @routine $6C1E40 TPlanetSE_SetPosition }
...
{ @routine $6C20DC TPlanetSE_SetSurfaceMapOffset }
...
{ @routine $6C2124 TPlanetSE_SetCloud1MapOffset }
...
{ @routine $6C2170 TPlanetSE_SetCloud2MapOffset }
...
{ @routine $6C21BC TPlanetSE_SetCloud3MapOffset }
...
{ @routine $6C2208 TPlanetSE_SetLightAngle }
...
{ @routine $6C2250 TPlanetSE_SetRotationTimerInterval }
...
{ @routine $6C27A0 TPlanetSE_SetSurfaceMapStep }
...
{ @routine $6C27BC TPlanetSE_SetRingKind }
...
{ @routine $6C27F8 TPlanetSE_SetSurfaceAnimationMask }
...
{ @routine $6C2834 TPlanetSE_UpdateLightAngleFromStar }
...
{ @routine $6C2904 TPlanetSE_SurfaceAnimationFinished }
...
{ @routine $6C2A9C TPlanetSE_AdvanceRotationTimer }
...
{ @routine $6C2AD0 TPlanetSE_AdvanceCloudTimer }
...
{ @routine $6C2BD0 TPlanetSE_HitTestCursor }
...
{ @routine $6C2C84 TPlanetSE_DrawMap }
...
{ @routine $6C3870 TPlanetSE_RenderToBuffer }
...
{ @routine $6C3B9C TPlanetSE_LoadTemplate }
...
{ @routine $6C4164 TPlanetSE_ApplyConfig }
...
{ @routine $6C435C TPlanetSE_QueueImageLoad }
...
{ @routine $6C4554 AllocatePlanetCollisionCircle }
...
{ @routine $6C45A4 FreePlanetCollisionCircle }
