...
var
  DesintegratorPalettes: array of TDesintegratorPalette; // @addr $8895C8
...
type
  ...
  public
    ...
    constructor Create(Owner: TObjectGI; APaletteIndex: Integer); // @addr $4F4FA4 @ida "TPSWeapon11Desintegrator *__userpurge $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>, TObjectGI *Owner@<ecx>, int APaletteIndex@<^0>);"
    destructor Destroy; override; // @addr $4F508C @ida "void __usercall $name(TPSWeapon11Desintegrator *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure SetPosition(Position: TPoint); override; // @addr $4F50C8 @ida "void __usercall $name(TPSWeapon11Desintegrator *Self@<eax>, TPoint *Position@<edx>);"
    procedure SetTargetPoint(Point: TPoint); override; // @addr $4F510C @ida "void __usercall $name(TPSWeapon11Desintegrator *Self@<eax>, TPoint *Point@<edx>);"
    procedure UpdateProjectionBounds; // @addr $4F5160
    procedure UpdateHitTestBounds; override; // @addr $4F54A4
    function GetLocalBounds: TRect; override; // @addr $4F5510 @ida "void __usercall $name(TPSWeapon11Desintegrator *Self@<eax>, TRect *Result@<edx>);"
    function AddParticle: PDesintegratorParticle; // @addr $4F5574
    procedure RemoveParticle(Particle: PDesintegratorParticle); // @addr $4F55EC
    procedure AdvanceImpactSparks(ClipRect: TRect); // @addr $4F5C24 @ida "void __usercall $name(TPSWeapon11Desintegrator *Self@<eax>, TRect *ClipRect@<edx>);"
    procedure ClearParticles; // @addr $4F5670
    procedure Invalidate; override; // @addr $4F56C4 @note "Native empty override."
    procedure InvalidateRect(Rect: TRect); override; // @addr $4F56D0 @ida "void __usercall $name(TPSWeapon11Desintegrator *Self@<eax>, TRect *Rect@<edx>);"
    procedure Advance(Timer: PCallbackTimerGI; UserData: Integer); override; // @addr $4F579C
    procedure Draw(ClipRect: TRect); override; // @addr $4F5FB8 @ida "void __usercall $name(TPSWeapon11Desintegrator *Self@<eax>, TRect *ClipRect@<edx>);"
  end;

procedure LoadDesintegratorPalettes; // @addr $4F62A4

implementation

// @unit-initialization $875828
// @unit-finalization $4F6568

uses SysUtils, Classes, Math, EC_BlockPar, EC_Str, EC_Mem, GR_Main, GR_DX, aMyFunction, Globals;

{ @routine $4F4FA4 TPSWeapon11Desintegrator_Create }
...
{ @routine $4F508C TPSWeapon11Desintegrator_Destroy }
...
{ @routine $4F50C8 TPSWeapon11Desintegrator_SetPosition }
...
{ @routine $4F510C TPSWeapon11Desintegrator_SetTargetPoint }
...
{ @routine $4F5160 TPSWeapon11Desintegrator_UpdateProjectionBounds }
...
{ @routine $4F54A4 TPSWeapon11Desintegrator_UpdateHitTestBounds }
...
{ @routine $4F5510 TPSWeapon11Desintegrator_GetLocalBounds }
...
{ @routine $4F5574 TPSWeapon11Desintegrator_AddParticle }
...
{ @routine $4F55EC TPSWeapon11Desintegrator_RemoveParticle }
...
{ @routine $4F5670 TPSWeapon11Desintegrator_ClearParticles }
...
{ @routine $4F56C4 TPSWeapon11Desintegrator_Invalidate }
procedure TPSWeapon11Desintegrator.Invalidate;
begin
end;
{ @end $4F56C4 }

{ @routine $4F56D0 TPSWeapon11Desintegrator_InvalidateRect }
...
{ @routine $4F579C TPSWeapon11Desintegrator_Advance }
...
{ @routine $4F5C24 TPSWeapon11Desintegrator_AdvanceImpactSparks }
...
{ @routine $4F5FB8 TPSWeapon11Desintegrator_Draw }
...
{ @routine $4F62A4 LoadDesintegratorPalettes }
