...
type
  ...
  public
    ...
    function GetStrengthScaledPirateStatus: Byte; override; // @addr 0x7531AC @slot 0x3C @note "Rounded pirate career status times StrengthInBestRanger, clamped to 0..100."
    ...
    function GetCareerSimilarity(Values: TRangerCareerValues): Byte; // @addr 0x752E60 @ida "unsigned __int8 __userpurge $name@<al>(TRanger *Self@<eax>, unsigned int Values@<^0>);" @note "Values occupies the low three bytes of one stack slot; result is the average of 100 minus each career-distance."
