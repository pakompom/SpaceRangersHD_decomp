...
type
  ...
  public
    ...
    function RelationToShip(Ship: TShip): Byte; // @addr 0x72F360
    ...
    function CountEquippedWeapons: Byte; // @addr 0x70A974
    function CountMissileWeapons: Byte; // @addr 0x70A9E0 @note "Counts torpedo/missile/rocket shot types; does not check usability or ammunition."
    function CountDirectFireWeapons: Byte; // @addr 0x70AA34 @note "Complement of CountMissileWeapons over cached equipped weapons."
    function CountWeaponsByDamageFlags(Flags: TDamageFlagSet): Byte; // @addr 0x70AB10 @note "Counts any intersection; does not check usability or ammunition."
    ...
    function GetWinChancePercent(Target: TShip): Byte; // @addr 0x70B8E0
    ...
    function GetHullIntegrityPercent: Byte; // @addr 0x70EE74 @note "Not clamped to 0..100."
    ...
    function GetDefensePercent: Byte; // @addr 0x70FDCC
    ...
    function GetEffectiveSkillLevel(Skill: TPilotSkill; IgnoreStatusEffects: Boolean = False): Byte; // @addr 0x72B90C @note "Clamps to 0..6; equipment bonuses still apply when status effects are ignored."
