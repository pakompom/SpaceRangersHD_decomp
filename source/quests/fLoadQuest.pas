unit fLoadQuest;
// Unit bracket (inferred): .text 0x005FAAD0..0x005FE34D; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    constructor Create; // @addr 0x5FABD0 @ida "TfLoadQuest *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x5FAC40 @ida "void __usercall $name(TfLoadQuest *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure InitializeLayout; override; // @addr 0x5FAC98
    procedure OnOpen; override; // @addr 0x5FB09C
    procedure OnClose; override; // @addr 0x5FB210
    procedure ReturnToMenu(Sender: TObjectGI); // @addr 0x5FB25C
    procedure QuestListKeyDown(Sender: TObjectGI; VirtualKey: Cardinal); // @addr 0x5FB284
    procedure ProcessMouseWheel(KeyState: Cardinal; Point: TPoint; Delta: Integer); override; // @addr 0x5FB7FC @ida "void __userpurge $name(TfLoadQuest *Self@<eax>, unsigned int KeyState@<edx>, TPoint *Point@<ecx>, int Delta@<^0>);"
    procedure RebuildQuestList; // @addr 0x5FBA30
    procedure InitializeQuestRow(Row: TObjectGI); // @addr 0x5FC1E8
    procedure SelectQuest(Index: Integer); // @addr 0x5FCA18 @note "Index is zero-based; locked entries clear the selection."
    procedure UpdateQuestRow(Index: Integer); // @addr 0x5FCB5C
    procedure QuestRowMouseEnter(Sender: TObjectGI); // @addr 0x5FCD88
    procedure QuestRowMouseLeave(Sender: TObjectGI); // @addr 0x5FCDE8
    procedure QuestRowMouseDown(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x5FCE3C @ida "void __userpurge $name(TfLoadQuest *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure QuestRowDoubleClick(Sender: TObjectGI; KeyState: Cardinal; Point: TPoint); // @addr 0x5FCEAC @ida "void __userpurge $name(TfLoadQuest *Self@<eax>, TObjectGI *Sender@<edx>, unsigned int KeyState@<ecx>, TPoint *Point@<^0>);"
    procedure SelectCategory(Sender: TObjectGI); // @addr 0x5FCED8
    procedure StartSelectedQuest(Sender: TObjectGI); // @addr 0x5FD038
    procedure ShowSelectedQuestDetails; // @addr 0x5FD0C0 @note "Loads the quest with HeaderOnly enabled."
    procedure LoadCompletionData; // @addr 0x5FDAA4 @note "QuestComplate.dat: CRC32, Int32 count, then Int32 entries."
    procedure SaveCompletionData; // @addr 0x5FDC5C
    procedure RecordCompletion(QuestId, Value, Status: Integer); // @addr 0x5FDDA8 @note "QuestId must be 0..9999. Higher status wins; equal status minimizes an existing nonzero Value."
    function CalculateAccessLevel: Integer; // @addr 0x5FDF08 @note "Advances past a group when all but one quest is completed."
    function GetCompletionCounts: TPoint; // @addr 0x5FE04C @ida "void __usercall $name(TfLoadQuest *Self@<eax>, TPoint *Result@<edx>);" @note "X is completed, Y is total; includes only numeric quests with positive Access."
    function GetCompletionSummary: WideString; // @addr 0x5FE1E8 @ida "void __usercall $name(TfLoadQuest *Self@<eax>, unsigned __int16 **Result@<edx>);" @note "The displayed total includes groups below 3."
    procedure SelectMusic; override; // @addr 0x5FE344 @note "Empty implementation."
    function InsertEntryByAccess(RequiredAccess: Integer): Integer; // @addr 0x5FB950 @note "Returns a zero-based index; inserts after entries with equal access."
  end;

var
  QuestNameColor: Cardinal; // @addr $889C04
...
{ @routine $5FABD0 TfLoadQuest_Create }
...
{ @routine $5FAC40 TfLoadQuest_Destroy }
...
{ @routine $5FAC98 TfLoadQuest_InitializeLayout }
...
{ @routine $5FB09C TfLoadQuest_OnOpen }
...
{ @routine $5FB210 TfLoadQuest_OnClose }
...
{ @routine $5FB25C TfLoadQuest_ReturnToMenu }
...
{ @routine $5FB284 TfLoadQuest_QuestListKeyDown }
...
{ @routine $5FB7FC TfLoadQuest_ProcessMouseWheel }
...
{ @routine $5FB950 TfLoadQuest_InsertEntryByAccess }
...
{ @routine $5FBA30 TfLoadQuest_RebuildQuestList }
...
{ @routine $5FC1E8 TfLoadQuest_InitializeQuestRow }
...
{ @routine $5FCA18 TfLoadQuest_SelectQuest }
...
{ @routine $5FCB5C TfLoadQuest_UpdateQuestRow }
...
{ @routine $5FCD88 TfLoadQuest_QuestRowMouseEnter }
...
{ @routine $5FCDE8 TfLoadQuest_QuestRowMouseLeave }
...
{ @routine $5FCE3C TfLoadQuest_QuestRowMouseDown }
...
{ @routine $5FCEAC TfLoadQuest_QuestRowDoubleClick }
...
{ @routine $5FCED8 TfLoadQuest_SelectCategory }
...
{ @routine $5FD038 TfLoadQuest_StartSelectedQuest }
...
{ @routine $5FD0C0 TfLoadQuest_ShowSelectedQuestDetails }
...
begin
  ...
  begin
    ...
    begin
      ...
      ReplaceTextToken(Text, '<Ranger>', LocalizedText('FormLoadQuest.PRanger'), '<color=0,71,234>');
      ReplaceTextToken(Text, '<ToPlanet>', LocalizedText('FormLoadQuest.PToPlanet'), '<color=0,71,234>');
      ReplaceTextToken(Text, '<ToStar>', LocalizedText('FormLoadQuest.PToStar'), '<color=0,71,234>');
      ...
      ReplaceTextToken(Text, '<FromPlanet>', LocalizedText('FormLoadQuest.PFromPlanet'), '<color=0,71,234>');
      ReplaceTextToken(Text, '<FromStar>', LocalizedText('FormLoadQuest.PFromStar'), '<color=0,71,234>');
...
{ @routine $5FDAA4 TfLoadQuest_LoadCompletionData }
...
{ @routine $5FDC5C TfLoadQuest_SaveCompletionData }
...
{ @routine $5FDDA8 TfLoadQuest_RecordCompletion }
...
{ @routine $5FDF08 TfLoadQuest_CalculateAccessLevel }
...
{ @routine $5FE04C TfLoadQuest_GetCompletionCounts }
...
{ @routine $5FE1E8 TfLoadQuest_GetCompletionSummary }
...
{ @routine $5FE344 TfLoadQuest_SelectMusic }
