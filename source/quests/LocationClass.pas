unit LocationClass;
// Unit bracket (inferred): .text 0x004E1874..0x004E32E9; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    ...
    constructor Create; // @addr 0x4E1900 @ida "TLocation *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x4E19B0 @ida "void __usercall $name(TLocation *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure Reset; // @addr 0x4E1A58 @note "Retains the first event; frees parameter changes and Sequence."
    function GetParameterChangeCount: Integer; // @addr 0x4E1B90
    function GetParameterChange(Index: Integer): TParameterDelta; // @addr 0x4E1BAC @note "Index is one-based."
    procedure AddParameterChange(Change: TParameterDelta); // @addr 0x4E1BD4
    function FindParameterChange(ParameterIndex: Integer): TParameterDelta; // @addr 0x4E1CF0
    procedure PruneParameterChanges(Parameters: TList); // @addr 0x4E1C68 @note "Removed entries are not freed."
    procedure ApplyParameterChanges(var Parameters: TList); // @addr 0x4E1BF4 @note "Evaluates every expression before applying any change."
    procedure AddEvent; // @addr 0x4E1D4C
    procedure RemoveLastEvent; // @addr 0x4E1F8C @note "Retains at least one event."
    function SelectEvent(var Parameters: TList): TEvent; // @addr 0x4E3020 @note "Expression selection falls back to random choice."
    procedure LoadFromReader(Reader: TBufEC); // @addr 0x4E1FDC @note "Location format used by quest versions 1111111126 and later."
    procedure LoadLegacyV0FromReader(Reader: TBufEC); // @addr 0x4E2EEC @note "Quest versions 1111111111..1111111114."
    procedure LoadLegacyV1FromReader(Reader: TBufEC); // @addr 0x4E2DB8 @note "Quest version 1111111115."
    procedure LoadLegacyV2FromReader(Reader: TBufEC); // @addr 0x4E2C20 @note "Quest version 1111111116."
    procedure LoadLegacyV3FromReader(Reader: TBufEC); // @addr 0x4E2A88 @note "Quest versions 1111111117..1111111118."
    procedure LoadLegacyV4FromReader(Reader: TBufEC); // @addr 0x4E28E0 @note "Quest versions 1111111119..1111111120."
    procedure LoadLegacyV5FromReader(Reader: TBufEC); // @addr 0x4E272C @note "Quest versions 1111111121..1111111122."
    procedure LoadLegacyV6FromReader(Reader: TBufEC); // @addr 0x4E2578 @note "Quest version 1111111123."
    procedure LoadLegacyV7FromReader(Reader: TBufEC); // @addr 0x4E23C4 @note "Quest version 1111111124."
    procedure LoadLegacyV8FromReader(Reader: TBufEC); // @addr 0x4E21D4 @note "Quest version 1111111125; repeated parameter indices overwrite earlier changes."
  end;
...
{ @routine $4E1900 TLocation_Create }
...
{ @routine $4E19B0 TLocation_Destroy }
...
{ @routine $4E1A58 TLocation_Reset }
...
{ @routine $4E1B90 TLocation_GetParameterChangeCount }
...
{ @routine $4E1BAC TLocation_GetParameterChange }
...
{ @routine $4E1BD4 TLocation_AddParameterChange }
...
{ @routine $4E1BF4 TLocation_ApplyParameterChanges }
...
{ @routine $4E1C68 TLocation_PruneParameterChanges }
...
{ @routine $4E1CF0 TLocation_FindParameterChange }
...
{ @routine $4E1D4C TLocation_AddEvent }
...
{ @routine $4E1F8C TLocation_RemoveLastEvent }
...
{ @routine $4E1FDC TLocation_LoadFromReader }
...
{ @routine $4E21D4 TLocation_LoadLegacyV8FromReader }
...
{ @routine $4E23C4 TLocation_LoadLegacyV7FromReader }
...
{ @routine $4E2578 TLocation_LoadLegacyV6FromReader }
...
{ @routine $4E272C TLocation_LoadLegacyV5FromReader }
...
{ @routine $4E28E0 TLocation_LoadLegacyV4FromReader }
...
{ @routine $4E2A88 TLocation_LoadLegacyV3FromReader }
...
{ @routine $4E2C20 TLocation_LoadLegacyV2FromReader }
...
{ @routine $4E2DB8 TLocation_LoadLegacyV1FromReader }
...
{ @routine $4E2EEC TLocation_LoadLegacyV0FromReader }
...
{ @routine $4E3020 TLocation_SelectEvent }
