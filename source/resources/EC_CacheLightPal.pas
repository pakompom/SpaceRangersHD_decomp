...
// Unit bracket (inferred): .text 0x0047CC00..0x0047D180; inclusive evidence, not full bounds. See docs/declarations.md#unit-coverage-and-address-brackets.
...
type
  ...
  public
    procedure QueueLoadIfMissing(PendingLoads: TList); override; // @addr 0x47CCDC
    function CreateData: TCacheDataEC; override; // @addr 0x47CD60
    function AcquireData: TCacheDataEC; override; // @addr 0x47CDAC
  end;
  ...
  public
    ...
    constructor Create; // @addr 0x47CFF8 @ida "TCLightPalEC *__usercall $name@<eax>(void *SelfOrClass@<eax>, unsigned __int8 Allocate@<dl>);"
    destructor Destroy; override; // @addr 0x47D044 @ida "void __usercall $name(TCLightPalEC *Self@<eax>, __int8 DestroyFlags@<dl>);"
    procedure LoadFromConfigBuffer(SourceBuffer: TBufEC; const LoadOption: WideString); override; // @addr 0x47D094
  end;

function AcquireOrCreateLightPalette(Control: TCacheControlEC): TCLightPalEC; // @addr 0x47CD80

procedure GetLightPaletteMaskInfo(Mask: Cardinal; Shift, BitCount, LevelCount: PCardinal); // @addr $47CDC8
function BuildLightPalette(Palette: PCardinal; ColorCount: Integer; RedMask, GreenMask, BlueMask: Cardinal): PWord; // @addr $47CE2C @note "Returns 64 packed 16-bit brightness levels per source color."
procedure FreeLightPalette(Palette: PWord); // @addr $47CFE0

implementation

uses GR_Main, GR_GraphBufPal, EC_Mem, SysUtils;

{ @routine $47CCDC TCLightPalControlEC_QueueLoadIfMissing }
...
{ @routine $47CD60 TCLightPalControlEC_CreateData }
...
{ @routine $47CD80 AcquireOrCreateLightPalette }
...
{ @routine $47CDAC TCLightPalControlEC_AcquireData }
...
{ @routine $47CDC8 GetLightPaletteMaskInfo }
...
{ @routine $47CE2C BuildLightPalette }
...
{ @routine $47CFE0 FreeLightPalette }
...
{ @routine $47CFF8 TCLightPalEC_Create }
...
{ @routine $47D044 TCLightPalEC_Destroy }
...
{ @routine $47D094 TCLightPalEC_LoadFromConfigBuffer }
